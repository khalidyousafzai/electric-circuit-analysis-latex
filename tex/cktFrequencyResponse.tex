...
\end{align*}
یوں اس دور کو استعمال کرنے سے پہلے تسلی کر لیں کہ استعمال ہونے والے برق گیر کی استعداد کم از کم \عددی{\SI{180}{\volt}\,\rms} ہو۔
\انتہا{مثال}
%==================
...
آئیں شکل \حوالہ{شکل_تعدد_سلسلہ_وار_الف} میں دکھائے گئے سلسلہ وار \عددی{RLC} دور  میں \عددی{\tfrac{\hat{V}_R}{\hat{V}_d}} تناسب کے لئے \عددی{Q}، \عددی{\omega_0} اور \عددی{\omega} پر مبنی عمومی مساوات حاصل کریں۔اس کے رکاوٹ سے فراوانی کی مساوات لکھتے ہیں۔
\begin{align*}
\bY(j\omega)&=\frac{1}{R+j(\omega L-\frac{1}{\omega C})}\\
&=\frac{1}{R[1+j(\frac{\omega L}{R} -\frac{1}{\omega RC})]}
\end{align*}
