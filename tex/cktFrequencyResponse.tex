...
حل:نسب نما \عددی{2s^2+5s+3} کے جذر \عددی{s_1=-1} اور \عددی{s_2=-\tfrac{3}{2}} ہیں۔آپ یہاں غلط فہمی\حاشیہد{میں یہ غلطی بار بار کر چکا ہوں۔} سے درج بالا کو \عددی{\tfrac{5s+2}{(s+1)(s+\tfrac{3}{2})}} لکھ سکتے ہیں لیکن قوسین کو ضرب دیتے ہوئے واپس اصل تفاعل حاصل کرتے ہوئے \عددی{\tfrac{5s+2}{s^2+\tfrac{5}{2}s+\frac{3}{2}}} حاصل ہوتا ہے جو درج بالا مساوات سے مختلف ہے۔ایسی غلطی سے بچنے کی خاطر پہلے دئے گئے تفاعل کے نسب نما اور شمار کنندہ کو یوں لکھیں کہ  ان کے بلند تر  درجہ \عددی{s} کا عددی سر اکائی کے برابر ہو۔ 
\begin{align*}
...
بعض اوقات ہم جال کو کسی مخصوص تعدد پر چلاتے ہیں۔اس کی مثال \عددی{\SI{50}{\hertz}} پر چلنے والا واپڈا کا نظام ہے۔اس کے برعکس کئی ادوار بدلتا تعدد پر استعمال کئے جاتے ہیں۔سمعی ایمپلیفائر ایسا دور ہے جو \عددی{\SI{20}{\hertz}} تا \عددی{\SI{20}{\kilo\hertz}} کے تعدد پر چلایا جاتا ہے۔ہم یہاں ادوار کی کارکردگی بالمقابل تعدد میں دلچسپی رکھتے ہیں۔تبادلی تفاعل مخلوط عدد ہے لہٰذا اس کو زاویائی طرز میں لکھا جا سکتا ہے
\begin{align}
