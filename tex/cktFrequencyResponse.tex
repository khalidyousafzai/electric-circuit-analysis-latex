...
\end{axis}%
\end{tikzpicture}%
\caption*{(ب) مزاحمتی رکاوٹ کی مطلق قیمت بالمقابل تعدد۔}
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}
...
\end{align}
اس طرح امالہ گیر کے رکاوٹ کی مطلق قیمت تعدد بڑھانے سے بڑھتی ہے۔رکاوٹ کی مقدار کا تعدد کے ساتھ راست تناسبی رشتہ ہے۔
\begin{align}
\abs{\bZ_L}=\omega L
\end{align}
...
\end{axis}%
\end{tikzpicture}%
\caption*{(ب) امالی رکاوٹ کی مطلق قیمت بالمقابل تعدد۔}
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}
...
\end{axis}%
\end{tikzpicture}%
\caption*{(ب) برق گیر رکاوٹ کی مطلق قیمت بالمقابل تعدد۔}
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}
...
سادہ ترین پرزوں کو نپٹانے کے بعد ذرہ مشکل ادوار دیکھتے ہیں۔شکل میں مزاحمت، امالہ گیر اور برق گیر سلسلہ وار جڑے دکھائے گئے ہیں۔ان کی کُل رکاوٹ \عددی{\bZ_s} لکھتے ہیں
\begin{align*}
\bZ_s&=\bZ_R+\bZ_L+\bZ_C\\
...
شکل \حوالہ{شکل_تعددی_بوڈا_خط_مزاحمت_امالہ_برق_گیر_رو_الف}-الف میں مزاحمت پر دباؤ حاصل کریں۔اس کے مقدار بالمقابل تعدد اور زاویہ بالمقابل تعدد کے خط کھینچیں۔
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
...
حل:دور سے مزاحمت کا دباؤ درج ذیل لکھا جا سکتا ہے
\begin{align*}
\hat{V}_R=\frac{(4)(20\phase{0^{\circ}})}{4+j(2\pi f 0.15-\frac{1}{2\pi f 0.004})}
\end{align*}
جو مخلوط تفاعل ہے۔اس کی مطلق مقدار \عددی{\hat{V}_R} بالمقابل تعدد \عددی{f} کو شکل-ب میں دکھایا گیا ہے۔اس ترسیم میں دونوں محور کی پیمائش \اصطلاح{لوگارتھم}\فرہنگ{لوگارتھم}\حاشیہب{log}\فرہنگ{log} میں ہے۔اس طرز کے ترسیم کو \اصطلاح{لوگارتھم لوگارتھم}\فرہنگ{لوگارتھم لوگارتھم!ترسیم}\فرہنگ{ترسیم!لوگارتھم لوگارتھم}\حاشیہب{log-log}\فرہنگ{log-log!graph}\فرہنگ{graph!log-log} ترسیم کہا جاتا  ہے۔مقدار بالمقابل تعدد کے خط عموماً لوگارتھم لوگارتھم محور پر دکھائے جاتے ہیں۔ زاویہ دباؤ \عددی{\phase{\hat{V}_R}} بالمقابل تعدد کو شکل-پ میں \اصطلاح{نیم لوگارتھم}\فرہنگ{نیم لوگارتھم!ترسیم}\فرہنگ{ترسیم!نیم لوگارتھم}\حاشیہب{semilog}\فرہنگ{semilog!axis}\فرہنگ{axis!semilog} محور پر دکھایا گیا ہے۔کم تعدد پر دباؤ کا زاویہ \عددی{+90^{\circ}} جبکہ بلند تعدد پر زاویہ \عددی{-90^{\circ}} ہے۔
\انتہا{مثال}
%========================

یہاں لوگارتھم لوگارتھم اور نیم لوگارتھم محور پر قیمتیں پڑھنا سیکھ لیں چونکہ اس باب میں انہیں کا استعمال ہو گا۔یوں شکل \حوالہ{شکل_تعددی_بوڈا_خط_مزاحمت_امالہ_برق_گیر_رو_الف}-ب میں  مطلق مقدار کی چوٹی \عددی{10^1} یعنی دس ہرٹز پر پائی جاتی ہے۔یہ چوٹی \عددی{10^1} یعنی دس وولٹ کو ظاہر کرتی ہے۔اسی طرح \عددی{\SI{e2}{\hertz}} یعنی سو ہرٹز پر دباؤ تقریباً  \عددی{\SI{1.6}{\volt}} ہے۔
...
کمپیوٹر سے حاصل موسیقی کے مماثلی اشارات کی چوٹی \عددی{\SI{1.5}{\volt}} ہے۔ ہم چاہتے ہیں کہ \اصطلاح{سمعی دباؤ ایمپلیفائر}\فرہنگ{ایمپلیفائر!سمعی}\فرہنگ{سمعی ایمپلیفائر}\حاشیہب{voltage amplifier}\فرہنگ{voltage!amplifier} استعمال کرتے ہوئے \عددی{\SI{8}{\ohm}} کے \اصطلاح{سپیکر}\فرہنگ{سپیکر}\حاشیہب{loud speaker}\فرہنگ{speaker} کو \عددی{\SI{10}{\watt}} طاقت فراہم کی جائے۔ان حقائق سے ایمپلیفائر کے داخلی مماثل اشارہ کی مؤثر قیمت حاصل کرتے ہیں۔
\begin{align*}
v_m=\frac{1.5}{\sqrt{2}}=\SI{1.061}{\volt}\,\rms
\end{align*}
طاقت کے کلیے \عددی{P=\tfrac{\VrmsS}{R}} سے آٹھ اوہم کے سپیکر کو دس واٹ طاقت کے لیے درکار مؤثر دباؤ حاصل کرتے ہیں۔
\begin{align*}
v_0=\sqrt{(10)(8)}=\SI{8.944}{\volt}\,\rms
\end{align*} 
یوں ایمپلیفائر کی درکار افزائش دباؤ درج ذیل ہے۔
\begin{align*}
...
برق گیر کی رکاوٹ \عددی{\bZ_C=\tfrac{1}{j\omega C}} لکھی جاتی ہے جس میں \عددی{j\omega=s} پر کرتے ہوئے \عددی{\bZ_C=\tfrac{1}{sC}} لکھا جا سکتا ہے۔ایسا ہی کرتے ہوئے ایمپلیفائر کو دوبارہ شکل \حوالہ{شکل_تعددی_افزائش_بالمقابل_تعددی_خط}-ب میں دکھایا گیا ہے۔آپ میں سے کچھ طلبہ \عددی{s} کو پہچان گئے ہوں گے۔یہ \اصطلاح{لاپلاس تبادل}\فرہنگ{لاپلاس تبادل}\حاشیہب{Laplace transform}\فرہنگ{Laplace transform} کا متغیرہ ہے۔

آئیں شکل \حوالہ{شکل_تعددی_افزائش_بالمقابل_تعددی_خط}-ب کو حل کریں۔داخلی جانب بالائی جوڑ پر کرخوف مساوات رو لکھتے ہیں
\begin{align*}
...
\end{align*}
اس میں قوسین کے اندر مزاحمتوں کو قریب قریب لکھتے ہوئے  \عددی{v_i} کے لیے حل کرتے ہیں۔
\begin{align*}
v_i&=\frac{v_m}{R_m\left(\frac{1}{R_m}+\frac{1}{R_i}+s C_i\right)}
\end{align*}
شکل \حوالہ{شکل_تعددی_افزائش_بالمقابل_تعددی_خط}-ب کے دائیں جانب تقسیم دباؤ کے کلیے سے \عددی{v_0} لکھتے ہیں۔
\begin{align*}
...
\end{align}
شکل \حوالہ{شکل_تعددی_افزائش_بالمقابل_تعددی_خط}-الف میں دی گئی مزاحمتوں اور برق گیروں کی قیمتیں استعمال کرتے ہوئے درج ذیل ملتا ہے۔
\begin{align*}
...
\end{aligned}
\end{gather}
اس کے مطلق قیمت \عددی{\abs{\bA_v(s)}} بالمقابل تعدد \عددی{f} کو شکل \حوالہ{شکل_تعددی_افزائش_بالمقابل_تعددی_خط_ب}-ب میں دکھایا گیا ہے۔
\begin{align*}
\abs{\bA_v(s)}=\frac{0.421 f }{\sqrt{1+\left(\frac{f}{20}\right)^2}\sqrt{1+\left(\frac{f}{20000}\right)^2}}
\end{align*}

شکل \حوالہ{شکل_تعددی_افزائش_بالمقابل_تعددی_خط_ب}-ب میں \عددی{\SI{20}{\hertz}} کو \اصطلاح{پست انقطاعی تعدد}\فرہنگ{پست انقطاعی تعدد}\فرہنگ{تعدد!پست انقطاعی}\فرہنگ{انقطاعی!پست تعدد}\حاشیہب{low cut-off frequency}\فرہنگ{low cut-off frequency}\فرہنگ{cut-off!low frequency} اور \عددی{\SI{20}{\kilo\hertz}} کو \اصطلاح{بلند انقطاعی تعدد}\فرہنگ{بلند انقطاعی تعدد}\فرہنگ{تعدد!بلند انقطاعی}\فرہنگ{انقطاعی!بلند تعدد}\حاشیہب{high cut-off frequency}\فرہنگ{cut-off!high frequency}\فرہنگ{high cut-off frequency} کہتے ہیں۔ انہیں خط کے \اصطلاح{کونے کی تعدد}\فرہنگ{تعدد!کونے کی}\حاشیہب{corner frequencies}\فرہنگ{corner frequencies} بھی کہا جاتا ہے۔

شکل \حوالہ{شکل_تعددی_افزائش_بالمقابل_تعددی_خط_ب} میں انقطاعی تعدد کے مابین \اصطلاح{درمیانی تعدد خطے}\فرہنگ{درمیانی تعدد خطہ}\حاشیہب{mid-frequency range}\فرہنگ{mid-frequency range} میں ایمپلیفائر کی افزائش \عددی{\SI{8.41}{\volt\per\volt}} ہے جو ہمیں درکار تھی۔اس کو درمیانی تعدد پر افزائش کہتے ہیں۔البتہ انقطاعی تعدد کے قریب ایمپلیفائر کی افزائش گھٹ جاتی ہے۔یوں پست اور بلند انقطاعی تعدد پر افزائش \عددی{\SI{5.95}{\volt\per\volt}} ہے۔جس تعدد پر افزائش کی قیمت درمیانی تعدد کے افزائش کے \عددی{\tfrac{1}{\sqrt{2}}} گنا رہ جاتی ہے اس کو انقطاعی تعدد کہتے ہیں۔چونکہ طاقت \عددی{P=\tfrac{\VrmsS}{R}} کے برابر ہے لہٰذا دباؤ کی قیمت \عددی{\tfrac{1}{\sqrt{2}}} گنا ہو جانے سے طاقت کی قیمت نصف ہو جاتی ہے۔یوں انقطاعی تعدد اس تعدد کو کہتے ہیں جس پر اشارے کی طاقت نصف رہ جاتی ہے۔ہمارے ایمپلیفائر کی درمیانی تعدد پر افزائش  \عددی{\SI{8.41}{\volt\per\volt}} ہے۔اس کا \عددی{\tfrac{1}{\sqrt{2}}} گنا \عددی{8.4\times\tfrac{1}{\sqrt{2}}=\SI{5.95}{\volt\per\volt}}  ہے۔
...
\end{align}
%==============
\ابتدا{مثال}\شناخت{مثال_تعددی_درست_تجزی}
درج ذیل تفاعل کو اجزائے ضربی کی صورت میں لکھیں۔
\begin{align*}
\bH(s)=\frac{5s+2}{2s^2+5s+3}
\end{align*}

حل:نسب نما \عددی{2s^2+5s+3} کے جذر \عددی{s_1=-1} اور \عددی{s_2=-\tfrac{3}{2}} ہیں۔آپ یہاں غلط فہمی\حاشیہد{میں یہ غلطی بار بار کر چکا ہوں۔} سے درج بالا کو \عددی{\tfrac{5s+2}{(s+1)(s+\tfrac{3}{2})}} لکھ سکتے ہیں لیکن قوسین کو ضرب دیتے ہوئے واپس اصل تفاعل حاصل کرتے ہوئے \عددی{\tfrac{5s+2}{s^2+\tfrac{5}{2}s+\frac{3}{2}}} حاصل ہوتا ہے جو درج بالا مساوات سے مختلف ہے۔ایسی غلطی سے بچنے کی خاطر پہلے دیے گئے تفاعل کے نسب نما اور شمار کنندہ کو یوں لکھیں کہ  ان کے بلند تر  درجہ \عددی{s} کا  ضریب  اکائی کے برابر ہو۔ 
\begin{align*}
\bH(s)=\frac{5(s+\frac{2}{5})}{2\left(s^2+\frac{5}{2}s+\frac{3}{2}\right)}
\end{align*}
نسب نما میں \عددی{s^2+\frac{5}{2}s+\frac{3}{2}} کے جذر اب بھی \عددی{s_1=-1} اور \عددی{s_2=-\tfrac{3}{2}} ہیں لہٰذا درج بالا مساوات کو ذیل لکھ سکتے ہیں۔
\begin{align*}
...
بعض اوقات ہم جال کو کسی مخصوص تعدد پر چلاتے ہیں۔اس کی مثال \عددی{\SI{50}{\hertz}} پر چلنے والا واپڈا کا نظام ہے۔اس کے برعکس کئی ادوار بدلتا تعدد پر استعمال کیے جاتے ہیں۔سمعی ایمپلیفائر ایسا دور ہے جو \عددی{\SI{20}{\hertz}} تا \عددی{\SI{20}{\kilo\hertz}} کے تعدد پر چلایا جاتا ہے۔ہم یہاں ادوار کی کارکردگی بالمقابل تعدد میں دلچسپی رکھتے ہیں۔تبادلی تفاعل مخلوط عدد ہے لہٰذا اس کو زاویائی طرز میں لکھا جا سکتا ہے
\begin{align}
\bH(\omega)=\abs{\bH(\omega)}e^{j\phi(\omega)}
\end{align}
جہاں مطلق مقدار کا تفاعل \عددی{\abs{\bH(\omega)}} اور زاویائی تفاعل \عددی{\phi(\omega)} دونوں تعدد پر منحصر ہیں۔ مطلق مقدار بالمقابل تعدد کے خط کو \اصطلاح{مقداری خصلت}\فرہنگ{مقداری خصلت}\فرہنگ{خصلت!مقداری}\حاشیہب{magnitude characteristic}\فرہنگ{magnitude!characteristic}\فرہنگ{characteristic!magnitude} اور زاویہ بالمقابل تعدد کے خط کو \اصطلاح{زاویائی خصلت}\فرہنگ{زاویائی خصلت}\فرہنگ{خصلت!زاویائی}\حاشیہب{phase characteristic}\فرہنگ{phase!characteristic}\فرہنگ{characteristic!phase} کہتے ہیں۔ 

\جزوحصہ{بوڈا خطوط}
افقی محور پر \عددی{\log_{10} \omega} اور  انتصابی  محور پر \عددی{20\log_{10} \abs{\bH(\omega)}} رکھنے سے  \اصطلاح{مقداری بوڈا خط}\فرہنگ{بوڈا خط}\حاشیہب{Bode plots}\فرہنگ{Bode plot} ملتا\حاشیہد{ہینڈرک واڈ بوڈا نے اس طرز کو دریافت کیا۔} ہے۔جیسے آپ آگے جا کر دیکھیں گے، تبادلی تفاعل کو دیکھ کر بوڈا خط کھینچا جاتا ہے۔یہی بوڈا خطوط کی مقبولیت  کی وجہ ہے۔\اصطلاح{تعدد تابع}\فرہنگ{تعدد تابع}\حاشیہب{frequency dependent}\فرہنگ{frequency dependent} ادوار مثلاً ایمپلیفائر، چھلنی وغیرہ کے تجزیے اور تخلیق میں بوڈا خطوط نہایت اہم ثابت ہوتے ہیں۔ مقداری بوڈا خط کے انتصابی محور کی پیمائش \اصطلاح{ڈیسی بیل}\فرہنگ{ڈیسی بیل}\حاشیہب{decibel}\فرہنگ{decibel} \عددی{\si{\deci\bel}} میں کی جاتی ہے۔ڈیسی بیل کو بنیادی طور پر آواز کے طاقت کی نسبت  ناپنے کے لیے استعمال کیا جاتا تھا جہاں دو طاقتوں کی نسبت کے لوگارتھم \عددی{\log_{10}\tfrac{P_2}{P_1}} کو \اصطلاح{بیل}\حاشیہب{Bell} میں ناپا جاتا تھا۔جیسے ایک میٹر \عددی{\SI{1}{\meter}} میں دس ڈیسی میٹر \عددی{\SI{10}{\deci\meter}} ہوتے ہیں، اسی طرح ایک بیل میں دس ڈیسی بیل ہوتے ہیں لہٰذا ڈیسی بیل کا کلیہ درج ذیل لکھا جائے گا۔
\begin{align}
\text{\RL{ڈیسی بیل میں طاقت کی نسبت  کی پیمائش}}=10 \log_{10} \frac{P_2}{P_1}
\end{align}
...
\text{\RL{ڈیسی بیل میں طاقت کی نسبت  کی پیمائش}}&=10 \log_{10} \frac{\abs{\hat{I}_2}^2 R}{\abs{\hat{I}_1}^2 R}=20 \log_{10}\frac{\abs{\hat{I}_2}}{\abs{\hat{I}_1}}\\
\text{\RL{ڈیسی بیل میں طاقت کی نسبت  کی پیمائش}}&=10 \log_{10} \frac{\abs{\hat{V}_2}^2/R}{\abs{\hat{V}_1}^2/R}=20 \log_{10}\frac{\abs{\hat{V}_2}}{\abs{\hat{V}_1}}
\end{aligned}
\end{gather}
مساوات \حوالہ{مساوات_تعددی_ڈیسی_بیل_تعریف} میں دیے ڈیسی بیل کے کلیے اتنے مقبول ہوئے ہیں کہ غیر یکساں مزاحمت کی صورت میں بھی دباؤ کی نسبت  یا رو کی نسبت کو انہیں کلیوں سے ڈیسی بیل میں ناپا جاتا ہے۔
%===============
\ابتدا{مشق}
...
%==================
\ابتدا{مشق}
ایک ایمپلیفائر کی افزائش دباؤ \عددی{A_v=\SI{22}{\volt\per\volt}} ہے۔اس کی افزائش دباؤ کو ڈیسی بیل میں لکھیں۔

جواب:\عددی{A_v=\SI{26.85}{\deci\bel}}
\انتہا{مشق}
%==================
\ابتدا{مشق}
سلسلہ وار جڑے \عددی{\SI{414}{\ohm}} اور \عددی{\SI{1000}{\ohm}} مزاحمتوں کو \عددی{\hat{V}_i=\SI{100}{\volt}\,\rms} کا داخلی اشارہ مہیا کیا جاتا ہے جبکہ  \عددی{\SI{1}{\kilo\ohm}} پر خارجی اشارہ \عددی{\hat{V}_0} ناپا جاتا ہے۔ جال کی افزائش دباؤ کو ڈیسی بیل میں دریافت کریں۔

جواب:خارجی دباؤ \عددی{\hat{V}_0=\tfrac{100\times 1000}{1000+414}=\SI{70.72}{\volt}\,\rms} ہے جو داخلی دباؤ کے \عددی{0.7072}  گنا ہے۔دباؤ کی قیمت  \عددی{0.7072}  گنا ہونے سے طاقت کی قیمت \عددی{0.5} گنا رہ جاتی ہے جو \عددی{\SI{-3}{\deci\bel}} کے برابر ہے۔
\انتہا{مشق}
%==============
...
\end{align*}
یوں نیم لوگارتھم محور پر خط کھینچتے ہوئے \عددی{\SI{10}{\radian\per\second}} سے کم تعدد  پر تفاعل کی مطلق قیمت \عددی{20\log_{10} 100=\SI{40}{\deci\bel}} ہو گی جبکہ اس تعدد سے زیادہ تعدد پر مطلق قیمت بتدریج بیس ڈیسی بیل فی دہائی بڑھے گی۔ان نتائج کو شکل \حوالہ{شکل_تعددی_ایک_قطب_دس_تعدد} میں دکھایا گیا ہے۔نقطہ \عددی{a} پر تعدد \عددی{\SI{10}{radian\per\second}} اور تفاعل کی مطلق قیمت \عددی{\SI{40}{\deci\bel}} ہے۔تعدد کو دس گنا کرنے سے \عددی{\omega=\SI{100}{\radian\per\second}} حاصل ہوتا ہے جس پر تفاعل کی مطلق مقدار بڑھ پر \عددی{\SI{40}{\deci\bel}+\SI{20}{\deci\bel}=\SI{60}{\deci\bel}} ہو جاتی ہے جسے نقطہ \عددی{b} سے ظاہر کیا گیا ہے۔ان دو نقطوں سے گزرتی سیدھی خط کھینچی گئی ہے جس کا ڈھلوان بیس ڈیسی بیل فی دہائی ہو گا۔
\begin{figure}
\centering
\begin{tikzpicture}
...
\end{align*}
مطلق قیمت کو ڈیسی بیل میں لکھتے ہیں۔
\begin{align*}
...
\end{multline*}
یہاں \عددی{\SI{10}{\radian\per\second}} پر درج بالا مساوات کا دوسرا جزو بیس ڈیسی بیل فی دہائی بڑھنا شروع ہو جات ہے جبکہ تیسرا جزو اسی شرح سے \عددی{\SI{1000}{\radian\per\second}} پر بڑھنا شروع ہوتا ہے۔یوں ان کا مجموعہ لیتے ہوئے \عددی{\SI{1000}{\radian\per\second}} تعدد سے خط کا ڈھلوان \عددی{\SI{40}{\deci\bel}} فی دہائی ہو گا۔اسی طرح \عددی{\SI{100}{\kilo\radian\per\second}} پر چھوتا جزو \عددی{\SI{40}{\deci\bel}} فی دہائی سے گھٹنا شروع ہوتا ہے جو دوسرے اور تیسرے اجزاء کو ختم کرتا ہے لہٰذا بوڈا خط برقرار \عددی{\SI{140}{\deci\bel}} پر رہتا ہے۔آخر کار \عددی{\SI{1}{\mega\radian\per\second}} پر پانچواں جزو چالیس ڈیسی بیل فی دہائی سے گھٹنا شروع ہوتا ہے۔ 
\begin{figure}
\centering
\begin{tikzpicture}
...
\end{align*}
کے برابر ہیں۔مساوات \حوالہ{مساوات_تعددی_دو_درجی_قطب} میں \عددی{\zeta}  کو \اصطلاح{تقصیری نسبت}\فرہنگ{تقصیری نسبت}\حاشیہب{damping ratio}\فرہنگ{damping ratio} کہتے ہیں۔

فرض کریں کہ ہمیں مساوات \حوالہ{مساوات_تعددی_دو_درجی_قطب} دی گئی ہے اور ہم اس کے قطب جاننا چاہتے ہیں۔قطب جاننے کے لیے نسب نما کے جذر حاصل کرنے ہوں گے جنہیں دو درجی مساوات کے کلیے سے حاصل کیا جا سکتا ہے۔
\begin{align*}
...
\end{aligned}
\end{gather}
تقصیری نسبت  کی قیمت اکائی سے زیادہ یا اکائی کے برابر ہونے کی صورت میں حقیقی قطب پائے جاتے ہیں جن پر ہم غور کر چکے ہیں۔آئیں مخلوط قطب پر غور کریں۔
%======================
\ابتدا{مشق}
...
\end{align*}
اس کی مطلق مقدار کو ڈیسی بیل میں لکھتے ہیں۔
...
\end{align}
مساوات \حوالہ{مساوات_تعددی_تقصیری_جزو} کا پہلا جزو مستقل ہے جبکہ دوسرے جزو کی مقدار کا دارومدار تعدد کے علاوہ تقصیری نسبت  پر بھی منحصر  ہے۔ شکل \حوالہ{شکل_تعددی_تقصیری_جزو}-الف میں مختلف \عددی{\zeta} کے  لیے مساوات \حوالہ{مساوات_تعددی_تقصیری_جزو} کے  دوسرے جزو کے خطوط دکھائے گئے ہیں۔اب تک ہم دیکھتے آ رہے ہیں کہ قطب پر مقداری خط گھٹنے شروع ہوتا ہے لیکن یہاں ایسا نہیں ہو رہا ہے۔مخلوط قطبین کی صورت میں مقداری خط گھٹنے سے پہلے بڑھتا ہے۔بڑھنے کی مقدار کا دارومدار \عددی{\zeta} پر ہے۔تقصیری نسبت  کی قیمت صفر \عددی{(\zeta=0)} ہو نے کی صورت میں \عددی{\omega \tau=1} پر تفاعل بے قابو بڑھتا ہے۔شکل میں \عددی{\zeta=0.02} کے خط کو نقطہ دار لکیر سے دکھایا گیا ہے۔تقصیری نسبت  کی قیمت صفر ہونا دور میں گونج یا \اصطلاح{گمک}\فرہنگ{گمک}\حاشیہب{resonance}\فرہنگ{resonance} کو ظاہر کرتی ہے۔

شکل \حوالہ{شکل_تعددی_تقصیری_جزو}-ب میں تبادلی تفاعل کا زاویائی خط \عددی{\zeta=0.1, 0.2,0.4,0.6,0.8,1} کے لیے دکھایا گیا ہے۔
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
...
\caption*{(ب)}
\end{subfigure}
\caption{مختلف تقصیری  نسبت کے لیے مخلوط جوڑی دار قطب کے تفاعل کے خط۔}
...
گمکی تعدد پر امالی متعاملیت اور برق گیر متعاملیت برابر ہوتے ہیں۔ چونکہ سلسلہ وار دور میں یکساں رو پائی جاتی ہے لہٰذا گمکی تعدد پر امالی دباؤ اور برق گیر دباؤ مقدار میں برابر لیکن آپس میں \عددی{180^{\circ}} زاویے پر ہوں گے۔زاویائی طور پر آپس میں بالکل الٹ ہونے کی وجہ سے ان کا مجموعہ صفر کے برابر ہو گا اور یوں شکل \حوالہ{شکل_تعدد_سلسلہ_وار_الف} میں داخلی دباؤ \عددی{\hat{V}_d} اور مزاحمتی دباؤ \عددی{\hat{V}_R} برابر ہوں گے۔

گمکی تعدد سے ہٹ کر کسی بھی تعدد پر مساوات \حوالہ{مساوات_سلسلہ_وار_رکاوٹ_الف} کا خیالی جزو صفر کے برابر نہیں ہو گا لہٰذا رکاوٹ کی مطلق قیمت \عددی{R} سے زیادہ ہو گی۔آپ دیکھ سکتے ہیں کہ گمکی تعدد پر رکاوٹ کی قیمت کم سے کم ہو گی اور رو کی قیمت زیادہ سے زیادہ ہو گی۔ گمکی تعدد پر دور میں رو اور داخلی دباؤ ہم زاویہ ہوں گے۔گمکی تعدد سے کم تعدد پر برق گیر متعاملیت کی مقدار امالی متعاملیت کے مقدار سے زیادہ ہو گی لہٰذا سلسلہ وار رکاوٹ برق گیر خاصیت رکھے گا اور داخلی دباؤ سے رو آگے پائی جائے گی۔اس کے برعکس گمکی تعدد سے زیادہ تعدد پر امالی متعاملیت کی مقدار برق گیر متعاملیت کی مقدار سے زیادہ ہو گی لہٰذا کُل رکاوٹ امالی ہو گا اور داخلی دباؤ سے رو پیچھے ہو گی۔ رکاوٹ کی مقدار بالمقابل تعدد کو شکل \حوالہ{شکل_تعددی_رکاوٹ_بالمقابل_تعدد_سلسلہ_وار_دور} میں دکھایا گیا ہے۔
\begin{figure}
\centering
\begin{tikzpicture}
...
رو کے حوالے سے تینوں پرزوں کے دباؤ کے دوری سمتیات شکل \حوالہ{شکل_تعددی_سلسلہ_وار_دوری_سمتیات} میں دکھائے گئے ہیں۔گمکی تعدد سے کم تعدد پر برق گیر کا دباؤ امالہ گیر کے دباؤ سے زیادہ ہے لہٰذا داخلی دباؤ \عددی{\hat{V}_d} سے رو آگے ہے۔گمکی تعدد پر داخلی دباؤ اور رو ہم زاویہ ہیں جبکہ گمکی تعدد سے زیادہ تعدد پر امالہ کی متعاملیت برق گیر کے متعاملیت سے زیادہ ہے لہٰذا امالی دباؤ کی قیمت برق گیر دباؤ سے زیادہ ہے اور یوں داخلی دباؤ سے رو پیچھے ہے۔داخلی دباؤ اور رو کے مابین زاویہ \عددی{\theta_z} مساوات \حوالہ{مساوات_سلسلہ_وار_رکاوٹ_الف} میں دیے رکاوٹ کا زاویہ ہے۔
\begin{align}
...
\end{align*}
حاصل ہوتے ہیں۔درج بالا مساوات میں دونوں جانب مطلق قیمتیں لیتے ہوئے گمکی تعدد کے لیے درج ذیل لکھا جا سکتا ہے
\begin{gather}
...
\end{aligned}
\end{gather}
 جہاں دباؤ کے مطلق قیمتوں کو \عددی{V_L}، \عددی{V_C}، \عددی{V_R}  اور \عددی{V_d} لکھا گیا ہے۔مساوات \حوالہ{مساوات_تعددی_گمکی_دباو_تعلقات} کے تحت گمکی تعدد پر امالی دباؤ اور برق گیر دباؤ کی قیمتیں داخلی دباؤ کے \عددی{Q} گنا ہوں گے۔یوں \عددی{Q>1} کی صورت میں امالی اور برق گیر دباؤ کی قیمت داخلی دباؤ سے زیادہ ہو گی۔ 
%===============
\ابتدا{مثال}\شناخت{مثال_تعددی_سلسلہ_وار_گمکی_تعدد_الف}
شکل \حوالہ{شکل_تعددی_سلسلہ_وار_گمکی_تعدد_الف} کے دور کی گمکی تعدد اور معیاری مستقل دریافت کریں۔گمکی تعدد پر رو حاصل کرتے ہوئے تینوں پرزوں کے دباؤ حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
...
\end{align*}
دباؤ کے یہی جوابات مساوات \حوالہ{مساوات_تعددی_گمکی_دباو_تعلقات} کی مدد سے بھی حاصل کیے جا سکتے ہیں یعنی
\begin{align*}
V_R&=V_d=\SI{40}{\volt}\\
V_L&=Q V_d=10\times 40=\SI{400}{\volt}\\
V_C&=Q V_d=10\times 40=\SI{400}{\volt}
\end{align*}
جہاں مزاحمتی دباؤ اور داخلی دباؤ ہم زاویہ ہیں جبکہ امالی دباؤ اور برق گیر دباؤ بالترتیب داخلی دباؤ سے \عددی{90^{\circ}} آگے اور پیچھے ہیں۔ اس مثال میں \عددی{Q=10} ہے لہٰذا گمکی تعدد پر امالی اور برق گیر دباؤ کی قیمتیں داخلی دباؤ سے دس گنا زیادہ ہیں۔ 
\انتہا{مثال}
%=================
\ابتدا{مثال}\شناخت{مثال_تعددی_امالہ_معیاری_مستقل}
برق گیر استعمال کرتے ہوئے ضروری ہے کہ برق گیر کی سکت سے تجاوز نہ کیا جائے۔برق گیر پر اس کے سکت سے زیادہ دباؤ ڈالنے سے برق گیر غیر فعال ہو جائے گا۔برق گیر عموماً غیر فعال ہونے کی صورت میں خوفناک دھماکے سے پھٹتا ہے۔ جزو طاقت درست کرنے والے برق گیر یا کارخانوں میں دیگر استعمال ہونے والے بڑے جسامت کے برق گیر کا پھٹنا جان لیوا ثابت ہو سکتا ہے۔

آپ جانتے ہیں کہ تار لپیٹنے سے امالہ گیر بنایا جاتا ہے۔یوں نہ چاہتے ہوئے بھی امالہ گیر میں درکار امالی رکاوٹ کے ساتھ ساتھ غیر مطلوب مزاحمتی رکاوٹ بھی پایا جاتا ہے۔شکل \حوالہ{شکل_تعددی_امالہ_معیاری_مستقل} میں ایسا ہی امالہ گیر اور برق گیر سلسلہ وار جوڑے گئے ہیں جہاں \عددی{L=\SI{90}{\milli\henry}} اور \عددی{C=\SI{100}{\micro\farad}} ہیں۔امالہ گیر کا معیاری مستقل \عددی{Q=6} ہے۔برق گیر پر گمکی تعدد پر دباؤ حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
...
حل:معیاری مستقل کی قیمت سے گمکی تعدد پر برق گیر کا دباؤ درج ذیل حاصل ہوتا ہے۔
\begin{align*}
V_C=Q V_d=6\times 30=\SI{180}{\volt}\,\rms
\end{align*}
یوں اس دور کو استعمال کرنے سے پہلے تسلی کر لیں کہ استعمال ہونے والے برق گیر کی سکت کم از کم \عددی{\SI{180}{\volt}\,\rms} ہے۔
\انتہا{مثال}
%==================
...
%==================
\ابتدا{مشق}
سلسلہ وار \عددی{RLC} دور میں داخلی دباؤ \عددی{22\cos \omega t\,\si{\volt}} ہے۔مزاحمت \عددی{\SI{2}{\ohm}} اور \عددی{L=\SI{120}{\micro\henry}} ہے۔دور کی گمکی تعدد \عددی{f_0=\SI{10}{\kilo\hertz}} کے لیے درکار برق گیر معلوم کریں۔دور میں \عددی{f_0}، \عددی{\tfrac{f_0}{2}} اور \عددی{2f_0} پر رو دریافت کریں۔
...
آئیں شکل \حوالہ{شکل_تعدد_سلسلہ_وار_الف} میں دکھائے گئے سلسلہ وار \عددی{RLC} دور  میں \عددی{\tfrac{\hat{V}_R}{\hat{V}_d}}  نسبت کے لیے \عددی{Q}، \عددی{\omega_0} اور \عددی{\omega} پر مبنی عمومی مساوات حاصل کریں۔مساوات \حوالہ{مساوات_تعددی_معیاری_مستقل_تعریف} سے \عددی{\tfrac{L}{R}=\tfrac{Q}{\omega_0}} اور \عددی{\tfrac{1}{RC}=Q\omega_0} کو دور کے رکاوٹ میں  پر کرتے ہیں۔
\begin{align*}
...
\end{align*}
سے مزاحمتی دباؤ \عددی{\hat{V}_R=\hat{I} R} لکھ کر دباؤ کی نسبت  لکھتے ہیں
\begin{align*}
\frac{\hat{V}_R}{\hat{V}_d}&=\frac{1}{1+jQ\big(\frac{\omega}{\omega_0}-\frac{\omega_0}{\omega}\big)}
\end{align*}
جس کی مطلق مقدار \عددی{M(\omega)} اور زاویہ \عددی{\phi(\omega)} درج ذیل ہیں جنہیں شکل \حوالہ{شکل_تعددی_مقداری_اور_زاویائی_خط} میں دکھایا گیا ہے۔
\begin{align}
...
مساوات \حوالہ{مساوات_تعددی_معیاری_مستقل_تعریف} کے تحت زیادہ \عددی{Q} کے لیے کم \عددی{R} درکار ہے اور مساوات \حوالہ{مساوات_تعددی_عرض_پٹی_تعریف} کے تحت تنگ عرض پٹی کے لیے زیادہ \عددی{Q} درکار ہے۔یوں تنگ \عددی{Q} کم \عددی{R} کی صورت میں حاصل ہو گا۔تنگ عرض پٹی کا دور نہایت عمدگی سی مخصوص تعدد کو چنے کی صلاحیت رکھتا ہے۔شکل \حوالہ{شکل_تعددی_عرض_پٹی_بالمقابل_معیاری_مستقل} میں مختلف \عددی{Q} کے لیے مساوات \حوالہ{مساوات_تعددی_مقداری_عمومی} کو دکھایا گیا ہے۔داخلی اشارات سے صرف وہ اشارات خارجی جانب پہنچتے ہیں جو عرض پٹی پر پائے جاتے ہوں۔عرض پٹی سے باہر تعدد کے اشارات گھٹتے ہیں۔یوں \عددی{RLC} بطور پٹی گزار چھلنی کام کرتا ہے۔
\begin{figure}
\centering
\begin{tikzpicture}
\pgfmathsetmacro{\wL}{-1+sqrt(2)}
...
معیاری مستقل \عددی{Q} کو توانائی کے نقطہ نظر سے دیکھا جا سکتا ہے۔شکل \حوالہ{شکل_تعددی_امالہ_معیاری_مستقل_توانائی_کے_نقطہ_نظر} پر غور کریں جہاں \عددی{RLC} کو گمکی تعدد کا اشارہ مہیا کیا گیا ہے۔گمکی تعدد پر رکاوٹ \عددی{\bZ=R} ہوتی ہے لہٰذا \عددی{i(t)=\tfrac{V_m}{R}\cos \omega_0 t\,\si{\ampere}} اور برق گیر کا دباؤ 
\begin{align*}
...
\end{align}
دور میں کُل ذخیرہ توانائی ان دونوں کا مجموعہ ہے
\begin{gather}
...
\end{aligned}
\end{gather}
جہاں آخری قدم پر \عددی{\cos^2 \theta+\sin^2 \theta=1} کا استعمال کیا گیا ہے۔یوں دور میں کُل ذخیرہ توانائی وقت کے ساتھ تبدیل نہیں ہوتی اور اس کی مقدار اٹل ہے۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
...
گمکی تعدد پر سلسلہ وار \عددی{RLC} میں کُل \عددی{\tfrac{LV_m^2}{2R^2}} توانائی ذخیرہ ہوتی ہے۔آئیں تعدد کے ایک چکر میں توانائی کا ضیاع \عددی{w_{\text{ضیاع}}} دریافت کریں۔توانائی صرف مزاحمت میں ضائع ہوتی ہے۔
\begin{align*}
w_{\text{ضیاع}}=\int_0^T i^2(t) R \dif t=\int_0^T \left(\frac{V_m}{R}\cos \omega_0 t\right)^2 R \dif t=\frac{V_m^2 T}{2R}
\end{align*}
کُل ذخیرہ توانائی اور فی چکر توانائی کے ضیاع کی نسبت  لکھتے ہیں۔
\begin{align*}
...
مساوات \حوالہ{مساوات_تعددی_گمکی_دباو_تعلقات} کے تحت سلسلہ وار \عددی{RLC} دور میں گمکی تعدد پر امالی دباؤ اور برق گیر دباؤ کی قیمتیں داخلی دباؤ کے \عددی{Q} گنا ہوتی ہیں۔ آئیں دیکھیں کہ آیا امالی دباؤ اور برق گیر دباؤ کی زیادہ سے زیادہ قیمت گمکی تعدد پر ہی پائی جاتی ہے یا کہ کسی دوسری تعدد پر۔شکل \حوالہ{شکل_تعددی_برق_گیر_زیادہ_سے_زیادہ-دباؤ} کو دیکھتے ہوئے برق گیر کا دباؤ لکھتے ہیں
\begin{align*}
...
\end{aligned}
\end{gather}
لکھا جا سکتا ہے۔درج بالا مساوات کے تحت زیادہ سے زیادہ دباؤ گمکی تعدد پر نہیں پایا جاتا اگرچہ \عددی{Q} کی قیمت زیادہ ہونے کی صورت میں درج بالا تعدد تقریباً گمکی تعدد ہی ہو گی۔مساوات \حوالہ{مساوات_تعددی_زیادہ_سے_زیادہ_دباو_کی_تعدد} کو مساوات \حوالہ{مساوات_تعدد_زیادہ_دباو_اور_تعدد} میں پر کرتے ہوئے اور \عددی{\omega_0^2=\tfrac{1}{LC}} اور \عددی{\omega_0^2 R^2 C^2=\tfrac{1}{Q^2}} استعمال کرتے ہوئے زیادہ سے زیادہ دباؤ کی قیمت حاصل ہوتی ہے
\begin{align}
...
\end{tikzpicture}
\caption{برق گیر پر زیادہ سے زیادہ دباؤ۔}
\label{شکل_تعددی_برق_گیر_زیادہ_سے_زیادہ-دباؤ}
\end{figure}
%=======================
\ابتدا{مثال}\شناخت{مثال_تعددی_پسند_اور_معیاری_مستقل}
شکل \حوالہ{شکل_تعددی_برق_گیر_زیادہ_سے_زیادہ-دباؤ} میں \عددی{L=\SI{10}{\milli\henry}} اور \عددی{C=\SI{1}{\micro\farad}} ہیں۔مزاحمت کی قیمت \عددی{\SI{50}{\ohm}} اور \عددی{\SI{1}{\ohm}} ہونے کی صورت میں  \عددی{\omega_0} اور \عددی{\omega_{\text{\RL{بلندتر}}}} دریافت کریں۔
...
\end{align}
شکل \حوالہ{شکل_تعددی_فراوانی_بالمقابل_تعدد} میں اس تبادلی تفاعل کا مطلق قیمت بالمقابل تعدد خط دکھایا گیا ہے۔گمکی تعدد پر امالی تاثیر زیادہ غالب ہے جبکہ زیادہ تعدد پر برق گیر تاثیر زیادہ غالب ہے۔عین گمکی تعدد پر ایصالی فراوانی پائی جاتی ہے۔
\begin{figure}
\centering
\begin{tikzpicture}
...
\end{figure}
شکل \حوالہ{شکل_تعددی_متوازی_دوری_سمتیات} میں داخلی دباؤ \عددی{\hat{V}_d} کے حوالے سے متوازی \عددی{RLC} کے دوری سمتیات دکھائے گئے ہیں۔ گمکی تعدد سے کم تعدد پر امالی رو غالب ہے لہٰذا داخلی دباؤ سے رو پیچھے ہے جبکہ گمکی تعدد سے زیادہ تعدد پر برق گیر رو زیادہ غالب ہے لہٰذا داخلی دباؤ سے رو آگے ہے۔عین گمکی تعدد پر داخلی دباؤ اور رو ہم قدم ہیں۔
\begin{figure}
\centering
\begin{tikzpicture}
\pgfmathsetmacro{\l}{2}
...
شکل \حوالہ{شکل_تعددی_متوازی_گمک} میں داخلی دباؤ گمکی تعدد پر تصور کرتے ہوئے \عددی{\hat{V}_d=V_m\phase{0^{\circ}}\,\si{\volt}} یعنی \عددی{v_d=V_m\cos \omega_0 t \,\si{\volt}} فرض کریں۔امالہ گیر کی رو
...
آئیں اب گمکی تعدد کے ایک چکر میں توانائی کا ضیاع دریافت کریں۔امالہ گیر اور برق گیر میں توانائی کا ضیاع ممکن نہیں ہے۔توانائی صرف \عددی{G} یعنی \عددی{R} میں ضائع ہو گی۔مزاحمت پر \عددی{V_m} حیطے کا دباؤ لاگو ہے جس کی مؤثر قیمت \عددی{\tfrac{V_m}{\sqrt{2}}} ہے۔یوں مزاحمت میں طاقتی ضیاع درج ذیل ہو گا۔
\begin{align*}
...
\end{aligned}
\end{gather}
یوں متوازی \عددی{RLC} دور میں رو کا کردار وہی ہے جو سلسلہ وار \عددی{RLC} میں دباؤ کا تھا۔متوازی \عددی{RLC} میں \عددی{Q>1} کی صورت میں گمکی تعدد پر امالہ گیر اور برق گیر کو رو منبع کی رو سے زیادہ ہو گی۔ 
%==================
\ابتدا{مثال}
متوازی جڑے \عددی{RLC} میں \عددی{G=\SI{0.01}{\siemens}}، \عددی{L=\SI{1}{\milli\henry}} اور \عددی{C=\SI{10}{\micro\farad}} ہیں۔اس کو گمکی تعدد پر \عددی{\hat{V}_d=22\phase{0^{\circ}}\,\si{\volt}} دباؤ فراہم کی جاتی ہے۔گمکی تعدد اور پرزوں میں رو دریافت کریں۔ 
...
\end{align*}
استعمال کرتے ہوئے خارجی دباؤ لکھتے ہوئے
\begin{align*}
...
\end{tikzpicture}
\caption*{(الف) تین رتبی زنجیری ایمپلیفائر۔}
\end{subfigure}
\begin{subfigure}{1\textwidth}
\centering
\begin{tikzpicture}
...
\end{figure} 
ہمسر ایمپلیفائر کے دور میں \عددی{\hat{I}_d=-A_g\hat{V}_1} لینے سے شکل \حوالہ{شکل_تعددی_متوازی_عرض_پٹی} حاصل ہوتا ہے لہٰذا مساوات \حوالہ{مساوات_تعددی_متوازی_تبادلی_تفاعل_داخلی_رو} سے پہلے ہمسر ایمپلیفائر کے لیے
\begin{align}\label{مساوات_تعددی_پہلا_ایمپلیفائر}
\hat{V}_1=\frac{-A_g \hat{V}_d}{G+j(\omega C-\frac{1}{\omega L})}
\end{align}
لکھا جا سکتا ہے۔پہلے ایمپلیفائر کا خارجی اشارہ \عددی{\hat{V}_1} ہے جسے دوسرے ایمپلیفائر کو فراہم کیا جاتا ہے لہٰذا مساوات \حوالہ{مساوات_تعددی_متوازی_تبادلی_تفاعل_داخلی_رو} کو دوبارہ استعمال کرتے ہوئے دوسری کڑی کے لیے درج ذیل لکھا جا سکتا ہے
\begin{align*}
...
\end{figure}
یہاں رک کر تسلی کر لیں کہ شکل \حوالہ{شکل_تعددی_تنگ_عرض_پٹی} میں ایمپلیفائر کو استعمال کیے بغیر تین عدد متوازی \عددی{RLC} ادوار کو زنجیری جوڑنے سے  مساوات \حوالہ{مساوات_تعددی_تیسرا_ایمپلیفائر} نہیں ملتی۔بغیر ایمپلیفائر کے تین مزاحمت متوازی جڑ جاتے ہیں جن کا مجموعہ \عددی{\tfrac{R}{3}} ہو گا۔اسی طرح تین امالہ گیر متوازی جوڑنے سے \عددی{\tfrac{L}{3}} ملتا ہے اور تین برق گیر متوازی جوڑنے سے \عددی{3C} ملتا ہے۔یوں صرف \عددی{RLC} زنجیری جوڑنے سے ایک عدد \عددی{RLC} ملتا ہے۔
\انتہا{مثال}
%======================
\ابتدا{مشق}
...
%===================
\ابتدا{مثال}
شکل \حوالہ{شکل_تعددی_بہتر_متوازی_دور} میں \عددی{L=\SI{5}{\milli\henry}} اور \عددی{C=\SI{2.2}{\micro\farad}} ہیں۔تعدد \عددی{\omega_0} اور \عددی{\omega'_0} کو \عددی{R=\SI{20}{\ohm}} اور \عددی{R=\SI{0.5}{\ohm}} کے لیے حاصل کریں۔
...
\end{align}
شکل-ب میں تبادلی تفاعل کا مقداری خط دکھایا گیا ہے۔ساتھ ہی کامل بلند گزار چھلنی کا خط بھی دکھایا گیا ہے۔یہاں بھی حقیقی چھلنی کی افزائش دباؤ انقطاعی تعدد پر اشارے کی طاقت آدھی کرتی ہے۔


شکل \حوالہ{شکل_تعدد_کامل_بلند_گزار_خصلت}-الف میں دیے بلند گزار چھلنی کو اس طرح سمجھا جا سکتا ہے کہ صفر تعدد کے قریب برق گیر کی رکاوٹ انتہائی زیادہ ہو گی لہٰذا تقسیم دباؤ کے کلیے سے ظاہر ہے کہ مزاحمت پر  دباؤ انتہائی کم ہو گا۔اس کے برعکس انتہائی زیادہ  تعدد پر برق گیر کی رکاوٹ انتہائی کم ہو گی لہٰذا تقسیم دباؤ کے کلیے کے تحت پورا دباؤ مزاحمت پر پایا جائے گا۔
...
پٹی گزار چھلنی کا سادہ ترین دور شکل \حوالہ{شکل_تعدد_کامل_پٹی_گزار_خصلت} میں دکھایا گیا ہے۔اس کی افزائش دباؤ لکھتے ہوئے
\begin{gather}
...
\end{align}
جس کو شکل-ب میں دکھایا گیا ہے۔اس کی کارکردگی یوں سمجھی جا سکتی ہے کہ درمیانی تعدد یعنی گمکی تعدد \عددی{\omega_0} پر \عددی{\omega L-\tfrac{1}{\omega C}=0} ہوتا ہے لہٰذا داخلی اشارہ جوں کا توں مزاحمت پر پہنچتا ہے۔گمکی تعدد سے بہت کم تعدد پر برق گیر کی رکاوٹ بہت بڑھ جاتی ہے  لہٰذا تقسیم دباؤ کے کلیے سے ظاہر ہے کہ مزاحمت پر دباؤ بہت کم ہو گی۔اسی طرح گمکی تعدد سے بہت زیادہ تعدد پر امالی رکاوٹ کی قیمت بہت بڑھ جاتی ہے جس کی وجہ سے مزاحمت پر دباؤ بہت کم ہوتی ہے۔
%
\begin{figure}
\centering
\begin{subfigure}{0.33\textwidth}
...
مساوات \حوالہ{مساوات_تعددی_پٹی_گزار_دور_مساوات} میں صرف \عددی{\omega} متغیر مقدار ہے۔افزائش دباؤ کی زیادہ سے زیادہ قیمت  اس تعدد \عددی{\omega_0} پر حاصل ہو گی جس پر نسب نما میں قوسین کی قیمت صفر کے برابر ہو یعنی
\begin{align}
\omega_0=\frac{1}{\sqrt{LC}}
\end{align} 
اس تعدد پر \عددی{\abs{\bA_v(\omega_0)}=\SI{1}{\volt\per\volt}} حاصل ہوتا ہے۔انقطاعی تعدد پر افزائش دباؤ \عددی{\abs{\bA_v(\omega_0)}} کے \عددی{\tfrac{1}{\sqrt{2}}} گنا ہو گی۔یوں مساوات \حوالہ{مساوات_تعددی_پٹی_گزار_دور_حتمی} کو استعمال کرتے ہوئے انقطاعی تعدد کے لیے درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
...
\end{align*}
تقسیم دباؤ کے کلیے سے خارجی دباؤ لکھتے ہیں
\begin{align*}
...
\end{align*}
غیر مطلوب اشارے سے چھٹکارے کے لیے ضروری ہے کہ \عددی{\SI{50}{\hertz}} یعنی \عددی{100\pi\,\si{\radian\per\second}} پر تبادلی تفاعل  صفر کے برابر ہو۔یوں تبادلی تفاعل کا شمار کنندہ اس تعدد پر صفر کے برابر درکار ہے جس سے درج ذیل شرط حاصل ہوتی ہے۔
\begin{align}
...
&=-\frac{\bZ_2}{\bZ_1}
\end{align*}
شکل  \حوالہ{شکل_تعددی_منفی_ایمپلیفائر}-ب میں \عددی{\bZ_1} کی جگہ \عددی{R_1} نصب کیا گیا ہے جبکہ \عددی{\bZ_2} کی جگہ مزاحمت \عددی{R_2} اور برق گیر \عددی{C} متوازی جوڑے گئے ہیں لہٰذا
 \begin{align*}
\bZ_1&=R_1\\
...
&=1+\frac{\bZ_2}{\bZ_1}
\end{align*}
ہے۔شکل \حوالہ{شکل_تعددی_مثبت_ایمپلیفائر}-ب میں رکاوٹ کی جگہ نصب پرزے دکھائے گئے ہیں جہاں سے 
\begin{align*}
...
\begin{align*}
\bA_v(j\omega)&=1+\frac{\frac{R}{1+j\omega R C_2}}{\frac{1}{j\omega C_1}}\\
...
شکل \حوالہ{شکل_سوال_تعددی_رکاوٹ_ٹ} میں \عددی{c} اور \عددی{d} کے مابین \عددی{\SI{1}{\ohm}} مزاحمت نصب کرتے ہوئے \عددی{a} اور \عددی{b} کے مابین رکاوٹ دریافت کریں۔
...
\caption*{(ب)}
\end{subfigure}%
\caption{سوال \حوالہ{سوال_تعددی_ردعمل_الف} اور سوال \حوالہ{سوال_تعددی_ردعمل_الف} کے ادوار۔}
...
جوابات:\عددی{\BW=\SI{1000}{\radian}}، \عددی{R=\SI{5}{\ohm}}
\انتہا{سوال}
%======================
\ابتدا{سوال}
ایک سلسلہ وار \عددی{RLC} دور کی گمکی تعدد \عددی{\omega_0=\SI{2}{\kilo\radian\per\second}} ہے جبکہ \عددی{C=\SI{40}{\micro\farad}} اور گمکی تعدد پر کُل رکاوٹ \عددی{\SI{2.2}{\ohm}} ہے۔ مزاحمت اور امالہ کی قیمت دریافت کریں۔دور کی عرض پٹی اور معیاری مستقل بھی حاصل کریں۔

جوابات:\عددی{R=\SI{2.2}{\ohm}}، \عددی{L=\SI{6.25}{\milli\henry}}، \عددی{\BW=\SI{352}{\radian}}، \عددی{Q=5.682}  
\انتہا{سوال}
%=====================
\ابتدا{سوال}
...
جوابات:\عددی{\BW=\SI{125}{\radian}}، \عددی{\omega_H=\SI{15063}{\radian\per\second}}، \عددی{\omega_L=\SI{14938}{\radian\per\second}}
\انتہا{سوال}
%==================
...
\caption*{(ب)}
\end{subfigure}%
\caption{سوال \حوالہ{سوال_تعددی_ردعمل_دباو_الف} اور سوال \حوالہ{سوال_تعددی_ردعمل_دباو_ب} کے ادوار۔}
\label{شکل_سوال_تعددی_ردعمل_دباو_الف}
\end{figure}

جوابات:\عددی{\omega_0=\SI{3536}{\radian\per\second}}، \عددی{Q=14.1}، \عددی{\BW=\SI{250}{\radian}}، \\ \عددی{\omega_H=\SI{3663}{\radian\per\second}}،  \عددی{v_{0\text{بلندتر}}=\SI{141.51}{\volt}}

\انتہا{سوال}
%=========================
\ابتدا{سوال}\شناخت{سوال_تعددی_ردعمل_دباو_ب}
...
جوابات:\عددی{\omega_0=\SI{645}{\radian\per\second}}، \عددی{Q=0.26}، \عددی{\BW=\SI{2500}{\radian}}، \عددی{p=\SI{2}{\watt}}
\انتہا{سوال}
%==================
\ابتدا{سوال}
متوازی \عددی{RLC} کی گمکی تعدد \عددی{\omega_0=\SI{1000}{\radian\per\second}} اور گمکی تعدد پر کُل رکاوٹ \عددی{\bZ=\SI{10}{\ohm}} ہے۔دور میں \عددی{C=\SI{20}{\micro\farad}} ہے۔آپ سے گزارش ہے کہ \عددی{L}، \عددی{R}، \عددی{Q} اور \عددی{\BW} دریافت کریں۔

جوابات:\عددی{L=\SI{50}{\milli\henry}}، \عددی{R=\SI{10}{\ohm}}، \عددی{Q=0.2}، \عددی{\BW=\SI{5}{\kilo\radian}}
\انتہا{سوال}
%===================
\ابتدا{سوال}
متوازی \عددی{RLC} کی گمکی تعدد \عددی{\SI{10}{\kilo\radian\per\second}} اور گمکی تعدد پر فراوانی \عددی{\bY=\SI{1}{\milli\siemens}} ہے۔دور میں \عددی{C=\SI{1.5}{\micro\farad}} ہے۔امالہ \عددی{L} اور مزاحمت \عددی{R} معلوم کریں۔

جوابات:\عددی{L=\SI{6.67}{\milli\henry}}، \عددی{R=\SI{1}{\kilo\ohm}}
\انتہا{سوال}
%======================
\ابتدا{سوال}
متوازی \عددی{RLC} کو متغیر تعدد، \عددی{\SI{4}{\ampere}} کے منبع سے طاقت فراہم کیا گیا ہے۔دور میں \عددی{R=\SI{500}{\ohm}}، \عددی{L=\SI{80}{\milli\henry}} اور \عددی{C=\SI{10}{\micro\farad}} ہیں۔دور کی عرض پٹی، انقطاعی تعدد  اور انقطاعی تعدد پر دور کا دباؤ حاصل کریں۔

جوابات:\عددی{\BW=\SI{200}{\radian}}، \عددی{\omega_H=\SI{1222}{\radian\per\second}}، \عددی{\omega_L=\SI{1022}{\radian\per\second}}، \عددی{\SI{1414}{\volt}}، \عددی{\SI{1414}{\volt}}
\انتہا{سوال}
%===================
\ابتدا{سوال}
ایک متوازی \عددی{RLC} دور کی گمکی تعدد \عددی{\SI{1}{\mega\radian\per\second}} اور عرض پٹی \عددی{\SI{100}{\radian}} ہے۔گمکی تعدد پر دور کی کُل رکاوٹ \عددی{\SI{2000}{\ohm}} ہے۔دور کی امالہ، برق گیر گنجائش اور معیاری مستقل دریافت کریں۔

جوابات:\عددی{L=\SI{0.2}{\micro\henry}}، \عددی{C=\SI{5}{\micro\farad}}، \عددی{Q=\num{10000}}
\انتہا{سوال}
%====================
\ابتدا{سوال}
\عددی{\SI{100}{\ohm}}، \عددی{\SI{100}{\micro\farad}} اور \عددی{L} کو متوازی جوڑا گیا ہے۔دور کی گمکی تعدد \عددی{\SI{1000}{\radian\per\second}} ہے۔دور کو \عددی{i_d(t)=\cos 1000t+\cos 1500t \,\si{\ampere}} منبع سے طاقت مہیا کیا گیا ہے۔امالہ \عددی{L}، معیاری مستقل، عرض پٹی \عددی{\BW} اور  \عددی{Q} حاصل کریں۔دور پر دباؤ \عددی{v_0(t)} بھی حاصل کریں۔

جوابات:\عددی{L=\SI{10}{\milli\henry}}، \عددی{\BW=\SI{100}{\radian}}،  \عددی{Q=10}،\\
 \عددی{v_0(t)=100\cos 1000t+11.9\cos(1500t-83^{\circ})\,\si{\volt}}
\انتہا{سوال}
%================
\ابتدا{سوال}\شناخت{سوال_تعددی_گمک_الف}
شکل \حوالہ{شکل_سوال_تعددی_گمک_الف} میں گمکی تعدد پر ہے۔برقی گیر گنجائش  \عددی{C} دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [american voltage source,l={$10\cos 4t \,\si{\volt}$}]++(0,2*\y) to [short]++(2*\x,0);
\draw(0,0) to [short]++(2*\x,0);
\draw(\x,0) to [resistor,*-,l={$\SI{8}{\ohm}$}]++(0,\y) to [capacitor,-*,l={$C$}]++(0,\y);
\draw(2*\x,0) to [resistor,l_={$\SI{4}{\ohm}$}]++(0,\y) to [inductor,l_={$\SI{6}{\henry}$}]++(0,\y);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_تعددی_گمک_الف} کا دور۔}
\label{شکل_سوال_تعددی_گمک_الف}
\end{figure}

جوابات:\عددی{C=\tfrac{37\mp\sqrt{793}}{768}\,\si{\farad}}
\انتہا{سوال}
%===================
\ابتدا{سوال}\شناخت{سوال_تعددی_گمک_ب}
شکل \حوالہ{شکل_سوال_تعددی_گمک_ب} کے گمکی تعدد کی مساوات حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [short,o-]++(\x/2,0) to [capacitor,l={$C$}] ++(\x,0) to [resistor,l={$R$}]++(0,-\y) to [short,-o]++(-\x-\x/2,0);
\draw(\x/2,0) to [inductor,*-*,l={$L$}]++(0,-\y);
\draw[stealth-](\x/4,-\y/2)--++(-\x/4,0)--++(0,-\y/8)node[below]{$\bZ$};
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_تعددی_گمک_ب} کا دور۔}
\label{شکل_سوال_تعددی_گمک_ب}
\end{figure}

جوابات:\عددی{\omega_0=\tfrac{1}{\sqrt{\abs{C^2R^2-CL}}}}
\انتہا{سوال}
%===================
\ابتدا{سوال}\شناخت{سوال_تعددی_تبادلی_تفاعل_الف}
شکل \حوالہ{شکل_سوال_تعددی_تبادلی_تفاعل_الف}-الف کا تبادلی تفاعل \عددی{\tfrac{\bV_0(j\omega)}{\bV_d(j\omega)}} لکھیں اور اس کا بوڈا مقداری خط کھینچیں۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$v_d(t)$}]++(0,\y) to [resistor,l={$\SI{2}{\kilo\ohm}$}]++(\x,0) to [resistor,l={$\SI{500}{\ohm}$}]++(\x,0) to [capacitor,l={$\SI{50}{\micro\farad}$},v={$v_0(t)$}]++(0,-\y) to [short]++(-2*\x,0);
...
\centering
\begin{tikzpicture}
\begin{semilogxaxis}[small,xlabel={$\omega$},ylabel={$\abs{\bH}\,(\si{\deci\bel})$},ylabel style={rotate=-90},ylabel style={at={(axis description cs:0,1.05)}}]
\addplot[] plot coordinates {(1,0) (8,0) (80,-20)};
\end{semilogxaxis}
\end{tikzpicture}
\caption*{(ب)}
\end{subfigure}%
\caption{سوال \حوالہ{سوال_تعددی_تبادلی_تفاعل_الف} کا دور۔}
\label{شکل_سوال_تعددی_تبادلی_تفاعل_الف}
\end{figure}

جواب:\عددی{\tfrac{\bV_0(j\omega)}{\bV_d(j\omega)}=\tfrac{1}{1+j\tfrac{\omega}{8}}}، بوڈا مقداری خط شکل-ب میں دکھایا گیا ہے۔
\انتہا{سوال}
%====================
\ابتدا{سوال}\شناخت{سوال_تعددی_تبادلی_تفاعل_ب}
شکل \حوالہ{شکل_سوال_تعددی_تبادلی_تفاعل_ب}-الف کا تبادلی تفاعل \عددی{\tfrac{\bV_0(\omega)}{\bV_d(\omega)}} لکھیں۔چھلنی کی قسم لکھیں۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [short,o-]++(\x/2,0) to [inductor,l={$L$}]++(\x,0) to [short,-o]++(\x/2,0);
\draw(\x/2,0) to [short,*-]++(0,3/4*\y) to [resistor,l={$R_1$}]++(\x,0) to [short,-*]++(0,-3/4*\y);
\draw(0,-\y) to [short,o-o]++(2*\x,0);
\draw(\x+\x/2,0) to [resistor,*-*,l_={$R_2$}]++(0,-\y);
\draw(0,0) to [open,v={$\bV_d(\omega)$}]++(0,-\y);
\draw(2*\x,0) to [open,v^<={$\bV_0(\omega)$}]++(0,-\y);
\end{tikzpicture}
\caption*{(الف)}
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}
\begin{semilogxaxis}[small,xlabel={$\omega$},ylabel={\abs{\bH}},ylabel style={rotate=-90},ylabel style={at={(axis description cs:0,1.05)}},xtick={10,100},xticklabels={$\tfrac{R_1R_2}{L(R_1+R_2)}$,$\tfrac{R_1}{L}$},ytick=\empty]
\addplot[] plot coordinates {(5,0) (10,0) (100,20) (800,20)};
\end{semilogxaxis}
\end{tikzpicture}
\caption*{(ب)}
\end{subfigure}%
\caption{سوال \حوالہ{سوال_تعددی_تبادلی_تفاعل_ب} کا دور۔}
\label{شکل_سوال_تعددی_تبادلی_تفاعل_ب}
\end{figure}

جواب:$\bH=\tfrac{R_2L (j\omega+\tfrac{R_1}{L})}{j\omega+\tfrac{R_1R_2}{L(R_1+R_2)}}$، بلند گزار چھلنی۔

\انتہا{سوال}
%====================
\ابتدا{سوال}\شناخت{سوال_تعددی_تبادلی_تفاعل_پ}
شکل \حوالہ{شکل_سوال_تعددی_تبادلی_تفاعل_پ} کا تبادلی تفاعل \عددی{\tfrac{\bV_0(\omega)}{\bV_d(\omega)}} لکھیں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [capacitor,l={$C$}]++(0,\y) to [resistor,l={$R$}]++(0,\y);
\draw(\x,0) to [resistor,*-,l_={$\frac{R}{2}$}]++(0,\y) to [capacitor,-*,l_={$2C$}]++(0,\y);
\draw(2*\x,0) to [capacitor,l_={$C$}]++(0,\y) to [resistor,l_={$R$}]++(0,\y);
\draw(0,0) to [short]++(2*\x,0);
\draw(0,2*\y) to [short]++(2*\x,0);
\draw(\x,\y) to [short,*-]++(-\x/4,0)node[ground]{};
\draw(0,\y) to [short,*-o]++(-\x,0)node[left]{$v_d(t)$};
\draw(2*\x,\y) to [short,*-o]++(\x,0)node[right]{$v_0(t)$};
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_تعددی_تبادلی_تفاعل_پ} کا دور۔}
\label{شکل_سوال_تعددی_تبادلی_تفاعل_پ}
\end{figure}

جواب:\عددی{\tfrac{-\omega^2+\tfrac{1}{R^2C^2}}{-\omega^2+\tfrac{j4\omega}{RC}+\tfrac{1}{R^2C^2}}}
\انتہا{سوال}
%===============================
\ابتدا{سوال}\شناخت{سوال_تعددی_تبادلی_تفاعل_ت}
شکل \حوالہ{شکل_سوال_تعددی_تبادلی_تفاعل_ت} کا تبادلی تفاعل \عددی{\tfrac{\bV_0(\omega)}{\bV_d(\omega)}} لکھیں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [inductor,o-,l={$\SI{8}{\henry}$}]++(\x,0) to [short,-o]++(\x+\x/2,0);
\draw(\x,0) to [capacitor,*-*,l_={$\SI{500}{\micro\farad}$}]++(0,-\y);
 \draw(\x+\x/2,0)to [resistor,*-*,l={$\SI{100}{\ohm}$}]++(0,-\y);
\draw(0,-\y) to [short,o-o]++(2*\x+\x/2,0);
\draw(0,0) to [open,v={$\bV_d(\omega)$}]++(0,-\y);
\draw(2*\x+\x/2,0) to [open,v^<={$\bV_0(\omega)$}]++(0,-\y);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_تعددی_تبادلی_تفاعل_ت} کا دور۔}
\label{شکل_سوال_تعددی_تبادلی_تفاعل_ت}
\end{figure}

جواب:\عددی{\bH=\tfrac{250}{-\omega^2+j20\omega+250}}
