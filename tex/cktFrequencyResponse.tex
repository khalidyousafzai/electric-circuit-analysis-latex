...
حل:نسب نما \عددی{2s^2+5s+3} کے جذر \عددی{s_1=-1} اور \عددی{s_2=-\tfrac{3}{2}} ہیں۔آپ یہاں غلط فہمی\حاشیہد{میں یہ غلطی بار بار کر چکا ہوں۔} سے درج بالا کو \عددی{\tfrac{5s+2}{(s+1)(s+\tfrac{3}{2})}} لکھ سکتے ہیں لیکن قوسین کو ضرب دیتے ہوئے واپس اصل تفاعل حاصل کرتے ہوئے \عددی{\tfrac{5s+2}{s^2+\tfrac{5}{2}s+\frac{3}{2}}} حاصل ہوتا ہے جو درج بالا مساوات سے مختلف ہے۔ایسی غلطی سے بچنے کی خاطر پہلے دیے گئے تفاعل کے نسب نما اور شمار کنندہ کو یوں لکھیں کہ  ان کے بلند تر  درجہ \عددی{s} کا عددی سر اکائی کے برابر ہو۔ 
\begin{align*}
...
\end{aligned}
\end{gather}
مساوات \حوالہ{مساوات_تعددی_ڈیسی_بیل_تعریف} میں دیے ڈیسی بیل کے کلیے اتنے مقبول ہوئے ہیں کہ غیر یکساں مزاحمت کی صورت میں بھی دباؤ کی تناسب یا رو کی تناسب کو انہیں کلیوں سے ڈیسی بیل میں ناپا جاتا ہے۔
%===============
\ابتدا{مشق}
...
\caption*{(ب)}
\end{subfigure}
\caption{مختلف تقصیری تناسب کے لیے مخلوط جوڑی دار قطب کے تفاعل کے خط۔}
...
آئیں شکل \حوالہ{شکل_تعدد_سلسلہ_وار_الف} میں دکھائے گئے سلسلہ وار \عددی{RLC} دور  میں \عددی{\tfrac{\hat{V}_R}{\hat{V}_d}} تناسب کے لیے \عددی{Q}، \عددی{\omega_0} اور \عددی{\omega} پر مبنی عمومی مساوات حاصل کریں۔مساوات \حوالہ{مساوات_تعددی_معیاری_مستقل_تعریف} سے \عددی{\tfrac{L}{R}=\tfrac{Q}{\omega_0}} اور \عددی{\tfrac{1}{RC}=Q\omega_0} کو دور کے رکاوٹ میں  پر کرتے ہیں۔
\begin{align*}
...
\end{align*}
سے مزاحمتی دباؤ \عددی{\hat{V}_R=\hat{I} R} لکھ کر دباؤ کا تناسب لکھتے ہیں
\begin{align*}
...
\end{align*}
کُل ذخیرہ توانائی اور فی چکر توانائی کے ضیاع کا تناسب لکھتے ہیں۔
\begin{align*}
