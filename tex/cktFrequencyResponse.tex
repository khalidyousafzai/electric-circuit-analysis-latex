...
\end{align*}
طاقت کے کلیے \عددی{P=\tfrac{\VrmsS}{R}} سے آٹھ اوہم کے سپیکر کو دس واٹ طاقت کے لیے درکار موثر دباو حاصل کرتے ہیں۔
\begin{align*}
...
%==================
\ابتدا{سوال}
متوازی \عددی{RLC} کی گمکی تعدد \عددی{\omega_0=\SI{1000}{\radian\per\second}} اور گمکی تعدد پر کل رکاوٹ \عددی{\bZ=\SI{10}{\ohm}} ہے۔دور میں \عددی{C=\SI{20}{\micro\farad}} ہے۔آپ سے گزارش ہے کہ \عددی{L}، \عددی{R}، \عددی{Q} اور \عددی{\BW} دریافت کریں۔
...
%===================
\ابتدا{سوال}
ایک متوازی \عددی{RLC} دور کی گمکی تعدد \عددی{\SI{1}{\mega\radian\per\second}} اور عرض پٹی \عددی{\SI{100}{\radian}} ہے۔گمکی تعدد پر دور کی کل رکاوٹ \عددی{\SI{2000}{\ohm}} ہے۔دور کی امالہ، برق گیر گنجائش اور معیاری مستقل دریافت کریں۔
