...
اب تک بدلتا رو طاقت کی بات کرتے ہوئے  ایک عدد منبع دباو کی بات کی جاتی رہی۔حقیقت میں بدلتا رو طاقت کی پیدا وار اور ترسیل تین دوری نظام سے کی جاتی ہے۔شکل \حوالہ{شکل_تین_دوری_تین_دوری_نظام} میں تین دوری نظام دکھایا گیا ہے جہاں تین عدد منبع استعمال کیے گئے ہیں جو آپس میں \عددی{120^{\circ}} زاویائی فاصلہ رکھتے ہیں۔تمام دباو کے حیطے یک برابر ہونے کی صورت میں اس کو \اصطلاح{متوازن تین دوری نظام}\فرہنگ{متوازن!تین دوری نظام}\فرہنگ{تین دور!متوازن}\حاشیہب{balanced three phase system}\فرہنگ{three phase balanced system} کہا جاتا ہے۔دکھائے گئے متوازن نظام کے دباو درج ذیل ہیں جن کے دوری سمتیات کو شکل-ب میں دکھایا گیا ہے۔
\begin{gather}
\begin{aligned}
...
%=================
\ابتدا{مشق}
متوازن \عددی{abc} ترتیب کے تین دوری ستارہ دباو  میں \عددی{\hat{V}_{an}=230\phase{30^{\circ}}\,\si{\volt\rms}} ہے۔باقی دو مؤثر ستارہ دباو حاصل کرتے ہوئے مؤثر دباو تار بھی حاصل کریں۔
...
%==================
\ابتدا{مشق}
متوازن تین دوری \عددی{abc} ستارہ نظام میں \عددی{\hat{V}_{ab}=415\phase{0^{\circ}}\,\si{\volt\rms}} ہے۔ دباو تار کا تکون شکل \حوالہ{شکل_تین_دوری_تار_تعلق}-الف کے طرز پر کھینچیں۔ترسیمی طریقے سے  مؤثر ستارہ دوری دباو حاصل کریں۔
...
\end{align*}
یہاں غور کریں۔عام حالت میں تعدیلی تار پر صفر وولٹ کا دباو ہوتا ہے۔اسی لیے اس کو ٹھنڈی تار کہتے ہیں۔یہاں تعدیلی نقطے پر \عددی{\SI{172.5}{\volt}\,\rms} کا خطرناک دباو پایا جاتا ہے۔آئیں اب بلب پر دباو دیکھیں۔
...
متوازن تین دوری ستارہ ستارہ \عددی{abc} نظام میں مؤثر دوری دباو \عددی{\SI{230}{\volt}\,\rms} ہے جبکہ تار اور بوجھ کے رکاوٹ بالترتیب \عددی{0.5+j1\,\si{\ohm}} اور  \عددی{15+j12\,\si{\ohm}} ہیں۔تمام دباو بوجھ اور تار کی رو دریافت کریں۔
...
%==================
\ابتدا{مشق}
متوازن ستارہ ستارہ نظام میں تاروں میں کُل ضیاع \عددی{\SI{962}{\watt}} ہے۔بوجھ کا دوری دباو \عددی{v_{AN}=240\phase{38^{\circ}}\,\si{\volt\rms}} جبکہ اس کا آگے جزو طاقت \عددی{0.69} ہے۔تار کی رکاوٹ \عددی{1.2+j1.5\,\si{\ohm}} ہے۔بوجھ کی دوری رکاوٹ دریافت کریں۔
...
شکل \حوالہ{شکل_تین_ستارہ_اور_تکونی_دباو}-الف میں تین عدد منبع کو تین تاروں کے مابین \اصطلاح{تکونی}\فرہنگ{تکونی جوڑ}\حاشیہب{delta connected, $\Delta$}\فرہنگ{delta connection}  جوڑا گیا ہے۔مساوات \حوالہ{مساوات_تین_ستارہ_دور_تار_دباو_تعلق} دباو تار اور دوری دباو کا تعلق دیتا ہے۔یوں اگر شکل-الف کے تکونی جڑے منبع کے دباو
\begin{gather}
\begin{aligned}
...
شکل \حوالہ{شکل_تین_تکون_سے_ستارہ_الف}-الف میں تکونی منبع کی جگہ مساوی ستارہ منبع نصب کرتے ہوئے  تار کی رو اور بوجھ پر دباو  حاصل کریں۔
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
...
شکل \حوالہ{شکل_تین_ستارہ_تکونی_الف} میں \عددی{\bZ_{\text{تار}}=0.4+j0.2\,\si{\ohm}} اور \عددی{\bZ_{\text{بوجھ}}=12+j4\,\si{\ohm}} ہیں۔ بوجھ پر مؤثر دباو تار دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
%delta supplies
...
\حصہ{طاقت کے کلیات}
چاہے بوجھ ستارہ جڑا ہو یا تکونی، فی دور حقیقی طاقت اور  متعاملی طاقت درج ذیل ہوں گے جہاں \عددی{V_p} مؤثر دوری دباو، \عددی{I_p} مؤثر دوری رو اور \عددی{\theta} ان کے مابین زاویہ یعنی زاویہ رکاوٹ \عددی{\theta_z} ہیں۔
\begin{gather}
...
%======================
\ابتدا{مثال}
شکل \حوالہ{شکل_تین_دوری_جزو_طاقت_تکونی_بوجھ}-الف میں تکونی بوجھ دکھایا گیا ہے۔جزو طاقت کے لیے دباو اور رو کے مابین زاویائی فرق جاننا ضروری ہے۔رو \عددی{\hat{I}} کا زاویہ  دباو \عددی{\hat{V}_1} سے ناپا جائے گا کہ دباو \عددی{\hat{V}_2} سے ناپا جائے گا؟
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
%===========================
\ابتدا{مثال}
ستارہ ستارہ نظام میں منبع کا دوری دباو \عددی{\SI{200}{\volt}\,\rms} ہے۔تار کی رکاوٹ \عددی{0.5+j0.8\,\si{\ohm}} اور بوجھ کے ایک شاخ کی رکاوٹ \عددی{10+j4\,\si{\ohm}} ہے۔بوجھ کے ایک شاخ پر حقیقی اور متعاملی طاقت دریافت کریں۔منبع کی کُل حقیقی، متعاملی اور مخلوط طاقت دریافت کریں۔
...
شکل \حوالہ{شکل_تین_متوازن_نظام_بڑا_بوجھ_مثال_الف} میں متوازن تین دوری نظام دکھایا گیا ہے۔تار میں کُل ضیاع کو بوجھ پر \عددی{\SI{11}{\kilo\volt}\,\rms} دباو تار اور \عددی{\SI{133}{\kilo\volt}\,\rms} دباو تار کی صورت میں دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
...
جزو طاقت کے درستگی کے لیے دستیاب برق گیر کی گنجائش \عددی{\si{\kilo\var}} میں بتلائی جاتی ہے۔ساتھ ہی  استعمال کی تعدد اور مؤثر دباو بھی بتلایا جاتا ہے۔ہمارے ہاں \عددی{\SI{50}{\hertz}} درکار تعدد ہے۔
...
شکل \حوالہ{شکل_تین_دوری_جزو_طاقت_الف} میں متوازن، \عددی{abc} نظام دکھایا گیا ہے جس میں مؤثر دباو تار \عددی{\SI{11}{\kilo\volt}\,\rms} اور تعدد \عددی{\SI{50}{\hertz}} ہے۔جزو طاقت \عددی{0.97} آگے  کرنے کی خاطر درکار برق گیر \عددی{C} کی گنجائش دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
...
%=======================
\ابتدا{سوال}
تین دوری \عددی{abc} نظام میں \عددی{\bV_{an}=220\phase{90^{\circ}}\,\si{\volt\rms}} ہے۔تینوں دباو تار دریافت کریں۔
...
%=======================
\ابتدا{سوال}
تین دوری \عددی{abc} نظام میں \عددی{\bV_{an}=100\phase{30^{\circ}}\,\si{\si{\volt\rms}}} ہے۔تینوں دباو تار دریافت کریں۔
...
%=======================
\ابتدا{سوال}
تین دوری \عددی{abc} نظام میں \عددی{\bV_{ab}=200\phase{60^{\circ}}\,\si{\volt\rms}} ہے۔تینوں دباو دور دریافت کریں۔
...
%=======================
\ابتدا{سوال}
تین دوری \عددی{abc} نظام میں \عددی{\bV_{an}=240\phase{45^{\circ}}\,\si{\volt\rms}} ہے۔تینوں دباو تار دریافت کریں۔
...
%==========================
\ابتدا{سوال}
متوازن ستارہ بوجھ کو ستارہ منبع \عددی{abc} سے طاقت مہیا کیا جاتا ہے۔جزو بوجھ \عددی{0.8} امالی  جبکہ دباو  بوجھ \عددی{\hat{V}_{AN}=210\phase{0^{\circ}}\,\rms} ہے۔کُل تار کا ضیاع \عددی{\SI{300}{\watt}} ہے۔تار کی رکاوٹ \عددی{0.8+j1.2\,\si{\ohm}} ہے۔بوجھ کی رکاوٹ دریافت کریں۔
...
%==========================
\ابتدا{سوال}
ستارہ بوجھ \عددی{10+j8\,\si{\ohm}} کو \عددی{1.4+0.6j\,\si{\ohm}} رکاوٹ کے تار سے طاقت مہیا کیا جاتا ہے۔بوجھ پر دباو کا زاویہ \عددی{\phase{\hat{V}_{AN}}=45^{\circ}} ہے۔تاروں میں کُل طاقت کا ضیاع \عددی{\SI{450}{\watt}} ہے۔ دباو بوجھ اور دباو منبع حاصل کریں۔
...
\end{itemize}
بوجھ پر مؤثر دباو تار \عددی{\SI{440}{\volt}\,\rms} ہے۔رو تار اور بوجھ پر کُل جزو طاقت دریافت کریں۔
...
\end{itemize}
بوجھ پر مؤثر دباو تار \عددی{\SI{440}{\volt}\,\rms} ہے۔تار کی رکاوٹ کو نظر انداز کرتے ہوئے منبع پر مؤثر دباو تار اور جزو طاقت دریافت کریں۔
...
\end{itemize}
تار کی رکاوٹ \عددی{0.2+j0.6\,\si{\ohm}} ہے جبکہ بوجھ پر مؤثر دباو تار \عددی{\SI{415}{\volt}\,\rms} ہے۔منبع پر دباو تار اور جزو طاقت دریافت کریں۔
