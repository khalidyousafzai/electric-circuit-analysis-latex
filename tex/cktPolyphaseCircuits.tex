...
%==================
\ابتدا{مشق}
مثال \حوالہ{مثال_تین_دوری_جزو_طاقت_الف} میں برق گیر کو ستارہ کے بجائے تکونی نسب کرتے ہوئے  \عددی{0.97} امالی جزو طاقت حاصل کیا جاتا ہے۔برق گیر \عددی{C} کی گنجائش دریافت کریں۔
