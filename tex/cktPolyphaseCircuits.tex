...
شکل \حوالہ{شکل_تین_ستارہ_تکونی_الف} میں \عددی{\bZ_{\text{تار}}=0.4+j0.2\,\si{\ohm}} اور \عددی{\bZ_{\text{بوجھ}}=12+j4\,\si{\ohm}} ہیں۔ بوجھ پر موثر دباو تار دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
%delta supplies
...
جزو طاقت کے درستگی کے لیے دستیاب برق گیر کی گنجائش \عددی{\si{\kilo\var}} میں بتلائی جاتی ہے۔ساتھ ہی  استعمال کی تعدد اور موثر دباو بھی بتلایا جاتا ہے۔ہمارے ہاں \عددی{\SI{50}{\hertz}} درکار تعدد ہے۔
