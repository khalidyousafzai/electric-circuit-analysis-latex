...
\caption*{(ب)}
\end{subfigure}%
\caption{متوازن ستارہ ستارہ (\عددیء{YY}) نظام۔}
...
\حصہ{تکونی بوجھ}
شکل \حوالہ{شکل_تین_دوری_ستارہ_تکونی_الف} میں ستارہ منبع کے ساتھ \اصطلاح{تکونی بوجھ}\فرہنگ{تکونی!بوجھ}\فرہنگ{بوجھ!تکونی} جوڑا گیا ہے۔بوجھ کے ایک شاخ پر دباو تار پایا جاتا ہے۔یوں اگر ستارہ دباو درج ذیل ہوں
\begin{align*}
