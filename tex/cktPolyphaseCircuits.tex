...
شکل \حوالہ{شکل_تین_دوری_تین_دوری_نظام}-ب میں  \عددی{v_{bn}} کو \عددی{v_{an}} سے \عددی{120^{\circ}} پیچھے اور \عددی{v_{cn}} کو \عددی{v_{bn}} سے \عددی{120^{\circ}}  پیچھے دکھایا گیا ہے لہٰذا اس نظام کی ترتیب \عددی{abc}\فرہنگ{abc} ہے۔تین دوری نظام میں عموماً \عددی{a}، \عددی{b}، \عددی{c} اور \عددی{n}  لئے مختلف رنگ کے تار استعمال کیے جاتے ہیں۔ہمارے ہاں لال، پیلا، نیلا اور کالا رنگ استعمال ہوتا ہے۔
...
جزو طاقت کے درستگی کے لئے دستیاب برق گیر کی گنجائش \عددی{\si{\kilo\var}} میں بتلائی جاتی ہے۔ساتھ ہی  استعمال کی تعدد اور موثر دباو بھی بتلایا جاتا ہے۔ہمارے ہاں \عددی{\SI{50}{\hertz}} درکار تعدد ہے۔
