...
\draw(0,0) to [resistor,l_={$\SI{4}{\kilo\ohm}$}]++(0,\y)node[left]{$V_1$} to [resistor,l={$\SI{8}{\kilo\ohm}$}]++(\x,0) to [resistor,l={$\SI{2}{\kilo\ohm}$}]++(\x,0) to [short,i<={$i_p$}]++(\x/2,0);
\draw(0,\y) to [short,*-]++(0,\y/2) to [resistor,l={$\SI{10}{\kilo\ohm}$}]++(2*\x,0) to [short,-*]++(0,-\y/2);
...
\begin{align*}
i_p=\frac{1-\frac{8}{23}}{10000}+\frac{1-3\times \frac{4}{23}}{2000}+\frac{1}{6000}=\frac{65}{138}\, \si{\milli\ampere}
\end{align*}
