\باب{مسئلے}
گزشتہ ابواب میں ہم نے ادوار میں مختلف مقامات پر دباو اور رو حاصل کرنے کے چند ترکیب دیکھے۔ایسا کرتے ہوئے ہم نے چند حقائق کا استعمال کیا جنہیں یہاں دوبارہ پیش کرتے ہیں۔
...
شکل \حوالہ{شکل_مسئلہ_خطیت_ب} میں \عددی{V_R=\SI{2}{\volt}}  تصور کرتے ہوئے منبع دباو کی قیمت دریافت کریں۔خطیت کے استعمال سے \عددی{V_S=\SI{50}{\volt}} پر \عددی{V_R} دریافت کریں۔ 
\begin{figure}
\centering
\begin{tikzpicture}
...
\ابتدا{قانون}
مسئلہ خطی میل کے تحت کسی بھی خطی دور، جس میں متعدد غیر تابع منبع دباو اور غیر تابع منبع رو پائے جاتے ہوں، میں  کسی بھی مقام پر نافذ دباو (رو)، تمام منبع کے انفرادی نافذ کردہ قیمتوں  کے مجموعے  کے برابر ہو گا۔
\انتہا{قانون}

آپ دیکھ سکتے ہیں کہ ہر منبع، دور میں یوں دباو اور رو نافذ کرتا ہے جیسے دور میں کوئی دوسرا منبع پایا ہی نا جاتا ہو۔

مسئلہ خطی میل کا عمومی ثبوت پیش کرتے ہیں۔صفحہ \حوالہصفحہ{مساوات_جوڑ_عمومی_مساوات_متعدد_منبع} پر مساوات \حوالہ{مساوات_جوڑ_عمومی_مساوات_متعدد_منبع} متعدد منبع دباو استعمال کرنے والے دور کی عمومی مساوات ہے جسے یہاں دوبارہ پیش کرتے ہیں۔
...
شکل \حوالہ{شکل_مسئلہ_مثال_منبع_انفرادی_اثر_الف} میں منبع دباو اور منبع رو کے انفرادی نافذ دباو حاصل کرتے ہوئے کُل \عددی{V_0} حاصل کریں۔
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
...
حل:منبع رو کو کھلے سر کرتے ہوئے شکل \حوالہ{شکل_مسئلہ_مثال_منبع_انفرادی_اثر_الف}-ب حاصل ہوتا ہے جس سے منبع دباو کا پیدا کردہ \عددی{V_{0}'} بذریعہ \اصطلاح{تقسیم دباو} کے کلیے سے حاصل کرتے ہیں۔
\begin{align*}
V_0'=10\left(\frac{4000}{1000+4000}\right)=\SI{8}{\volt}
\end{align*}
منبع دباو کو قصر دور کرتے ہوئے شکل \حوالہ{شکل_مسئلہ_مثال_منبع_انفرادی_اثر_الف}-پ حاصل ہوتا ہے جس سے منبع رو کا پیدا کردہ \عددی{V_{0}''} بذریعہ قانون اوہم حاصل کرتے ہیں۔
\begin{align*}
V_0''=\SI{-5}{\milli\ampere} \left(\frac{\SI{1}{\kilo\ohm}\times \SI{4}{\kilo\ohm}}{\SI{1}{\kilo\ohm}+\SI{4}{\kilo\ohm}}\right)=\SI{-4}{\volt}
\end{align*}
یوں دونوں منبع کی موجودگی میں کُل دباو \عددی{V_0'} اور \عددی{V_0''} کا مجموعہ ہو گا۔
\begin{align*}
...
حل:شکل \حوالہ{شکل_مسئلہ_منبع_دباو_منبع_رو_مجموعی} میں منبع رو کو کھلا دور کرتے ہوئے شکل \حوالہ{شکل_مسئلہ_مثال_منبع_دباو_حصہ}-الف حاصل ہوتا ہے جس سے  منبع دباو سے پیدا کُل دباو کا حصہ دریافت کیا جائے گا۔شکل \حوالہ{شکل_مسئلہ_مثال_منبع_دباو_حصہ}-ب میں شکل کو قدر مختلف صورت دی گئی ہے۔چونکہ \عددی{\SI{4}{\kilo\ohm}} کا ایک سرا کہیں نہیں جڑا لہٰذا اس کا بقایا دور پر کوئی اثر نہیں ہو گا اور اسی لیے اس کو شکل-ب میں نہیں دکھایا گیا ہے۔
...
شکل \حوالہ{شکل_مسئلہ_باری_باری_الف} میں پہلے منبع رو اور بعد میں منبع دباو کا حصہ معلوم کرتے ہوئے کُل دباو \عددی{V_0} دریافت کریں۔
...
شکل \حوالہ{شکل_مسئلہ_مساوی_دور_الف}-الف اور شکل \حوالہ{شکل_مسئلہ_مساوی_دور_الف}-ب کے  برقی سروں پر \عددی{\SI{8}{\kilo\ohm}} مزاحمت نصب کرتے ہوئے برقی سروں پر دباو اور رو حاصل کریں۔بند ڈبے کو نہیں دکھایا گیا تا کہ شکل صاف ستھری نظر آئے۔
...
شکل \حوالہ{شکل_مسئلہ_مساوی_دور_الف} کے  برقی سروں پر سلسلہ وار جڑے منبع دباو اور مزاحمت نصب کرتے ہوئے شکل \حوالہ{شکل_مسئلہ_مساوی_دور_پ} میں دکھایا گیا ہے۔انہیں حل کریں۔
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
...
شکل \حوالہ{شکل_مسئلہ_تھونن_سمجھنا_دور}-الف میں نقطہ دار لکیر کے بائیں حصے پر لکیر کے دائیں جانب دور کا اثر صرف اور صرف جوڑ \عددی{v_3} کے ذریعہ ہوتا ہے۔یوں جیسا شکل-ب میں کیا گیا، اگر جوڑ \عددی{v_3} پر دباو اسی قیمت پر رکھا جائے جو لکیر کے دائیں جانب دور کے نصب کرنے سے حاصل ہوتا ہے، تب  لکیر کے بائیں جانب دور کے متغیرات جوں کے توں رہتے ہیں۔  
...
شکل-پ میں دائیں حصے کی جگہ  منبع دباو نصب کیا گیا ہے جس کا دباو \عددی{v_0} ہے۔ 
...
\end{align*}
لکھا جا سکتا ہے۔یوں شکل-ب کی جگہ اس کا مساوی تھونن دور نصب کرتے ہوئے شکل-الف کی جگہ شکل-ت حاصل ہوتا ہے جسے دیکھتے ہوئے  تقسیم دباو کے کلیے سے بوجھ پر دباو  درج ذیل لکھا جا سکتا ہے۔
\begin{align}
...
\end{align*}
حاصل ہوتا ہے۔تھونن مزاحمت اور نارٹن رو جانتے ہوئے   \عددی{\SI{8}{\kilo\ohm}} بوجھ کے علاوہ \حوالہ{شکل_مثال_تھونن_سے_نارٹن_ث}-الف کے بقایا دور کا مساوی نارٹن  دور شکل \حوالہ{شکل_مثال_تھونن_سے_نارٹن_ث}-ت میں دکھایا گیا ہے جہاں نارٹن رو کی قیمت منفی ہونے کی  وجہ سے اسے الٹ سمت میں دکھایا گیا ہے۔نارٹن مساوی دور کے ساتھ \عددی{\SI{8}{\kilo\ohm}} بوجھ جوڑنے سے شکل-ٹ حاصل ہوتی ہے۔اس شکل کو دیکھ کر درکار دباو درج ذیل لکھی جا سکتی ہے۔
\begin{align*}
...
حل:شکل \حوالہ{شکل_مسئلہ_مثال_تھونن_تابع-منبع_الف}-ب میں برقی سروں \عددی{AB} پر پیمائشی دباو لاگو کرتے ہوئے \عددی{i_p} حاصل کرتے ہیں۔پیمائشی دباو کی قیمت کچھ بھی چنی جا سکتی ہے۔ہم نے  \عددی{v_p=\SI{1}{\volt}} چنا ہے۔نچلی جوڑ کو زمین چنتے ہوئے  درج ذیل مساوات لکھے جا سکتے ہیں
\begin{align*}
...
دور کی تھونن مزاحمت حاصل کرنے کی خاطر برقی سروں پر بیرونی منبع نصب کرنا ہو گا۔شکل \حوالہ{شکل_مسئلہ_مثال_تھونن_تابع-منبع_ب}-ب میں برقی سروں پر
 \عددی{i_p=\SI{1}{\milli\ampere}} کا پیمائشی رو نصب کیا گیا ہے۔برقی سروں پر پیمائشی دباو \عددی{v_p} جانتے ہوئے  تھونن مزاحمت حاصل کی جا سکتی ہے۔
...
گزشتہ مثال کے دور کو سلسلہ وار جڑے بیرونی منبع  اور مزاحمت سے طاقت مہیا کی جاتی ہے۔شکل \حوالہ{شکل_مسئلہ_مثال_تھونن_تابع-منبع_پ} میں اسے دکھایا گیا ہے۔برقی سروں پر دباو \عددی{v_0} اور رو \عددی{i_0} حاصل کریں۔اب گزشتہ مثال کے دور کی جگہ اس کا مساوی تھونن دور نصب کرتے ہوئے دوبارہ حل کریں۔
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
...
\end{align*}
شکل \حوالہ{شکل_مسئلہ_تابع_غیر_تابع_مثال_الف}-ب کی جگہ تھونن مساوی دور نصب کرتے ہوئے شکل-الف سے شکل-ٹ حاصل ہوتا ہے جس سے تقسیم دباو کے کلیے سے 
\begin{align*}
...
مسئلہ نارٹن کے استعمال میں بالکل اسی طرح چلتے ہوئے آخری قدم پر متوازی جڑے قصر دور رو \عددی{I_{\text{قصر}}} اور تھونن مزاحمت \عددی{R_{\text{تھونن}}} کے ساتھ بوجھ جوڑتے ہوئے بوجھ کا دباو اور رو حاصل کی جاتی ہیں۔ 
...
حل:بوجھ کے علاوہ بقایا دور کا تھونن مساوی حاصل کرتے ہیں۔تھونن دباو کی خاطر بوجھ کو ہٹاتے ہوئے شکل \حوالہ{شکل_مسئلہ_طاقت_منتقلی_الف}-ب سے \عددی{V_{\text{کھلا}}} حاصل کرتے ہیں۔شکل-ب سے
\begin{align*}
...
\end{align*}
تھونن مزاحمت اور دباو سے تھونن مساوی دور کے ساتھ بقایا پرزے جوڑنے سے شکل-ٹ حاصل ہوتا ہے۔ یاد رہے کہ زیادہ سے زیادہ طاقت کی منتقلی کے لیے ضروری ہے کہ بوجھ کی مزاحمت بقایا تمام دور کے تھونن مزاحمت کے برابر ہو۔شکل \حوالہ{شکل_مسئلہ_طاقت_منتقلی_ب}-ٹ کو دیکھتے ہوئے یوں زیادہ سے زیادہ طاقت کی منتقلی کے لیے درکار مزاحمت
\begin{align*}
