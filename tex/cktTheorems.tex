...
شکل \حوالہ{شکل_مسئلہ_مشق_تھونن_الف} میں دور دکھایا گیا ہے جسے  مسئلہ تھونن سے حل کرتے ہوئے \عددی{V_0} حاصل کریں۔(دائیں جانب نسب \عددی{\SI{2}{\kilo\ohm}} سے دیکھتے ہوئے بقایا دور کا تھونن دور حاصل کرتے ہوئے حل کریں۔)
\begin{figure}
\centering
\begin{tikzpicture}
...
مسئلہ نارٹن کی مدد سے شکل \حوالہ{شکل_مسئلہ_مشق_تھونن_پ} میں \عددی{I_0} حاصل کریں۔(دائیں جانب نسب \SI{4}{\kilo\ohm} مزاحمت  کے ساتھ منسلک دور کا نارٹن مساوی حاصل کرتے ہوئے حل کریں۔)
\begin{figure}
\centering
\begin{tikzpicture}
