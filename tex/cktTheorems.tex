...
\draw(3.5,1.25)node[rotate=90]{\RL{دایاں حصہ}};
...
شکل  \حوالہ{شکل_مسئلہ_تھونن_عمومی_دور}-پ میں \عددی{i} کو مسئلہ نفاذ کی مدد سے دو حصوں میں تقسیم  کیا جا سکتا ہے۔ پہلا حصہ \عددی{i'} ڈبہ دور کے اندر منبع نافذ کرتے ہیں جبکہ دوسرا حصہ \عددی{i''} بیرونی  منبع \عددی{v_0} نافذ کرتا ہے۔جیسا شکل \حوالہ{شکل_مسئلہ_ڈبہ_دور_دباو_اور_رو}-الف میں دکھایا گیا ہے،  \عددی{i'} حاصل کرتے وقت بیرونی منبع کو قصر دور کیا جاتا ہے لہٰذا اس رو کو \عددی{i_{\text{قصر}}} کہا  جاتا ہے۔
\begin{align}
i'=i_{\text{قصر}}
\end{align}
...
i_{\text{قصر}}=\frac{v_{\text{کھلا}}}{R_{\text{تھونن}}}
\end{align}
یا
\begin{align}\label{مساوات_مسئلہ_تھونن_ت}
v_{\text{کھلا}}= i_{\text{قصر}} R_{\text{تھونن}}
\end{align}
...
\end{tikzpicture}
\caption{کھلا دور سروں پر صفر رو اور کھلے دور دباو پائی جاتی ہے۔}
\label{شکل_مسئلہ_کھلا_دور_تھونن}
\end{figure}

مساوات \حوالہ{مساوات_مسئلہ_تھونن_الف} مسئلہ نارٹن بیان کرتی ہے جسے شکل \حوالہ{شکل_مسئلہ_تھونن_نارٹن}-الف میں دکھایا گیا ہے جبکہ مساوات \حوالہ{مساوات_مسئلہ_تھونن_ٹ} مسئلہ تھونن بیان کرتی ہے جسے شکل \حوالہ{شکل_مسئلہ_تھونن_نارٹن}-ب میں دکھایا گیا ہے۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
یوں کسی بھی دور کو شکل \حوالہ{شکل_مسئلہ_تھونن_نارٹن}-الف کا تھونن مساوی دور یا شکل \حوالہ{شکل_مسئلہ_تھونن_نارٹن}-ب کا نارٹن مساوی دور ظاہر کر سکتا ہے۔

آئیں ان کا استعمال مثالوں کو حل کرتے ہوئے دیکھیں۔
...
\end{align*}
لکھا جا سکتا ہے۔شکل-ت سے تقسیم دباو کے کلیے سے خارجی دباو درج ذیل لکھا جا سکتا ہے۔
\begin{align}
...
حل:نارٹن مساوی دور میں \عددی{R_{\text{تھونن}}} کے ساتھ ساتھ \عددی{i_{\text{قصر}}} بھی درکار ہے۔تھونن مزاحمت کو گزشتہ مثال میں حاصل کیا گیا ہے لہٰذا صرف قصر دور رو معلوم کرنا باقی ہے۔شکل \حوالہ{شکل_مسئلہ__مثال_تھونن_ب}-الف میں دور کو قصر دور کیا دکھایا گیا ہے جس سے  \عددی{i_{\text{قصر}}} حاصل کیا جا سکتا ہے۔دور کو دیکھتے ہوئے 
\begin{align*}
V_1=\SI{3}{\volt}
\end{align*}
اور یوں
...
اس مثال میں \عددی{i_{قصر}} کو مساوات \حوالہ{مساوات_مسئلہ_تھونن_ت} سے بھی حاصل کیا جا سکتا تھا یعنی
\begin{align*}
