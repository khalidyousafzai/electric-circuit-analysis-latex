...
\end{align*}
ابتدائی معلومات کو استعمال کرتے ہوئے، سوئچ منقطع ہونے کے بعد کا لاپلاس بدل دور شکل-پ میں دکھایا گیا ہے جہاں سے \عددی{\bI(s)} لکھتے ہیں۔
\begin{align*}
...
اس کا الٹ لاپلاس بدل لیتے ہوئے درج ذیل حاصل ہوتا ہے۔
 \begin{align*}
i(t)=-e^{-\frac{5}{2}t}\left[\frac{45}{6\sqrt{201}} \sinh \left(\frac{\sqrt{201}t}{6}\right)+\frac{1}{2}\cosh \left(\frac{\sqrt{201}t}{6}\right)\right]u(t)\,\si{\ampere}
\end{align*}
\انتہا{مثال}
%================
