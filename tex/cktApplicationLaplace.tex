\باب{ادوار کا حل بذریعہ لاپلاس تبادل}
\حصہ{ادوار کا حل}
لاپلاس تبادل کا استعمال دیکھنے کی خاطر شکل \حوالہ{شکل_لاپالس_حل_امالہ_مزاحمت} میں \عددی{RL} دور کو حل کرتے ہوئے \عددی{i(t)} دریافت کرتے ہیں۔دور کی کرخوف مساوات لکھتے ہیں۔
\begin{align*}
v_d(t)=i(t)R+L\frac{\dif i(t)}{\dif t}
\end{align*}
اس دور کے  فطری حل اور جبری حل  کا مجموعہ درکار عمومی حل ہو گا۔ عمومی حل میں ابتدائی معلومات سے حاصل کردہ مستقل پر کرنے سے مخصوص حل حاصل ہو گا۔لاپلاس تبادل سے دور حل کرتے ہوئے مخصوص حل ایک ہی بار میں حاصل ہوتا ہے۔درج بالا مساوات کے دونوں اطراف کا لاپلاس تبادل لیتے ہیں۔
\begin{align*}
...
\end{align*}
آپ نے دیکھا کہ مخصوص حل یک وقت حاصل ہوتا ہے۔دور کی ابتدائی معلومات لاپلاس تبادل لیتے وقت استعمال کی جاتی ہے۔

جیسا آپ نے دیکھا، لاپلاس تبادل سے تفرقی و تکملی مساوات الجبرائی مساوات میں تبدیل ہو جاتی ہے جس سے درکار تفاعل کا لاپلاس تبادل نہایت آسانی سے حاصل ہوتا ہے۔حاصل تفاعل کا الٹ لاپلاس تبادل وقتی تفاعل دیتا ہے۔الٹ لاپلاس تبادل جدول کی مدد سے حاصل کیا جاتا ہے۔
\begin{figure}
\centering
\begin{circuitikz}
...
برقی پرزوں کی خصوصیات سے ان کے مساوی لاپلاسی ادوار حاصل کیے جا سکتے ہیں۔تمام پرزوں کے دباؤ بالمقابل رو تعلق لکھتے ہوئے غیر فعال رائج سمت استعمال کیے گئے ہیں۔مزاحمت کے دباؤ اور رو کا تعلق
\begin{align}
v(t)=R i(t)
\end{align}
ہے۔دونوں اطراف کا لاپلاس تبادل لیتے ہوئے اس تعلق کو درج ذیل لکھا جا سکتا ہے۔
\begin{align}
\bV(s)=R \bI(s)
\end{align}
شکل \حوالہ{شکل_لاپلاس_دور_مزاحمت_اظہار} میں مزاحمت کے دباؤ بالمقابل کا تعلق وقتی دائرہ کار اور مخلوط تعددی دائرہ کار میں دکھائے گئے ہیں۔
\begin{figure}
\centering
...
\end{align}
ہیں۔دونوں اطراف کا لاپلاس تبادل لیتے ہوئے مخلوط تعددی دائرہ کار میں تعلقات حاصل ہوتے ہیں جنہیں شکل \حوالہ{شکل_لاپلاس_دور_برق_گیر_اظہار} میں دکھایا گیا ہے۔ابتدائی معومات سے پیدا منبع رو کی سمت اور منبع دباؤ کے قطب پر غور کریں۔ابتدائی رو کی سمت الٹ کرنے یا ابتدائی دباؤ کے قطب الٹ کرنے سے پیدا منبع رو کی سمت اور منبع دباؤ کے قطب الٹ ہوں گے۔
\begin{align}
...
\end{align}
حاصل ہوتے ہیں۔انہیں شکل \حوالہ{شکل_لاپلاس_دور_امالہ_گیر_اظہار} میں دکھایا گیا ہے۔یہاں بھی ابتدائی معلومات سے پیدا منبع کا دارومدار ابتدائی رو کی سمت اور ابتدائی دباؤ کے قطب  پر ہے۔ 
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
...
\caption*{(ب)}
\end{subfigure}
\caption{مشترکہ امالہ کا لاپلاسی تبادل۔}
\label{شکل_لاپلاس_استعمال_مشترک_امالہ_دباو_الف}
\end{figure}

تابع اور غیر تابع منبع دباؤ اور منبع رو کو بھی \عددی{s} دائرہ کار میں ظاہر کیا جا سکتا ہے
\begin{align}
...
\حصہ{تجزیاتی تراکیب}
درج بالا حصے میں ہم نے برقی پرزوں کے \عددی{s} دائرہ کار میں مساوی ادوار حاصل کیے۔انہیں استعمال کرتے ہوئے ادوار حل کیے جا سکتے ہیں۔ایسا کرنے کی خاطر درج ذیل کرنا ہو گا۔

\begin{itemize}
\item
ابتدائی حالت جاننے کے لیے \عددی{t<\SI{0}{\second}} کے لیے دور حل کریں۔اگر \عددی{t<\SI{0}{\second}} میں دور برقرار حالت میں ہو تب برق گیر کو کھلے سر اور امالہ گیر کو قصر دور تصور کرتے ہوئے ابتدائی رو اور ابتدائی دباؤ حاصل کیے جا سکتے ہیں۔
\item
ابتدائی معلومات شامل کرتے ہوئے تمام پرزوں کی جگہ ان کے مساوی مخلوط تعددی دائرہ کار کے ادوار نصب کریں۔
\item
کسی بھی ترکیب کو استعمال کرتے ہوئے دور کو حل کریں۔جوابات \عددی{s} دائرہ کار میں ہوں گے۔
\item
الٹ لاپلاس تبادل لیتے ہوئے وقتی دائرہ کار میں جوابات حاصل کریں۔
\end{itemize}
%==================
\ابتدا{مثال}\شناخت{مثال_لاپلاس_استعمال_مزاحمت_برق_گیر_الف}
لاپلاس تبادل کی مدد سے شکل \حوالہ{شکل_لاپلاس_استعمال_مزاحمت_برق_گیر_الف}-الف میں \عددی{v_C(t)} حاصل کریں۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
حل:ابتدائی دباؤ \عددی{v_C(0)=\SI{0}{\volt}} ہے۔تمام پرزوں کی جگہ \عددی{s} دائرہ کار کے مساوی دور پر کرتے ہوئے شکل-ب حاصل ہوتا ہے۔شکل-ب میں تقسیم دباؤ کے کلیے سے برق گیر کا دباؤ لکھتے ہیں۔
\begin{align*}
\bV_C(s)&=\left(\frac{\frac{1}{2s}}{4+\frac{1}{2s}}\right)\frac{20}{s}\\
&=20\left(\frac{1}{s}-\frac{1}{s+\frac{1}{8}}\right)
\end{align*}
الٹ لاپلاس تبادل لیتے ہوئے \عددی{v_C(t)} حاصل کرتے ہیں۔
\begin{align*}
...
حل:لاپلاس تبادل شکل \حوالہ{شکل_لاپلاس_استعمال_دائری_مساوات}-ب میں دکھایا گیا ہے جہاں سے کرخوف دائری مساوات لکھتے ہیں۔
\begin{align*}
...
حل: لاپلاس مساوی شکل-ب میں دکھایا گیا ہے۔ ہم جوڑ \عددی{\bV_1(s)} کو حاصل کرتے ہوئے \عددی{\bV_0(s)} کو تقسیم دباؤ کے کلیے سے حاصل کریں گے۔ مساوات جوڑ لکھتے ہیں
\begin{align*}
...
\end{align*}
حاصل ہوتا ہے۔تقسیم دباؤ کے کلیے سے \عددی{\bV_0(s)} لکھتے ہیں۔
\begin{align*}
...
اس دباؤ کا جزوی کسری پھیلاو لکھتے ہوئے وقتی تفاعل حاصل کرنا ہو گا۔ میں یہاں گزارش کروں گا ہوں کہ آپ صفحہ \حوالہصفحہ{مثال_تعددی_درست_تجزی} پر مثال \حوالہ{مثال_تعددی_درست_تجزی} کو ضرور دیکھیں۔
\begin{align*}
...
\end{align*}
یوں تقسیم دباؤ کے کلیے سے \عددی{\bV'_1(s)}  لکھا جا سکتا ہے۔
\begin{align*}
...
\end{align*}
تقسیم دباؤ کے کلیے کو دوبارہ استعمال کرتے ہوئے \عددی{\bV'_1(s)} سے \عددی{\bV''_0(s)} لکھتے ہیں۔
\begin{align*}
...
\end{align*}
یوں تقسیم دباؤ کے کلیے سے درج ذیل لکھا جا سکتا ہے
\begin{align*}
...
\end{align*}
اور ایک مرتبہ دوبارہ تقسیم دباؤ سے 
\begin{align*}
\bV''_0(s)&=\left(\frac{6}{6+\frac{4}{s}}\right)\bV''_1(s)\\
...
آئیں اب شکل \حوالہ{شکل_لاپلاس_استعمال_متعدد_طریقے_الف}-الف کو تبادلہ منبع سے حل کریں۔دونوں منبع دباؤ کے مساوی منبع رو نصب کرتے ہوئے شکل \حوالہ{شکل_لاپلاس_استعمال_تبادلہ_منبع_الف}-الف ملتا ہے جہاں منبع دباؤ \عددی{\tfrac{8}{s}} اور اس کے سلسلہ وار \عددی{2s} کو منبع رو \عددی{\tfrac{8/s}{2s}=\tfrac{4}{s^2}} جس کے متوازی \عددی{2s} جڑا ہے میں تبدیل کیا گیا ہے۔اسی طرح منبع دباؤ \عددی{\tfrac{2}{s}} اور سلسلہ وار \عددی{2} کو منبع رو \عددی{\tfrac{2/s}{2}=\tfrac{1}{s}} میں تبدیل کیا گیا ہے جس کے متوازی \عددی{2} نصب ہے۔
...
شکل \حوالہ{شکل_لاپلاس_استعمال_تبادلہ_منبع_الف}-ب میں منبع رو \عددی{\tfrac{s+4}{s^2}} اور متوازی رکاوٹ \عددی{\tfrac{2s}{s+1}} کو سلسلہ وار جڑے منبع دباؤ \عددی{(\tfrac{s+4}{s^2})(\tfrac{2s}{s+1})=\tfrac{2(s+4)}{s(s+1)}} اور رکاوٹ \عددی{\tfrac{2s}{s+1}} میں تبدیل کرتے ہوئے شکل-پ حاصل ہوتی ہے جس سے تقسیم دباؤ کے کلیے سے \عددی{\bV_0(s)} لکھتے ہیں۔
\begin{align*}
...
&=\frac{2s}{s+1}
\end{align*}
تھونن دباؤ اور تھونن رکاوٹ استعمال کرتے ہوئے تھونن دور حاصل ہوتا ہے جس کے ساتھ بوجھ جوڑتے ہوئے  شکل \حوالہ{شکل_لاپلاس_استعمال_متعدد_تھونن}-پ حاصل ہوتی ہے جہاں سے تقسیم دباؤ کے کلیے سے \عددی{\bV_0(s)} حاصل ہو گا۔
\begin{align*}
\bV_0(s)&=\left(\frac{6}{\frac{2s}{s+1}+\frac{4}{s}+6}\right)\frac{2(s+4)}{s(s+1)}\\
&=\frac{6(s+4)}{4s^2+5s+2}
\end{align*}
...
حل: اگر \عددی{v_2(t)} معلوم کیا جائے تو \عددی{v_0(t)} کو تقسیم دباؤ کے کلیے سے حاصل کیا جا سکتا ہے۔اس دور میں مخلوط جوڑ پایا جاتا ہے لہٰذا مساوات جوڑ کی تعداد کم ہو گی۔ شکل-ب میں لاپلاس تبادل  دکھایا گیا ہے جس سے کرخوف مساوات جوڑ لکھتے ہیں
\begin{align*}
...
\end{align*}
حاصل ہوتا ہے۔تقسیم دباؤ کے کلیے سے درکار جواب لکھتے ہیں۔
\begin{align*}
\bV_0(s)&=\bV_2(s)\left(\frac{\frac{1}{s}}{1+\frac{1}{s}}\right)\\
&=\frac{10(s+1)}{s^2+2s-1}\left(\frac{\frac{1}{s}}{1+\frac{1}{s}}\right)\\
&=\frac{10}{s^2+2s-1}
\end{align*}
جزوی کسری پھیلاو حاصل کرتے ہوئے  وقتی دائرہ کار میں دباؤ حاصل ہو گا۔  نسب نما کے جذر \عددی{-1\mp \sqrt{2}} ہیں لہٰذا درج ذیل لکھا جا سکتا ہے
\begin{align*}
...
\end{align*}
لکھ کر الٹ لاپلاس تبادل لیتے ہوئے درکار دباؤ حاصل ہو گا۔
\begin{align*}
...
لاپلاس تبادل کی مدد سے کچھ ادوار ہم حل کر چکے جن میں ابتدائی رو اور دباؤ صفر تھے۔ آئیں اب چند ایسے ادوار دیکھیں جن میں ابتدائی رو یا ابتدائی دباؤ پایا جاتا ہو۔اس طرز کے ادوار  ہم پہلے باب \حوالہ{باب_عارضی_رد_عمل} میں حل کر چکے ہیں۔اس باب کے شروع میں ابتدائی رو اور ابتدائی دباؤ کو شامل کرتے ہوئے پرزوں کے لاپلاس تبادل حاصل کیے گئے نہیں شکل \حوالہ{شکل_لاپلاس_دور_مزاحمت_اظہار}، شکل \حوالہ{شکل_لاپلاس_دور_برق_گیر_اظہار} اور شکل \حوالہ{شکل_لاپلاس_دور_امالہ_گیر_اظہار} میں دکھایا گیا ہے۔انہیں کو استعمال کرتے ہوئے ادوار حل کیے جائیں گے۔
%======================

\ابتدا{مثال}\شناخت{مثال_لاپلاس_استعمال_عارضی_ردعمل_الف}
شکل \حوالہ{شکل_لاپلاس_استعمال_عارضی_ردعمل_الف} میں ازل سے ایک سوئچ منقطع اور ایک سوئچ چالو ہے۔عین \عددی{t=\SI{0}{\second}} پر چالو سوئچ کو منقطع کر دیا جاتا ہے جبکہ منقطع سوئچ کو چالو کر دیا جاتا ہے۔لمحہ \عددی{t<0} پر دور کو حل کرتے ہوئے ابتدائی دباؤ اور ابتدائی رو حاصل کرتے ہوئے \عددی{t\ge 0} پر \عددی{i_0(t)} دریافت کریں۔
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
...
حل: لمحہ \عددی{t<0} پر برق گیر کو کھلے دور جبکہ امالہ گیر کو قصر دور تصور کرتے ہوئے شکل-ب حاصل ہوتا ہے جہاں سے امالہ گیر کی ابتدائی رو \عددی{i_L(0)} اور برق گیر کا ابتدائی دباؤ \عددی{v_C(0)} حاصل ہوتے ہیں۔
\begin{align*}
i_L(0)&=\frac{2}{4}=\SI{0.5}{\ampere}\\
v_C(0)&=\SI{2}{\volt}
\end{align*}
ابتدائی معلومات کو شامل کرتے ہوئے پرزوں کے لاپلاس مساوی دور پر کرنے سے  لمحہ \عددی{t\ge 0} کے لیے شکل حاصل ہوتا ہے۔مساوات جوڑ لکھتے ہیں
\begin{align*}
...
\end{align*}
الٹ لاپلاس تبادل لیتے ہوئے درج ذیل ملتا ہے۔
\begin{align*}
...
شکل \حوالہ{شکل_لاپلاس_استعمال_عارضی_ردعمل_ب} میں ازل سے چالو سوئچ کو لمحہ \عددی{t=0} پر منقطع کیا جاتا ہے۔سوئچ منقطع ہونے کے بعد کی رو \عددی{i(t)} دریافت کریں۔
...
\end{align*}
اس کا الٹ لاپلاس تبادل لیتے ہوئے درج ذیل حاصل ہوتا ہے۔
 \begin{align*}
...
شکل \حوالہ{شکل_لاپلاس_استعمال_سوئچ_ب}-الف میں \عددی{v_0(t)} حاصل کریں۔شکل-ب میں داخلی دباؤ کی مستطیل صورت دی گئی ہے۔
\begin{figure}
\centering
\begin{subfigure}{0.6\textwidth}
\centering
...
دور میں کسی بھی دباؤ یا رو اور داخلی اشارے کی نسبت  کو جال کی \اصطلاح{تبادلی تفاعل}\فرہنگ{تبادلی تفاعل}\حاشیہب{transfer function}\فرہنگ{transfer function} یا \اصطلاح{تفاعل جال}\فرہنگ{تفاعل!جال}\فرہنگ{جال!تفاعل}\حاشیہب{network function}\فرہنگ{network!function}\فرہنگ{function!network}  کہتے ہیں۔اگر دونوں متغیرات دباؤ ہوں تب تبادلی تفاعل \اصطلاح{افزائش دباؤ}\فرہنگ{افزائش!دباؤ}\فرہنگ{دباؤ!افزائش}\حاشیہب{voltage gain}\فرہنگ{voltage!gain}\فرہنگ{gain!voltage} کہلاتا ہے، اگر دونوں متغیرات رو ہوں تب اس کو \اصطلاح{افزائش رو}\فرہنگ{افزائش!رو}\فرہنگ{رو!افزائش}\حاشیہب{current gain}\فرہنگ{current!gain}\فرہنگ{gain!current} کہتے ہیں۔اسی طرح دباؤ اور رو کی نسبت کو \اصطلاح{افزائش مزاحمت نما}\فرہنگ{افزائش!مزاحمت نما}\فرہنگ{مزاحمت نما!افزائش}\حاشیہب{transresistance gain}\فرہنگ{transcresistance!gain}\فرہنگ{gain!transresistance} کہتے ہیں جبکہ رو اور دباؤ کی نسبت  کو \اصطلاح{افزائش موصلیت نما}\فرہنگ{افزائش!موصلیت نما}\فرہنگ{موصلیت نما!افزائش}\حاشیہب{transconductance gain}\فرہنگ{transconductance!gain}\فرہنگ{gain!transconductance} کہتے ہیں۔تبادلی تفاعل کے حصول میں ابتدائی دباؤ اور ابتدائی رو کو صفر لیا جاتا ہے۔
...
\end{multline*}
تمام ابتدائی معلومات صفر ہونے کی صورت میں درج بالا کا لاپلاس تبادل درج ذیل ہو گا
\begin{multline*}
...
حل:داخلی اشارے کا لاپلاس تبادل لکھتے ہیں۔
\begin{align*}
\bV_d(s)=\frac{3}{s+4}
\end{align*}
...
\end{align*}
الٹ لاپلاس تبادل لیتے ہوئے خارجی اشارہ حاصل کرتے ہیں۔
\begin{align*}
...
تبادلی تفاعل کے قطب سے دور کے ردعمل کے بارے میں بہت کچھ جانا جاتا ہے۔ہم یک رتبی اور دو رتبی ادوار پر باب \حوالہ{باب_عارضی_رد_عمل} میں غور کر چکے ہیں۔یہاں نتائج کو دوبارہ پیش کرتے ہیں۔ایک عدد امالہ گیر یا برق گیر کی صورت میں ردعمل \عددی{y(t)=y_0e^{-\frac{t}{\tau}}} صورت رکھتا ہے جہاں \عددی{\tau} دور کا وقتی مستقل ہے۔دو رتبی ادوار کا ردعمل دور کے \اصطلاح{امتیازی مساوات}
\begin{align*}
...
شکل \حوالہ{شکل_لاپلاس_استعمال_تغیر_پذیر_برق_گیر_الف}-الف میں \اصطلاح{تغیر پذیر برق گیر}\فرہنگ{تغیر پذیر برق گیر}\فرہنگ{برق گیر!تغیر پذیر} استعمال کیا گیا ہے۔خارجی دباؤ \عددی{v_C(t)} کو \عددی{C=\SI{1}{\farad}}، \عددی{C=\SI{4}{\farad}} اور \عددی{C=\SI{10}{\farad}} کے لیے حاصل کریں۔
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
...
شکل \حوالہ{شکل_لاپلاس_استعمال_تغیر_پذیر_برق_گیر_الف}-ب میں لاپلاس تبادل دور دکھایا گیا ہے جس سے تقسیم دباؤ کے کلیے سے خارجی دباؤ لکھتے ہیں۔
\begin{align*}
\bV_C(s)&=\left(\frac{\frac{1}{sC}}{1+s+\frac{1}{sC}}\right)\frac{1}{s}\\
&=\frac{\frac{1}{C}}{s(s^2+s+\frac{1}{C})}
\end{align*}
\عددی{C=\SI{1}{\farad}}  کے لیے \عددی{\bV_C(s)} کے مساوات کو حل کرتے ہیں۔
\begin{align*}
...
امتیازی مساوات کے جذر یعنی \عددی{\bV_C(s)} کے قطبین \عددی{p_1=0}، \عددی{p_2=-\tfrac{1}{2}-j\tfrac{\sqrt{3}}{2}} اور
 \عددی{p_3=-\tfrac{1}{2}+j\tfrac{\sqrt{3}}{2}} ہیں۔یوں ایک عدد حقیقی اور مخلوط جوڑی دار قطبین پائے جاتے ہیں جو \اصطلاح{کم مقصور صورت}\فرہنگ{مقصور!کم}\فرہنگ{underdamped} حال ہے۔الٹ لاپلاس تبادل سے وقتی دائرہ کار میں خارجی دباؤ حاصل کرتے ہیں۔
\begin{align*}
v_C(t)=\left[1-e^{-\frac{t}{2}}\left(\cos \frac{\sqrt{3}t}{2}+\frac{1}{\sqrt{3}}\sin\frac{\sqrt{3}t}{2}\right)\right]u(t)\,\si{\volt}
\end{align*}
\عددی{C=\SI{4}{\farad}}  کے لیے \عددی{\bV_C(s)} کے مساوات کو حل کرتے ہیں۔
\begin{align*}
...
\end{align*}
\عددی{C=\SI{10}{\farad}}  کے لیے \عددی{\bV_C(s)} کے مساوات کو حل کرتے ہیں۔
\begin{align*}
\bV_C(s)&=\frac{0.1}{s(s^2+s+0.1)}\\
&=\frac{1}{s}+\frac{0.145}{s+0.887}-\frac{1.145}{s+0.113}
\end{align*}
اس مساوات کے قطبین \عددی{p_1=0}، \عددی{p_2=-0.887} اور \عددی{p_3=-0.113} ہیں۔یوں تینوں سادہ علیحدہ علیحدہ حقیقی قطبین ہیں لہٰذا تفاعل کا ردعمل \اصطلاح{زیادہ مقصور}\فرہنگ{مقصور!زیادہ}\فرہنگ{damped!over} ہو گا۔الٹ لاپلاس تبادل سے \عددی{v_C(t)} حاصل کرتے ہیں۔
\begin{align*}
...
حل:اکائی ضرب ردعمل تبادلی تفاعل دیتا ہے لہٰذا دیے گیے ردعمل کا لاپلاس تبادل \عددی{\bH(s)} ہو گا۔
\begin{align*}
...
آپ جانتے ہیں کہ دو رتبی کم قصری جال کا امتیازی مساوات درج ذیل ہے
\begin{align*}
...
s_2&=-\zeta \omega_0+j\omega_0 \sqrt{1-\zeta^2}
\end{align*}
کو مخلوط سطح پر شکل \حوالہ{شکل_لاپلاس_استعمال_کم_قصری_جوڑی_دار} میں دکھایا گیا ہے۔قطب \عددی{p} کو زاویائی صورت میں لکھتے ہیں۔ محدد کے مبدا \عددی{(0,0)} سے قطب کا فاصلہ مسئلہ فیثاغورث کی مدد سے حاصل کرتے ہیں
\begin{align*}
...
\end{aligned}
\end{gather}
آپ دیکھ سکتے ہیں کہ محدد کے مبدا سے قطب تک فاصلہ \عددی{\omega_0} کے برابر ہے جبکہ زاویہ \عددی{\cos^{-1}\zeta} ہے۔یوں \عددی{\zeta} تبدیل کرنے سے رداس تبدیل نہیں ہوتا البتہ زاویہ تبدیل ہونے سے قطب دائری حرکت کرتا ہے۔شکل-ب میں \عددی{\zeta} تبدیل کرنے سے مخلوط جوڑی دار قطبین نقطہ دار دائرے پر حرکت کرتے ہیں۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
\end{subfigure}
\caption{کم قصری، دو رتبی جال کے مخلوط جوڑی دار قطبین۔}
...
\end{figure}
شکل \حوالہ{شکل_لاپلاس_استعمال_تین_بعدی_ترسیم_ب} کو یوں گھماتے ہیں کہ حقیقی محور صفحہ کتاب کے ساتھ قائمہ الزاویہ  پر ہو۔اس طرح شکل \حوالہ{شکل_لاپلاس_استعمال_تین_بعدی_ترسیم_پ} ملتا ہے جہاں حقیقی محور کے دونوں جانب برابر فاصلے پر قطبین دیکھے جا سکتے ہیں۔
\begin{figure}
\centering
\includegraphics{figLaplaceApplicationPoleZeroPlotRLCC}
\caption{تین بُعدی ترسیم کا حقیقی محور صفحہ کتاب کے  ساتھ قائمہ الزاویہ پر ہے۔}
...
\end{align}
ہے جس کا لاپلاس تبادل درج ذیل ہے۔
\begin{align*}
...
\end{align*}
جس کا الٹ لاپلاس تبادل لیتے ہیں۔
\begin{align*}
...
حل:شکل-ب میں لاپلاس تبادل دکھایا گیا ہے۔اس دور کو کسی بھی طریقے سے حل کیا جا سکتا ہے۔ہم ترکیب جوڑ سے \عددی{\bV_1(s)} حاصل کرتے ہوئے تقسیم دباؤ کے کلیے سے  \عددی{\bV_0(s)} حاصل کریں گے۔کرخوف مساوات جوڑ لکھتے ہیں
\begin{align*}
...
\end{align*}
ملتا ہے۔تقسیم دباؤ کے کلیے سے خارجی دباؤ لکھتے ہیں۔
\begin{align*}
...
\end{align*}
کے  الٹ لاپلاس تبادل سے حاصل کیا جا سکتا ہے۔
\انتہا{مثال}
%========================
...
شکل \حوالہ{شکل_لاپلاس_استعمال_فلٹر_الف} میں پست گزار چھلنی دکھائی گئی ہے۔اس کو استعمال کرتے ہوئے دیکھا گیا کہ مستطیل داخلی دباؤ  پر خارجی دباؤ درکار قیمت سے تجاوز کرتے ہوئے آگے نکل جاتا ہے جو کم تقصیر کی نشانی ہے۔تقصیر بڑھاتے ہوئے اس مسئلے کو حل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
...
حل:متوازی جڑے برق گیر اور مزاحمت کی رکاوٹ \عددی{\tfrac{R}{1+sRC}} لیتے ہوئے تقسیم دباؤ کے کلیے سے چھلنی کا تبادلی تفاعل لکھتے ہیں۔
\begin{align*}
...
\end{align*}
یعنی \عددی{\omega_0=\tfrac{1}{\sqrt{LC}}=\SI{200}{\kilo\radian\per\second}} اور \عددی{\zeta=\tfrac{160000}{2\times 200000}=0.4} ہیں۔یقیناً تقصیری مستقل کی قیمت نہایت کم ہے جس کو بڑھا کر \عددی{\zeta=1} کرنے سے ہمارا مسئلہ حل ہو سکتا ہے۔تعدد کو تبدیل کیے بغیر ایسا مزاحمت کو تبدیل کرنے سے ہو گا۔مزاحمت کی نئی
...
&=\SI{25}{\ohm}
\end{align*}
یوں مزاحمت کو تبدیل کرتے ہوئے \عددی{\SI{62.5}{\ohm}} کی جگہ \عددی{\SI{25}{\ohm}} نصب کرنے سے خارجی اشارہ درکار حد سے آگے گزرنا بند کر دے گا۔
\انتہا{مثال}
%=======================
\ابتدا{مشق}
