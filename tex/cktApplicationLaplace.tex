...
برقی پرزوں کی خصوصیات سے ان کے مساوی لاپلاسی ادوار حاصل کیے جا سکتے ہیں۔تمام پرزوں کے دباو بالمقابل رو تعلق لکھتے ہوئے غیر فعال رائج سمت استعمال کیے گئے ہیں۔مزاحمت کے دباو اور رو کا تعلق
\begin{align}
v(t)=R i(t)
\end{align}
...
\begin{itemize}
\item
ابتدائی حالت جاننے کے لیے \عددی{t<\SI{0}{\second}} کے لیے دور حل کریں۔اگر \عددی{t<\SI{0}{\second}} میں دور برقرار حالت میں ہو تب برق گیر کو کھلے سر اور امالہ گیر کو قصر دور تصور کرتے ہوئے ابتدائی رو اور ابتدائی دباو حاصل کیے جا سکتے ہیں۔
\item
...
آئیں اب شکل \حوالہ{شکل_لاپلاس_استعمال_متعدد_طریقے_الف}-الف کو تبادلہ منبع سے حل کریں۔دونوں منبع دباو کے مساوی منبع رو نصب کرتے ہوئے شکل \حوالہ{شکل_لاپلاس_استعمال_تبادلہ_منبع_الف}-الف ملتا ہے جہاں منبع دباو \عددی{\tfrac{8}{s}} اور اس کے سلسلہ وار \عددی{2s} کو منبع رو \عددی{\tfrac{8/s}{2s}=\tfrac{4}{s^2}} جس کے متوازی \عددی{2s} جڑا ہے میں تبدیل کیا گیا ہے۔اسی طرح منبع دباو \عددی{\tfrac{2}{s}} اور سلسلہ وار \عددی{2} کو منبع رو \عددی{\tfrac{2/s}{2}=\tfrac{1}{s}} میں تبدیل کیا گیا ہے جس کے متوازی \عددی{2} نصب ہے۔
...
\caption*{(پ)}
\end{subfigure}
\caption{منبع دباو کی جگہ منبع رو نصب کیا گیا ہے۔}
...
حل: اگر \عددی{v_2(t)} معلوم کیا جائے تو \عددی{v_0(t)} کو تقسیم دباو کے کلیے سے حاصل کیا جا سکتا ہے۔اس دور میں مخلوط جوڑ پایا جاتا ہے لہٰذا مساوات جوڑ کی تعداد کم ہو گی۔ شکل-ب میں لاپلاس تبادل  دکھایا گیا ہے جس سے کرخوف مساوات جوڑ لکھتے ہیں
\begin{align*}
...
\end{align*}
لکھ کر الٹ لاپلاس تبادل لیتے ہوئے درکار دباو حاصل ہو گا۔
\begin{align*}
...
شکل \حوالہ{شکل_لاپلاس_استعمال_تغیر_پذیر_برق_گیر_الف}-الف میں \اصطلاح{تغیر پذیر برق گیر}\فرہنگ{تغیر پذیر برق گیر}\فرہنگ{برق گیر!تغیر پذیر} استعمال کیا گیا ہے۔خارجی دباو \عددی{v_C(t)} کو \عددی{C=\SI{1}{\farad}}، \عددی{C=\SI{4}{\farad}} اور \عددی{C=\SI{10}{\farad}} کے لیے حاصل کریں۔
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
...
شکل \حوالہ{شکل_لاپلاس_استعمال_تغیر_پذیر_برق_گیر_الف}-ب میں لاپلاس تبادل دور دکھایا گیا ہے جس سے تقسیم دباو کے کلیے سے خارجی دباو لکھتے ہیں۔
\begin{align*}
...
امتیازی مساوات کے جذر یعنی \عددی{\bV_C(s)} کے قطبین \عددی{p_1=0}، \عددی{p_2=-\tfrac{1}{2}-j\tfrac{\sqrt{3}}{2}} اور
 \عددی{p_3=-\tfrac{1}{2}+j\tfrac{\sqrt{3}}{2}} ہیں۔یوں ایک عدد حقیقی اور مخلوط جوڑی دار قطبین پائے جاتے ہیں جو \اصطلاح{کم مقصور صورت}\فرہنگ{مقصور!کم}\فرہنگ{underdamped} حال ہے۔الٹ لاپلاس تبادل سے وقتی دائرہ کار میں خارجی دباو حاصل کرتے ہیں۔
\begin{align*}
...
حل:شکل-ب میں لاپلاس تبادل دکھایا گیا ہے۔اس دور کو کسی بھی طریقے سے حل کیا جا سکتا ہے۔ہم ترکیب جوڑ سے \عددی{\bV_1(s)} حاصل کرتے ہوئے تقسیم دباو کے کلیے سے  \عددی{\bV_0(s)} حاصل کریں گے۔کرخوف مساوات جوڑ لکھتے ہیں
\begin{align*}
