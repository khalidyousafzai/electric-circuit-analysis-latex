...
\end{align*}
ہے جہاں \عددی{\sigma=\tfrac{1}{6}} اور \عددی{\omega_d=\frac{1}{6\sqrt{2}}} استعمال کئے گئے۔یوں مکمل حل درج ذیل ہو گا
\begin{gather}
...
\end{align}
یہ مساوات \عددی{t=0_+} پر \عددی{v_C(0_+)=\SI{5}{\volt}} اور \عددی{t=\infty} پر \عددی{v_C(\infty)=\tfrac{10}{3}\, \si{\volt}} دیتی ہے۔
\انتہا{مثال}
