...
\end{align}
حاصل ہوتا ہے۔اس دو درجی مساوات کو \عددی{s} کے لئے حل کرتے ہوئے
\begin{gather}
\begin{aligned}
...
\حصہء{کم مقصور صورت، \عددی{\zeta<1}}
 \اصطلاح{کم مقصور صورت}\فرہنگ{مقصور!کم}\حاشیہب{under damped condition}\فرہنگ{under damped condition} \عددی{\zeta<1} میں \عددی{s_1} اور \عددی{s_2} کی قیمتیں خیالی حاصل ہوتی ہیں جنہیں درج ذیل لکھا جا سکتا ہے
\begin{gather}
\begin{aligned}
...
ہم جنسی مساوات سے \عددی{\omega_0=\tfrac{1}{\sqrt{24}}} اور \عددی{\zeta=\tfrac{2}{\sqrt{6}}=0.333} حاصل ہوتا ہے۔چونکہ \عددی{\zeta<1} ہے لہٰذا یہ کم قصری مساوات ہے جس کا حل مساوات \حوالہ{مساوات_عارضی_فطری_حل_کم_تقصیر_الف} کے تحت
\begin{align*}
...
\end{align*}
حاصل ہوتا ہے جس کے دونوں اطراف کو \عددی{e^{st}} سے تقسیم کرنے سے درج ذیل حاصل ہوتا ہے
\begin{align*}
s^2+7.9s+3=0
\end{align*}
جس کے حل
