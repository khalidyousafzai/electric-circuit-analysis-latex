...
\end{align*}
آپ نے دیکھا کہ دونوں مساوات میں تفرقی جزو کے عددی سر، مستقل مقدار ہیں۔آئیں مستقل عددی سر کے دو رتبی تفرقی مساوات کو حل کرنا سیکھتے ہیں۔
 \begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
مستقل عددی سر کے دو رتبی تفرقی مساوات کی عمومی صورت درج ذیل ہے جہاں دو رتبی تفرق کے عددی سر کو اکائی برابر رکھا گیا ہے۔
