...
\end{align*}
عمومی حلمیں نا معلوم مستقل کو \اصطلاح{ابتدائی شرائط}\فرہنگ{ابتدائی شرائط}\حاشیہب{initial conditions}\فرہنگ{initial conditions} سے حاصل کرتے ہیں جس کے تحت \عددی{t=0_+} پر \عددی{v_C(0_+)=0} کی قیمت معلوم ہے۔ان قیمتوں کو درج بالا مساوات میں پُر کرتے ہوئے حل کرنے سے
\begin{align*}
