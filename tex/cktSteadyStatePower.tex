...
\end{align*}
رو \عددی{\bIrmsCC} سے مراد درج ذیل ہے۔
\begin{align*}
...
امالی بوجھ کو \عددی{\SI{50}{\kilo\watt}} طاقت فراہم کی جا رہی ہے۔بوجھ پر موثر دباو \عددی{\SI{230}{\volt}}، تعدد \عددی{\SI{50}{\hertz}} اور پیچھے جزو طاقت \عددی{0.9} ہے۔منبع طاقت سے بوجھ تک تاروں کی رکاوٹ \عددی{0.05+j0.25\,\si{\ohm}} ہے۔ منبع طاقت پر دباو، جزو طاقت اور طاقت کا تخمینہ لگائیں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
...
حل:دور کو شکل \حوالہ{شکل_طاقت_جزو_طاقت_الف} میں دکھایا گیا ہے۔بوجھ کے دباو کو حوالہ دوری سمتیہ لیتے ہوئے اس کا زاویہ صفر چننا گیا ہے۔مخلوط طاقت
\begin{align*}
