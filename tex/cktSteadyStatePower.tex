...
\حصہ{لمحاتی طاقت}
شکل \حوالہ{شکل_طاقت_پرزے_کو_منتقل} میں بوجھ \عددی{\bZ} کو بدلتا رو منبع  طاقت فراہم کرتا ہے۔اس عمومی دور کے برقرار دباو اور برقرار رو درج ذیل لکھے جا سکتے ہیں۔
\begin{gather}
...
\end{align*}
دباو، رو اور طاقت کے خط شکل \حوالہ{شکل_طاقت_عمومی_الف} میں دکھائے گئے ہیں۔درج بالا مساوات میں \عددی{\SI{21.143}{\watt}} مستقل طاقت ہے جو وقت کے ساتھ تبدیل نہیں ہوتا جبکہ \عددی{22.5\cos(200t+70^{\circ})\,\si{\watt}} بدلتا رو طاقت ہے جس کی تعدد \عددی{\SI{200}{\radian\per\second}} ہے۔
\begin{figure}
\centering
...
\end{aligned}
\end{gather}    
جہاں \عددی{t_0} کوئی بھی لمحہ ہو سکتا ہے جبکہ \عددی{T=\tfrac{2\pi}{\omega}} دباو یا رو کا دوری عرصہ ہے۔حقیقت میں ہم ایک دوری عرصے کے بجائے  \عددی{n} مکمل دوری عرصے پر تکمل لیتے ہوئے \عددی{n} دوری عرصے سے تقسیم کرتے ہوئے بھی اوسط قیمت حاصل کر سکتے ہیں۔یوں اوسط طاقت درج ذیل بھی لکھی جا سکتی ہے۔
\begin{align}
...
حل:پہلے تمام رو دریافت کرتے ہیں۔شکل میں دباو کو دیکھتے ہوئے غیر فعال رائج رو کے تحت رو کی سمتیں چنی گئی ہیں۔ 
\begin{align*}
...
ایک سے زیادہ منبع کی صورت میں آپ کسی بھی ترکیب کو استعمال کرتے ہوئے شاخوں کی رو اور جوڑ کے دباو حاصل کرتے ہوئے طاقت دریافت کر سکتے ہیں۔البتہ یاد رہے کہ خطی میل سے طاقت کا تخمینہ نہیں لگایا جا سکتا چونکہ طاقت مربع دباو (یا مربع رو) کا تعلق رکھتا ہے جو غیر خطی تعلق ہے۔ 
...
مؤثر دباو کو بھی اسی طرح حاصل کیا جا سکتا ہے۔مزاحمت \عددی{R} کے متوازی دباو \عددی{v(t)} نصب کرنے سے مزاحمت کو لمحاتی طور پر \عددی{\tfrac{v^2(t)}{R}} طاقت منتقل ہو گا۔اگر دباو کا دوری عرصہ \عددی{T} ہو تب مزاحمت کو اوسطاً 
\begin{align}
P=\frac{1}{T}\int_{t_0}^{t_0+T} \frac{v^2(t)}{R} \dif t
\end{align}
طاقت منتقل ہو گا۔اسی مزاحمت کو یک سمت دباو \عددی{V_{\text{مؤثر}}} اوسطاً درج ذیل طاقت فراہم کرتا ہے۔
\begin{align}
P=\frac{V^2_{\text{مؤثر}}}{R}
\end{align}
دونوں طاقت برابر ہونے کی صورت میں مؤثر دباو کی مساوات درج ذیل حاصل ہوتی ہے۔
\begin{align}\label{مساوات_طاقت_موثر_قیمت_کی_تعریف_ب}
V_{\text{مؤثر}}=\sqrt{\frac{1}{T}\int_{t_0}^{t_0+T} v^2(t) \dif t}
\end{align}
آئیں ان مساوات کی مدد سے چند امواج کی مؤثر قیمتیں دریافت کریں۔درج بالا مساوات سے آپ دیکھ سکتے ہیں کہ سائن نما موج کی مؤثر قیمت حاصل کرنے کی خاطر مربع حیطہ کی اوسط کا جذر لیا جاتا ہے۔دباو اور رو کے مؤثر قیمتوں کو عموماً \عددی{\Vrms} اور \عددی{\Irms} لکھا جاتا ہے۔آخر میں یاد رہے کہ جذر کا مثبت جواب مؤثر قیمت لیا جاتا ہے۔ 
%====================
\ابتدا{مثال}
...
\end{align}
لکھا جا سکتا ہے۔چونکہ \عددی{\sin(\omega t +\theta)=\cos(\omega t +\theta-90^{\circ})} لکھا جا سکتا ہے لہٰذا سائن موج کی مؤثر قیمت بھی درج بالا ہو گی۔اسی طرح \عددی{V_0} حیطے کے سائن نما دباو کی مؤثر قیمت درج ذیل ہو گی۔
...
%===========
\ابتدا{مثال}
ہمارے ملک پاکستان میں \عددی{\SI{50}{\hertz}} تعدد اور \عددی{\SI{220}{\volt}} تا \عددی{\SI{240}{\volt}} مؤثر قیمت کا سائن نما برقی دباو گھریلو صارفین کو مہیا کا جاتا ہے۔دباو کا حیطہ دریافت کرتے ہوئے موج کی مساوات لکھیں۔

حل:دباو کی مؤثر قیمت کو \عددی{\SI{230}{\volt}} لیتے ہوئے  مساوات \حوالہ{مساوات_طاقت_موثر_تعریف_دباو} سے  حیطہ حاصل کرتے ہیں۔
\begin{align}
...
اب تک ہم دباو یا رو کا حیطہ لیتے ہوئے ان کے دوری سمتیات لکھتے رہے ہیں مثلاً  \عددی{\hat{V}=V_0\phase{\theta^{\circ}}\,\si{\volt}} دوری سمتیہ \عددی{V_0} حیطے اور \عددی{\theta} زاویہ ہٹاو کے کوسائن دباو کو ظاہر کرتا ہے۔ہم دوری سمتیات کو مؤثر قیمت کی صورت میں بھی لکھ سکتے ہیں۔یوں
 \عددی{\hat{V}_{\textup{rms}}=230\phase{\theta}\,\si{\volt}} میں \عددی{\SI{230}{\volt}} دباو کے مؤثر قیمت کو ظاہر کرتی ہے  جبکہ
...
دباو یا رو کی قیمتیں مختلف انداز میں بیان کی جا سکتی  ہیں۔مثلاً مساوات \حوالہ{مساوات_طاقت_پاکستانی_گھریلو_دباو} میں دباو کی چوٹی \عددی{V_{\textup{p}}} یا مثبت اور منفی چوٹیوں کے درمیان قیمت \عددی{V_{\textup{pp}}} اور یا پھر دباو کی مؤثر قیمت \عددی{\Vrms} بیان کی جا سکتی ہے۔یوں درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
V_{\textup{p}}&=\SI{325}{\volt}\\
V_{\textup{pp}}&=\SI{650}{\volt}\\
\Vrms&=\SI{230}{\volt}
\end{align*}
بدلتا رو مشینوں کے دباو اور رو کی عموماً مؤثر قیمتیں بیان کی جاتی ہیں۔یوں \عددی{\SI{230}{\volt}} پر چلنے والا گھریلو پنکھا درحقیقت \عددی{\SI{230}{\volt}} کے مؤثر دباو پر چلے گا۔اس کتاب میں مؤثر قیمتیں استعمال کرتے ہوئے دباو اور رو کے ساتھ مؤثر یا \عددی{\textup{rms}} لکھا جائے گا۔
...
\end{align*}
چونکہ \عددی{\tfrac{V_0}{\sqrt{2}}} اور \عددی{\tfrac{I_0}{\sqrt{2}}} بالترتیب مؤثر دباو \عددی{\Vrms} اور مؤثر رو \عددی{\Irms} ہیں لہٰذا درج بالا مساوات کو درج ذیل لکھا جا سکتا ہے۔
...
شکل \حوالہ{شکل_طاقت_موثر_قیمتیں_الف} میں دیے دباو کی مؤثر قیمت دریافت کریں۔اگر \عددی{D=\SI{50}{\percent}} اور \عددی{V_{\textup{p}}=\SI{60}{\volt}} ہوں تب یہ دباو \عددی{\SI{200}{\ohm}} مزاحمت کو کتنی طاقت مہیا کر سکتا ہے اور مزاحمت کی مؤثر رو کیا ہو گی۔
\begin{figure}
\centering
\begin{tikzpicture}
\pgfmathsetmacro{\T}{2};
...
حل:یہاں دوری عرصہ \عددی{T} ہے جس میں \عددی{t_1} مدت کے لیے دباو پایا جاتا ہے جبکہ \عددی{T-t_1} مدت کے لیے دباو صفر کے برابر رہتا ہے۔یوں  فعال عرصہ \عددی{D=\tfrac{t_1}{T}} ہے۔مساوات \حوالہ{مساوات_طاقت_موثر_قیمت_کی_تعریف_ب} استعمال کرتے ہوئے
\begin{align*}
...
دی گئی معلومات کے مطابق مؤثر دباو درج ذیل ہے
\begin{align*}
...
شکل \حوالہ{شکل_طاقت_موثر_قیمتیں_ب} میں \عددی{D} کی قیمت \عددی{\SI{30}{\percent}}، \عددی{\SI{50}{\percent}} اور \عددی{\SI{70}{\percent}} کی صورت میں  دباو کی مؤثر قیمت اور اوسط قیمت دریافت کریں جہاں \عددی{V_{\textup{p}}=\SI{10}{\volt}} ہے۔
\begin{figure}
\centering
\begin{tikzpicture}
\pgfmathsetmacro{\T}{2};
...
&=V_{\textup{p}}
\end{align*}
یوں دی گئی تینوں فعال عرصوں  کے لیے  مؤثر دباو \عددی{\SI{10}{\volt}} حاصل ہوتا ہے۔
...
شکل \حوالہ{شکل_طاقت_مشق_موثر_قیمتیں_الف} میں دیے دباو کی مؤثر قیمت دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
...
\end{align}
جہاں مساوات \حوالہ{مساوات_طاقت_مقدار_مساوی_مخلوط_اور_جوڑی_دور_ضرب} اور مساوات \حوالہ{مساوات_طاقت_مخلوط_طاقت_مساوی_حقیقی_متعاملی} کا سہارا لیا گیا ہے۔اسی طرح مساوات \حوالہ{مساوات_طاقت_مخلوط_طاقت_الف} میں دباو کے بجائے رو کے لیے پر کرتے ہوئے درج ذیل لکھا جا سکتا ہے۔
\begin{align}
\bS=\bVrms\left(\frac{\bVrms}{\bZ}\right)^*=\frac{\VrmsS}{\bZCC}=\VrmsS \bYCC=\VrmsS(B+jG)^*=P+jQ
\end{align}
اس مساوات کے تحت جوڑی دار مخلوط فراوانی کو دباو کی مؤثر قیمت سے ضرب دیتے ہوئے فراوانی کی طاقت حاصل کی جا سکتی ہے۔یہ وہ طاقت ہے جو فراوانی جذب کرتا ہے۔  یوں اگر شکل \حوالہ{شکل_طاقت_اقسام_طاقت} میں برق گیر بطور بوجھ \عددی{\bZ} نصب ہوتا تب فراوانی \عددی{j\omega C} کے برابر ہوتی جسے درج بالا مساوات میں پر کرتے ہوئے
...
امالی بوجھ کو \عددی{\SI{50}{\kilo\watt}} طاقت فراہم کی جا رہی ہے۔بوجھ پر مؤثر دباو \عددی{\SI{230}{\volt}}، تعدد \عددی{\SI{50}{\hertz}} اور پیچھے جزو طاقت \عددی{0.9} ہے۔ترسیلی تاروں  کی رکاوٹ \عددی{\bZ_{\text{تار}}=0.05+j0.25\,\si{\ohm}} ہے۔ منبع طاقت پر دباو، جزو طاقت اور طاقت کا تخمینہ لگائیں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
...
%================
\ابتدا{مثال}
گزشتہ مثال کے شکل \حوالہ{شکل_طاقت_جزو_طاقت_الف} میں بقایا تمام معلومات وہی ہیں البتہ بوجھ پر جزو طاقت پیچھے کے بجائے آگے ہے۔منبع طاقت کا دباو حاصل کریں۔
...
\end{align*}
آگے  ہے لہٰذا منبع پر آگے جزو طاقت \عددی{\cos(-10.31^{\circ})=0.98} ہو گا۔آپ دیکھ سکتے ہیں کہ بوجھ پر مؤثر دباو \عددی{\SI{230}{\volt}} ہے جبکہ منبع طاقت کا مؤثر دباو \عددی{\SI{223}{\volt}} ہے جو کہ بوجھ کے دباو سے کم ہے۔
\انتہا{مثال}
%===================
\ابتدا{مشق}
شکل \حوالہ{شکل_طاقت_جزو_طاقت_الف} میں بقایا تمام معلومات وہی ہیں البتہ آگے جزو طاقت \عددی{0.8} ہے۔منبع طاقت کا مؤثر دباو اور جزو طاقت حاصل کریں۔منبع کتنا طاقت پیدا کر رہا ہے۔

جوابات:\عددی{\SI{210}{\volt}\, \textup{rms}}، \عددی{\pf=0.94 \,\text{آگے}}، \عددی{\SI{53.69}{\kilo\watt}}
\انتہا{مشق}
%=================
\ابتدا{مشق}
ایک صنعتی بوجھ کو \عددی{\SI{30}{\kilo\watt}} طاقت \عددی{0.82} پیچھے جزو طاقت پر درکار ہے۔بوجھ پر مؤثر دباو \عددی{\SI{230}{\volt}} اور تعدد \عددی{\SI{50}{\hertz}} ہے۔منبع سے صنعت تک طاقت کو ترسیلی تاروں کے ذریعہ پہنچایا جاتا ہے۔ان ترسیلی تاروں کی رکاوٹ \عددی{\bZ_{\text{تار}}=0.08+j0.3\,\si{\ohm}} ہے۔ترسیلی تاروں میں حقیقی اور متعاملی طاقت کا ضیاع دریافت کریں۔ترسیلی تار کے داخلی سر پر درکار حقیقی اور متعاملی طاقت دریافت کریں۔
...
%=================
\ابتدا{مشق}
صنعتی بوجھ کو \عددی{0.86} امالی جزو طاقت پر \عددی{\SI{25}{\kilo\watt}} طاقت \عددی{\SI{230}{\volt}\,\rms}  اور \عددی{\SI{50}{\hertz}} تعدد پر فراہم کی جا رہی ہے۔ترسیلی تار کی رکاوٹ  \عددی{\bZ_{\text{تار}}=0.1+j0.2\,\si{\ohm}} ہے۔تاروں کے داخلی سروں پر مؤثر دباو اور جزو طاقت دریافت کریں۔
...
برقی دباو اور طاقت کے بارے میں علم حاصل کرتے وقت ضروری ہے کہ ان سے لاحق خطرات اور ان خطرات سے بچنے کے حفاظتی اقدامات اور تدابیر پر بھی غور کیا جائے۔
 ...
 میں چھوٹا بچہ تھا جب مجھے پہلی مرتبہ بجلی کا جھٹکا لگا۔آپ میں سے  بیشتر طلباء بھی اس کٹھن تجربے سے گزر چکے ہوں گے۔کسی بھی دو مختلف اجسام کے رگڑ سے ساکن  دباو پیدا ہوتا ہے۔اونی جرسی اتارنے سے جرسی اور آپ کے جسم کے مابین \عددی{\SI{20}{\kilo\volt}} تا \عددی{\SI{40}{\kilo\volt}} کا ساکن دباو پیدا ہو سکتا ہے۔ آپ نے اندھرے میں اونی جرسی اتارتے ہوئے شعلے ضرور دیکھے ہوں گے جو اسی ساکن دباو کی وجہ سے پیدا ہوتے ہیں۔آپ کو ساکن دباو کے جھٹکے بھی لگے ہوں گے جن سے جسم میں \عددی{\SI{40}{\ampere}} تک کی رو گزر سکتی ہے۔جسم میں رو گزرنے سے بجلی کا جھٹکا محسوس ہوتا ہے۔ رو گزرنے سے پٹھے کھینچ جاتے ہیں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0)--++(0,{ln(10000)});
...
شکل \حوالہ{شکل_سوال_طاقت_موثر_الف}-الف میں دیے دباو کی مؤثر قیمت دریافت کریں۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
شکل \حوالہ{شکل_سوال_طاقت_موثر_پ}-الف میں دیے دباو کی مؤثر قیمت دریافت کریں۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
%=========================
\ابتدا{سوال}
دباو \عددی{v(t)=15+10\cos(\omega t+30^{\circ})\,\si{\volt}} کی مؤثر قیمت دریافت کریں۔
...
شکل \حوالہ{شکل_طاقت_صنعتی_بوجھ} میں صنعتی بوجھ کو \عددی{\SI{80}{\kilo\watt}} طاقت مہیا کیا گیا ہے۔ ایمپیئر پیما \عددی{\SI{220}{\ampere}\,\rms} ناپتا ہے  جبکہ بوجھ کا امالی جزو طاقت \عددی{0.92} ہے۔مؤثر دباو حاصل کریں۔
...
شکل \حوالہ{شکل_طاقت_صنعتی_بوجھ} میں صنعتی بوجھ کو \عددی{\pf=0.86} آگے جزو طاقت پر  \عددی{\SI{20}{\kilo\watt}} طاقت مہیا کیا گیا ہے۔بوجھ
 پر دباو \عددی{240\phase{0^{\circ}}\,\si{\volt}\,\rms} ہے۔تار کی رکاوٹ \عددی{\bZ_{\text{تار}}=0.1+j0.15\,\si{\ohm}} ہے۔ منبع کا جزو طاقت اور مخلوط طاقت دریافت کریں۔
...
شکل \حوالہ{شکل_طاقت_صنعتی_ث} میں کرخوف کے قوانین سے دباو منبع \عددی{\bV_m} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
...
شکل \حوالہ{شکل_طاقت_صنعتی_چ} میں منبع کا دباو دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
