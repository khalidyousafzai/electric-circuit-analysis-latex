...
\end{align}
کسی بھی جزو طاقت کے حصول کے لئے  \عددی{\bS_C} کو شکل \حوالہ{شکل_طاقت_درستگی_جزو_طاقت_صنعتی_بہتر}-ت سے حاصل کا جا سکتا ہے جسے استعمال کرتے ہوئے درج بالا مساوات سے درکار \عددی{C} حاصل کیا جا سکتا ہے۔ جزو طاقت قابو کرنے کے لئے برق گیر کی سکت عموماً متعاملی وولٹ ایمپیئر \عددی{\var} میں ہی بیان کی جاتی ہے۔یوں \عددی{\SI{50}{\hertz}}، \عددی{\SI{440}{\volt}\,\rms} پر استعمال ہونے  والے \عددی{\SI{822}{\micro\farad}} برق گیر کو \عددی{\SI{50}{\kilo\var}} کا برق گیر کہا جائے گا۔
