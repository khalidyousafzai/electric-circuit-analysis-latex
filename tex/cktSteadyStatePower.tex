...
\حصہ{لمحاتی طاقت}
شکل \حوالہ{شکل_طاقت_پرزے_کو_منتقل} میں بوجھ \عددی{\bZ} کو بدلتا رو منبع  طاقت فراہم کرتا ہے۔اس عمومی دور کے برقرار دباؤ اور برقرار رو درج ذیل لکھے جا سکتے ہیں۔
\begin{gather}
...
\end{align}
ملتا ہے جہاں \عددی{\alpha=\omega t +\theta_v} اور \عددی{\beta=\omega t+\theta_i} لیے گئے ہیں۔آپ دیکھ سکتے ہیں کہ لمحاتی طاقت دو اجزاء کا مجموعہ ہے۔پہلا جزو مستقل طاقت ہے جو وقت کے ساتھ تبدیل نہیں ہوتا جبکہ دوسرا جزو دگنی تعدد کا بدلتا رو طاقت ہے۔  
%
\begin{figure}
\centering
\begin{tikzpicture}
...
شکل \حوالہ{شکل_طاقت_پرزے_کو_منتقل} میں برقرار دباؤ \عددی{v(t)=15\cos(100 t+45^{\circ})\,\si{\volt}} اور \عددی{\bZ=5\phase{20^{\circ}}\,\si{\ohm}} ہیں۔بوجھ کو منتقل لمحاتی طاقت دریافت کریں۔
...
\end{align*}
دباؤ، رو اور طاقت کے خط شکل \حوالہ{شکل_طاقت_عمومی_الف} میں دکھائے گئے ہیں۔درج بالا مساوات میں \عددی{\SI{21.143}{\watt}} مستقل طاقت ہے جو وقت کے ساتھ تبدیل نہیں ہوتا جبکہ \عددی{22.5\cos(200t+70^{\circ})\,\si{\watt}} بدلتا رو طاقت ہے جس کی تعدد \عددی{\SI{200}{\radian\per\second}} ہے۔
\begin{figure}
\centering
...
\حصہ{اوسط طاقت}
دہراتے تفاعل (مثلاً سائن نما تفاعل) کے ایک دوری عرصے پر تکمل کو دوری عرصے سے تقسیم کرنے سے تفاعل کی اوسط قیمت حاصل ہوتی ہے۔یوں مساوات \حوالہ{مساوات_طاقت_دباو_رو_عمومی_الف} میں دیے دباؤ اور رو کی صورت میں بوجھ کو منتقل اوسط طاقت درج ذیل ہو گی
\begin{gather}
...
\end{aligned}
\end{gather}    
جہاں \عددی{t_0} کوئی بھی لمحہ ہو سکتا ہے جبکہ \عددی{T=\tfrac{2\pi}{\omega}} دباؤ یا رو کا دوری عرصہ ہے۔حقیقت میں ہم ایک دوری عرصے کے بجائے  \عددی{n} مکمل دوری عرصے پر تکمل لیتے ہوئے \عددی{n} دوری عرصے سے تقسیم کرتے ہوئے بھی اوسط قیمت حاصل کر سکتے ہیں۔یوں اوسط طاقت درج ذیل بھی لکھی جا سکتی ہے۔
\begin{align}
...
\end{align}
چونکہ \عددی{\cos(\alpha)=\cos(-\alpha)} کے برابر ہے لہٰذا درج بالا مساوات میں کوسائن کی دلیل \عددی{\theta_v-\theta_i} یا \عددی{\theta_i-\theta_v} لکھی جا سکتی ہے۔مساوات \حوالہ{مساوات_طاقت_زاویہ_رکاوٹ_اور_طاقت} کو استعمال کرتے ہوئے درج بالا مساوات کو دوبارہ لکھتے ہیں۔
...
\end{align}
ہو گا جہاں \عددی{V_0} سے مراد مزاحمت کے دباؤ کا حیطہ ہے۔قانون اوہم سے درج بالا کو درج ذیل صورتوں میں بھی لکھا جا سکتا ہے۔
\begin{align}
...
\end{align}
درج بالا تینوں مساوات کا یک سمت رو میں مزاحمتی ضیاع کے مساوات کے ساتھ موازنہ کرنے سے معلوم ہوتا ہے کہ موجودہ تینوں مساوات کے نسب نما میں دو \عددی{(2)} کا اضافی عدد پایا جاتا ہے جس پر حصہ \حوالہ{حصہ_طاقت_موثر_قیمت} میں  تبصرہ کیا جائے گا۔
...
&=\SI{83.34}{\watt}
\end{align*}
ہو گا۔چونکہ طاقت صرف مزاحمت میں ضائع ہوتی ہے لہٰذا یہی جواب مساوات \حوالہ{مساوات_طاقت_مزاحمتی_طاقت_الف} سے بھی حاصل کیا جا سکتا ہے جہاں \عددی{V_0} سے مراد مزاحمت کے دباؤ کا حیطہ ہے۔تقسیم دباؤ سے مزاحمت کا دباؤ درج ذیل ہے
\begin{align*}
...
شکل \حوالہ{شکل_طاقت_مزاحمت_امالہ_ب} میں منبع دباؤ کا اوسط طاقت حاصل کریں۔دور کے بقایا پرزوں کا اوسط طاقت بھی دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
...
حل:پہلے تمام رو دریافت کرتے ہیں۔شکل میں دباؤ کو دیکھتے ہوئے غیر فعال رائج رو کے تحت رو کی سمتیں چنی گئی ہیں۔ 
\begin{align*}
...
ایک سے زیادہ منبع کی صورت میں آپ کسی بھی ترکیب کو استعمال کرتے ہوئے شاخوں کی رو اور جوڑ کے دباؤ حاصل کرتے ہوئے طاقت دریافت کر سکتے ہیں۔البتہ یاد رہے کہ خطی میل سے طاقت کا تخمینہ نہیں لگایا جا سکتا چونکہ طاقت مربع دباؤ (یا مربع رو) کا تعلق رکھتا ہے جو غیر خطی تعلق ہے۔ 
...
جوابات:\عددی{P_{20\phase{30^{\circ}}}=\SI{-25.36}{\watt}}، \عددی{P_{40\phase{0^{\circ}}}=\SI{-5.36}{\watt}}، \عددی{P_{\SI{2}{\ohm}}=\SI{30.72}{\watt}}
\انتہا{مشق}
%================
...
یک سمت رو ادوار میں ہم زیادہ سے زیادہ طاقت منتقل کرنے کے مسئلے پر ہم حصہ \حوالہ{حصہ_مسئلے_زیادہ_سے_زیادہ_طاقت_منتقل} میں غور کر چکے ہیں۔آئیں بدلتا رو کی صورت میں اسی مسئلے پر دوبارہ غور کریں۔

کسی بھی دور کا تھونن مساوی حاصل کیا جا سکتا ہے۔شکل \حوالہ{شکل_طاقت_زیادہ_سے_زیادہ_الف} میں تھونن مساوی دور کے ساتھ بوجھ جوڑا گیا ہے جہاں تھونن دباؤ کو \عددی{\hat{V}_{\text{کھلا}}} کہا گیا ہے۔ہم جاننا چاہتے ہیں کہ بوجھ کو کس صورت میں زیادہ سے زیادہ اوسط طاقت منتقل ہو گا۔  
\begin{figure}
\centering
...
\end{aligned}
\end{gather} 
ہم جانتے ہیں کہ \عددی{X} میں طاقت ضائع نہیں ہوتا لہٰذا اس کو اوسطاً صفر طاقت منتقل ہوتا ہے۔درج بالا مساوات میں کسر کے نسب نما  میں \عددی{X_{\text{بوجھ}}+X_{\text{تھونن}}}  کی قیمت کم سے کم کرتے ہوئے طاقت بڑھائی جا سکتی ہے۔درج ذیل صورت میں اس قیمت کو صفر بنایا جا سکتا ہے۔
...
\end{align}
آئیں جانتے ہیں کہ کس قیمت کے \عددی{R_{\text{بوجھ}}} کو زیادہ سے زیادہ طاقت  منتقل ہو گی۔یہ جاننے کے لیے درج بالا مساوات کے تفرق کو صفر کے برابر پُر کرتے ہوئے  \عددی{R_{\text{بوجھ}}} کی درکار قیمت حاصل کرتے ہیں۔
\begin{align*}
...
حل:سب سے پہلے بوجھ کو ہٹاتے ہوئے بقایا دور کا تھونن مساوی حاصل کرنا ہو گا۔شکل-ب میں منبع دباؤ کو قصر دور کیا گیا ہے تا کہ تھونن مزاحمت حاصل کی جا سکے۔اسی طرح شکل-پ میں کھلے دور دباؤ کی نشاندہی کی گئی ہے۔ شکل-ب تھونن رکاوٹ لکھتے ہیں۔
\begin{align*}
\bZ_{\text{تھونن}}&=-j4+\frac{(6)(j2)}{6+j2}=\frac{3}{5}-j\frac{11}{5} \, \si{\ohm}
\end{align*}
یوں بوجھ کو زیادہ سے زیادہ طاقت کی منتقلی کے لیے ضروری ہے کہ بوجھ کی رکاوٹ درج ذیل ہو۔
\begin{align*}
\bZ_{\text{بوجھ}}=\frac{3}{5}+j\frac{11}{5} \, \si{\ohm}
\end{align*} 
شکل-پ میں برق گیر میں صفر رو ہے لہٰذا اس پر دباؤ بھی صفر ہو گا۔اس طرح مزاحمت پر دباؤ ہی تھونن دباؤ ہے جسے تقسیم دباؤ کے کلیے سے لکھتے ہیں۔
\begin{align*}
...
حل:بوجھ کے ساتھ جڑے دور کا تھونن مساوی حاصل کرتے ہیں۔شکل-ب سے  نارٹن دباؤ \عددی{\hat{V}_{\text{کھلا}}} حاصل ہو گا۔شکل-ب کے بائیں دائرے کی مساوات لکھتے ہیں
\begin{align*}
...
\end{align*}
درج بالا تین ہمزاد مساوات کو \عددی{\hat{I}_3} کے لیے حل کرنے سے درج ذیل حاصل ہوتا ہے۔
\begin{align*}
\hat{I}_3 =\hat{I}_{\text{نارٹن}}&=-\frac{12}{5}-j\frac{6}{5}\\
&=2.683\phase{-153.435^{\circ}}\,\si{\ampere}
\end{align*}
تھونن دباؤ اور نارٹن رو سے تھونن رکاوٹ حاصل کرتے ہیں۔
\begin{align*}
...
\حصہ{مؤثر قیمت}\شناخت{حصہ_طاقت_موثر_قیمت}
یک سمت رو ادوار پر ہم تفصیلاً غور کر چکے ہیں جہاں ہم نے دیکھا کہ مزاحمت \عددی{R} میں یک سمت رو \عددی{I} کے گزرنے سے مزاحمت میں \عددی{I^2R} طاقت کا ضیاع ہوتا ہے۔یک سمت رو کی مقدار تبدیل نہیں ہوتی لہٰذا مزاحمت کو ہر لمحہ برقرار \عددی{I^2R} طاقت فراہم ہوتا ہے۔ غیر تغیر طاقت کا اوسط بھی   \عددی{I^2R} ہو گا۔اس کے برعکس سائن نما رو کی صورت میں مزاحمت کو منتقل طاقت لمحہ با لمحہ تبدیل ہوتا ہے۔یوں \عددی{i(t)=I_0\cos(\omega t) \, \si{\ampere}} کی صورت میں لمحہ \عددی{t=0} پر مزاحمتی طاقت زیادہ سے زیادہ ہو گا جبکہ \عددی{t=\tfrac{\pi}{2\omega}} پر مزاحمتی طاقت صفر کے برابر ہو گا۔اسی اتار چڑھاو  کی وجہ سے سائن نما رو کی صورت میں مزاحمت کو منتقل اوسط طاقت \عددی{\tfrac{I_0^2 R}{2}} حاصل ہوتا ہے۔یوں \عددی{I_0} حیطے کی سائن نما رو مزاحمت کو \عددی{\tfrac{I_0}{\sqrt{2}}} قیمت کے یک سمت رو برابر طاقت فراہم کرتا ہے۔ہم کہہ سکتے ہیں کہ \عددی{I_0} حیطے کی سائن نما رو کی \اصطلاح{مؤثر}\فرہنگ{مؤثر} قیمت \عددی{\tfrac{I_0}{\sqrt{2}}} ہے۔اسی طرح کسی بھی شکل کی دہراتی ہوئی رو کی مؤثر قیمت \عددی{I_\text{مؤثر}} سے مراد وہ یک سمت رو ہے جو مزاحمت کو اس دہراتی ہوئی رو کے طاقت کے برابر طاقت منتقل کرتی ہو۔
...
\end{align}
طاقت منتقل ہو گا۔ہم یہ بھی جانتے ہیں کہ \عددی{I_\text{مؤثر}} یک سمت رو اسی مزاحمت کو درج ذیل طاقت منتقل کرتی ہے۔
\begin{align}
P=I^2_\text{مؤثر} R
\end{align}
اگر مزاحمت کو دونوں رو ایک برابر طاقت منتقل کرتی ہوں تب درج ذیل لکھا جا سکتا ہے
\begin{align*}
I^2_{\text{مؤثر}} R=\frac{1}{T} \int_{t_0}^{t_0+T} i^2(t) R \dif t
\end{align*}
جس سے
\begin{align}\label{مساوات_طاقت_موثر_قیمت_کی_تعریف}
I_{\text{مؤثر}}=\sqrt{\frac{1}{T} \int_{t_0}^{t_0+T} i^2(t) \dif t}
\end{align}
حاصل ہوتا ہے۔مساوات \حوالہ{مساوات_طاقت_موثر_قیمت_کی_تعریف} مؤثر رو \عددی{I_{\text{مؤثر}}} کی تعریف ہے۔

مؤثر دباؤ کو بھی اسی طرح حاصل کیا جا سکتا ہے۔مزاحمت \عددی{R} کے متوازی دباؤ \عددی{v(t)} نصب کرنے سے مزاحمت کو لمحاتی طور پر \عددی{\tfrac{v^2(t)}{R}} طاقت منتقل ہو گا۔اگر دباؤ کا دوری عرصہ \عددی{T} ہو تب مزاحمت کو اوسطاً 
\begin{align}
P=\frac{1}{T}\int_{t_0}^{t_0+T} \frac{v^2(t)}{R} \dif t
\end{align}
طاقت منتقل ہو گا۔اسی مزاحمت کو یک سمت دباؤ \عددی{V_{\text{مؤثر}}} اوسطاً درج ذیل طاقت فراہم کرتا ہے۔
\begin{align}
P=\frac{V^2_{\text{مؤثر}}}{R}
\end{align}
دونوں طاقت برابر ہونے کی صورت میں مؤثر دباؤ کی مساوات درج ذیل حاصل ہوتی ہے۔
\begin{align}\label{مساوات_طاقت_موثر_قیمت_کی_تعریف_ب}
V_{\text{مؤثر}}=\sqrt{\frac{1}{T}\int_{t_0}^{t_0+T} v^2(t) \dif t}
\end{align}
آئیں ان مساوات کی مدد سے چند امواج کی مؤثر قیمتیں دریافت کریں۔درج بالا مساوات سے آپ دیکھ سکتے ہیں کہ سائن نما موج کی مؤثر قیمت حاصل کرنے کی خاطر مربع حیطہ کی اوسط کا جذر لیا جاتا ہے۔دباؤ اور رو کے مؤثر قیمتوں کو عموماً \عددی{\Vrms} اور \عددی{\Irms} لکھا جاتا ہے۔آخر میں یاد رہے کہ جذر کا مثبت جواب مؤثر قیمت لیا جاتا ہے۔ 
%====================
\ابتدا{مثال}
بدلتا رو \عددی{i(t)=I_0\cos (\omega t+\theta)} کی مؤثر قیمت \عددی{\Irms} دریافت کریں۔

حل:اس موج کا دوری عرصہ \عددی{T=\tfrac{2\pi}{\omega}} ہے۔مساوات \حوالہ{مساوات_طاقت_موثر_قیمت_کی_تعریف} سے  رو کی مؤثر قیمت حاصل کرتے ہیں۔فی الحال جذر کی نشان سے چھٹکارا حاصل کرنے کی خاطر مساوات کا مربع لکھتے ہوئے آگے بڑھتے ہیں۔  
\begin{align*}
...
\end{align}
لکھا جا سکتا ہے۔چونکہ \عددی{\sin(\omega t +\theta)=\cos(\omega t +\theta-90^{\circ})} لکھا جا سکتا ہے لہٰذا سائن موج کی مؤثر قیمت بھی درج بالا ہو گی۔اسی طرح \عددی{V_0} حیطے کے سائن نما دباؤ کی مؤثر قیمت درج ذیل ہو گی۔
...
%===========
\ابتدا{مثال}
ہمارے ملک پاکستان میں \عددی{\SI{50}{\hertz}} تعدد اور \عددی{\SI{220}{\volt}} تا \عددی{\SI{240}{\volt}} مؤثر قیمت کا سائن نما برقی دباؤ گھریلو صارفین کو مہیا کا جاتا ہے۔دباؤ کا حیطہ دریافت کرتے ہوئے موج کی مساوات لکھیں۔

حل:دباؤ کی مؤثر قیمت کو \عددی{\SI{230}{\volt}} لیتے ہوئے  مساوات \حوالہ{مساوات_طاقت_موثر_تعریف_دباو} سے  حیطہ حاصل کرتے ہیں۔
\begin{align}
...
اب تک ہم دباؤ یا رو کا حیطہ لیتے ہوئے ان کے دوری سمتیات لکھتے رہے ہیں مثلاً  \عددی{\hat{V}=V_0\phase{\theta^{\circ}}\,\si{\volt}} دوری سمتیہ \عددی{V_0} حیطے اور \عددی{\theta} زاویہ ہٹاو کے کوسائن دباؤ کو ظاہر کرتا ہے۔ہم دوری سمتیات کو مؤثر قیمت کی صورت میں بھی لکھ سکتے ہیں۔یوں
 \عددی{\hat{V}_{\textup{rms}}=230\phase{\theta}\,\si{\volt}} میں \عددی{\SI{230}{\volt}} دباؤ کے مؤثر قیمت کو ظاہر کرتی ہے  جبکہ
 \عددی{\hat{V}=325\phase{\theta}\,\si{\volt}} میں \عددی{\SI{325}{\volt}} دباؤ کا حیطہ ہے۔تسلی کر لیں کہ یہ دونوں دوری سمتیات ایک ہی دباؤ کو ظاہر کرتی ہیں۔

دباؤ یا رو کی قیمتیں مختلف انداز میں بیان کی جا سکتی  ہیں۔مثلاً مساوات \حوالہ{مساوات_طاقت_پاکستانی_گھریلو_دباو} میں دباؤ کی چوٹی \عددی{V_{\textup{p}}} یا مثبت اور منفی چوٹیوں کے درمیان قیمت \عددی{V_{\textup{pp}}} اور یا پھر دباؤ کی مؤثر قیمت \عددی{\Vrms} بیان کی جا سکتی ہے۔یوں درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
V_{\textup{p}}&=\SI{325}{\volt}\\
V_{\textup{pp}}&=\SI{650}{\volt}\\
\Vrms&=\SI{230}{\volt}
\end{align*}
بدلتا رو مشینوں کے دباؤ اور رو کی عموماً مؤثر قیمتیں بیان کی جاتی ہیں۔یوں \عددی{\SI{230}{\volt}} پر چلنے والا گھریلو پنکھا درحقیقت \عددی{\SI{230}{\volt}} کے مؤثر دباؤ پر چلے گا۔اس کتاب میں مؤثر قیمتیں استعمال کرتے ہوئے دباؤ اور رو کے ساتھ مؤثر یا \عددی{\textup{rms}} لکھا جائے گا۔

سائن نما دباؤ اور سائن نما رو کی صورت میں مساوات \حوالہ{مساوات_طاقت_عمومی_الف} اوسط طاقت دیتی ہے۔اس مساوات کو یہاں دوبارہ پیش کرتے ہوئے ترتیب دیتے ہیں۔
\begin{align*}
P&=\frac{V_0 I_0}{2}\cos(\theta_v-\theta_i)\\
&=\frac{V_0}{\sqrt{2}}\frac{I_0}{\sqrt{2}}\cos(\theta_v-\theta_i)
\end{align*}
چونکہ \عددی{\tfrac{V_0}{\sqrt{2}}} اور \عددی{\tfrac{I_0}{\sqrt{2}}} بالترتیب مؤثر دباؤ \عددی{\Vrms} اور مؤثر رو \عددی{\Irms} ہیں لہٰذا درج بالا مساوات کو درج ذیل لکھا جا سکتا ہے۔
...
\end{align}
جو ہوبہو یک سمت مساوات کی طرح ہیں۔یہی حقیقت مؤثر قیمت کی مقبولیت کی وجہ بنی ہے۔ 
%================
\ابتدا{مثال}\شناخت{مثال_طاقت_موثر_قیمتیں_الف}
شکل \حوالہ{شکل_طاقت_موثر_قیمتیں_الف} میں دیے دباؤ کی مؤثر قیمت دریافت کریں۔اگر \عددی{D=\SI{50}{\percent}} اور \عددی{V_{\textup{p}}=\SI{60}{\volt}} ہوں تب یہ دباؤ \عددی{\SI{200}{\ohm}} مزاحمت کو کتنی طاقت مہیا کر سکتا ہے اور مزاحمت کی مؤثر رو کیا ہو گی۔
\begin{figure}
\centering
\begin{tikzpicture}
\pgfmathsetmacro{\T}{2};
...
حل:یہاں دوری عرصہ \عددی{T} ہے جس میں \عددی{t_1} مدت کے لیے دباؤ پایا جاتا ہے جبکہ \عددی{T-t_1} مدت کے لیے دباؤ صفر کے برابر رہتا ہے۔یوں  فعال عرصہ \عددی{D=\tfrac{t_1}{T}} ہے۔مساوات \حوالہ{مساوات_طاقت_موثر_قیمت_کی_تعریف_ب} استعمال کرتے ہوئے
\begin{align*}
V_{\text{مؤثر}}&=\sqrt{\frac{1}{T}\int_{0}^{T} v^2(t) \dif t}\\
...
دی گئی معلومات کے مطابق مؤثر دباؤ درج ذیل ہے
\begin{align*}
...
\end{align*}
مزاحمت کی مؤثر رو درج ذیل ہو گی۔
\begin{align*}
...
شکل \حوالہ{شکل_طاقت_موثر_قیمتیں_ب} میں \عددی{D} کی قیمت \عددی{\SI{30}{\percent}}، \عددی{\SI{50}{\percent}} اور \عددی{\SI{70}{\percent}} کی صورت میں  دباؤ کی مؤثر قیمت اور اوسط قیمت دریافت کریں جہاں \عددی{V_{\textup{p}}=\SI{10}{\volt}} ہے۔
\begin{figure}
\centering
\begin{tikzpicture}
\pgfmathsetmacro{\T}{2};
...
&=V_{\textup{p}}
\end{align*}
یوں دی گئی تینوں فعال عرصوں  کے لیے  مؤثر دباؤ \عددی{\SI{10}{\volt}} حاصل ہوتا ہے۔

آئیں اب اوسط دباؤ حاصل کریں۔
\begin{align*}
...
&=V_{\textup{p}}(2D-1)
\end{align*}
فعال عرصے کی دی گئی قیمتوں پر اوسط دباؤ درج ذیل حاصل ہوتے ہیں۔
\begin{align*}
...
شکل \حوالہ{شکل_طاقت_موثر_قیمتیں_پ} میں رو کی مؤثر قیمت دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
...
حل:یہاں دباؤ مسلسل تبدیل ہو رہا ہے لہٰذا اس کے خط کی مساوات درکار ہو گی۔دباؤ کا سیدھا خط \عددی{(0,0)} تا \عددی{(3,6)} خطی تفاعل ہے جس کی شرح ڈھال درج ذیل ہے۔
\begin{align*}
m&=\frac{y_2-y_1}{x_2-x_1}=\frac{6-0}{3-0}=2
\end{align*}
کارتیسی محدد پر \عددی{(0,0)} سے گزرتے \عددی{m} شرح ڈھال کے خط کی مساوات \عددی{y=mx} لکھی جاتی ہے لہٰذا دباؤ کے خط کی مساوات درج ذیل ہے۔
\begin{align*}
v(t)=2t
\end{align*}
مؤثر دباؤ درج ذیل ہے۔
\begin{align*}
...
شکل \حوالہ{شکل_طاقت_مشق_موثر_قیمتیں_الف} میں دیے دباؤ کی مؤثر قیمت دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
...
آگے زاویہ اور پیچھے زاویہ سے مراد دباؤ کے لہٰذا سے رو کا زاویہ ہے۔چونکہ امالی دور میں دباؤ سے رو پیچھے رہتی ہے لہٰذا ایسے ادوار \اصطلاح{پیچھے ادوار} کہلاتے ہیں اور ان کا زاویہ اور جزو طاقت بھی \اصطلاح{پیچھے} کہلاتے ہیں۔اس کے برعکس برق گیر دور میں دباؤ سے رو آگے رہتی ہے لہٰذا ان ادوار کو \اصطلاح{آگے ادوار} کہتے ہیں اور ان کا زاویہ اور جزو طاقت بھی \اصطلاح{آگے} کہلاتے ہیں۔یوں امالی بوجھ \عددی{Z_L=2+j6} کا زاویہ \عددی{\tan^{-1}\tfrac{6}{2}=71.57^{\circ}}  اور پیچھے جزو طاقت \عددی{\cos 71.57^{\circ}=0.316} ہے۔اسی طرح برق گیر بوجھ \عددی{Z_C=3-j4} کا زاویہ \عددی{\tan^{-1} \left(-\tfrac{4}{3}\right)=-53.13^{\circ}} اور آگے جزو طاقت \عددی{\cos(-53.13^{\circ})=0.6} ہے۔
%=============================
...
بجلی کا میٹر صارف کے ہاں نصب ہوتا ہے جو خرچ کیے توانائی کا حساب رکھتا ہے۔یہ میٹر ترسیلی تاروں میں ضائع توانائی کو نہیں ناپ سکتا۔برقی طاقت کے پیداکار صنعت کو صارف کی درکار طاقت کے ساتھ ساتھ ترسیلی تاروں میں ضائع ہونے والا طاقت بھی پیدا کرنا پڑتا ہے لہٰذا ان کی دلچسپی اس بات میں ہو گی کہ ترسیلی تاروں میں طاقت کا ضیاع کم سے کم ہو۔یہی وجہ ہے کہ پیداکار صنعت کوشش کرتی ہے کہ صارف کو مجبور کرے کہ اس کا جزو طاقت اکائی کے قریب ترین ہو۔اگر صارف اپنے جزو طاقت پر قابو نہیں پاتا تو پیداکار اس پر جرمانہ عائد کرتا ہے۔اس کتاب کے لکھتے وقت پاکستان میں \عددی{0.9} سے کم جزو طاقت کی صورت میں صارف صنعت پر جرمانہ عائد کیا جاتا ہے البتہ گھریلو صارفین پر فی الحال کم جزو طاقت کی صورت میں کوئی جرمانہ عائد نہیں کیا جاتا۔عموماً صنعتوں میں بوجھ کا بیشتر حصہ مختلف اقسام کے موٹر پر مبنی ہوتا ہے جو امالی بوجھ ہے۔یہی وجہ ہے کہ جب بھی صنعتی بوجھ کی بات کی جائے تو امالی بوجھ کی بات کی جاتی ہے۔  

حصہ \حوالہ{حصہ_طاقت_جزو_طاقت_پر_قابو} میں جزو طاقت پر قابو پانے پر غور کیا جائے گا۔
%============================
\ابتدا{مشق}
ایک صنعت کو \عددی{\SI{50}{\hertz}} تعدد اور \عددی{\SI{480}{\volt}\,\rms} دباؤ پر \عددی{\SI{60}{\kilo\watt}} طاقت \عددی{\SI{0.2}{\ohm}} مزاحمت کے ترسیلی تاروں کے ذریعہ فراہم کیا جاتا ہے۔ صارف اپنا جزو طاقت \عددی{0.64} امالی سے بہتر کرتے ہوئے \عددی{0.98} امالی کر دیتا ہے۔طاقت میں بچت دریافت کریں۔   

جواب:\عددی{\SI{4.376}{\kilo\watt}}
\انتہا{مشق}
%===========================
\حصہ{مخلوط طاقت}
برقرار حال بدلتا رو طاقت پر غور کرنے کے لیے \اصطلاح{مخلوط طاقت}\فرہنگ{مخلوط طاقت}\فرہنگ{طاقت!مخلوط}\حاشیہب{complex power}\فرہنگ{complex power}\فرہنگ{power!complex} کا جاننا ضروری ہے لہٰذا اس حصے میں مخلوط طاقت پر بحث کی جائے گی۔   
\begin{figure}
\centering
\begin{tikzpicture}
\draw (0,0)--++(0.5,0)--++(0,2.5)--++(-0.5,0)--++(0,-2.5);
\draw(0.25,1.25)node[rotate=90]{\RL{بدلتا رو دور}};
...
\end{tikzpicture}
\caption{طاقت کے اقسام پر غور کے لیے دور۔}
...
\bS=\bVrms\bIrmsCC
\end{align}
ہے جس میں دباؤ اور رو کی قیمتیں پر کرتے ہوئے 
\begin{gather}
...
\end{align}
جہاں مساوات \حوالہ{مساوات_طاقت_مقدار_مساوی_مخلوط_اور_جوڑی_دور_ضرب} اور مساوات \حوالہ{مساوات_طاقت_مخلوط_طاقت_مساوی_حقیقی_متعاملی} کا سہارا لیا گیا ہے۔اسی طرح مساوات \حوالہ{مساوات_طاقت_مخلوط_طاقت_الف} میں دباؤ کے بجائے رو کے لیے پر کرتے ہوئے درج ذیل لکھا جا سکتا ہے۔
\begin{align}
\bS=\bVrms\left(\frac{\bVrms}{\bZ}\right)^*=\frac{\VrmsS}{\bZCC}=\VrmsS \bYCC=\VrmsS(B+jG)^*=P+jQ
\end{align}
اس مساوات کے تحت جوڑی دار مخلوط فراوانی کو دباؤ کی مؤثر قیمت سے ضرب دیتے ہوئے فراوانی کی طاقت حاصل کی جا سکتی ہے۔یہ وہ طاقت ہے جو فراوانی جذب کرتا ہے۔  یوں اگر شکل \حوالہ{شکل_طاقت_اقسام_طاقت} میں برق گیر بطور بوجھ \عددی{\bZ} نصب ہوتا تب فراوانی \عددی{j\omega C} کے برابر ہوتی جسے درج بالا مساوات میں پر کرتے ہوئے
...
شکل \حوالہ{شکل_طاقت_طاقتی_تعلقات} طاقت کے تعلقات پر  مزید روشنی ڈالتا ہے۔شکل-الف کے تحت رو کو دو ٹکڑوں میں تقسیم کیا جا سکتا ہے۔پہلا ٹکڑا \عددی{\bVrms} کے ہم زاویہ ہے جبکہ دوسرا ٹکڑا دباؤ کے ساتھ \عددی{90^{\circ}} کا زاویہ بناتا ہے۔مساوات \حوالہ{مساوات_طاقت_مخلوط_طاقت_پ} کے تحت دباؤ اور اس کے ہم زاویہ رو مل کر حقیقی طاقت \عددی{P} پیدا کرتے ہیں۔اسی طرح مساوات \حوالہ{مساوات_طاقت_مخلوط_طاقت_ت} کے تحت دباؤ اور دباؤ کے قائمہ  رو مل کر متعاملی طاقت \عددی{Q} پیدا کرتے ہیں۔انہیں دو مساوات سے درج ذیل تعلق بھی حاصل ہوتا ہے
\begin{align}
...
امالی بوجھ کو \عددی{\SI{50}{\kilo\watt}} طاقت فراہم کی جا رہی ہے۔بوجھ پر مؤثر دباؤ \عددی{\SI{230}{\volt}}، تعدد \عددی{\SI{50}{\hertz}} اور پیچھے جزو طاقت \عددی{0.9} ہے۔ترسیلی تاروں  کی رکاوٹ \عددی{\bZ_{\text{تار}}=0.05+j0.25\,\si{\ohm}} ہے۔ منبع طاقت پر دباؤ، جزو طاقت اور طاقت کا تخمینہ لگائیں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
...
حل:دور کو شکل \حوالہ{شکل_طاقت_جزو_طاقت_الف} میں دکھایا گیا ہے جہاں ترسیلی تار کی رکاوٹ صرف بالائی تار پر دکھائی گئی ہے۔حقیقت میں بالائی اور نچلی تار کی رکاوٹیں سلسلہ وار جڑی ہیں۔ان کا مجموعہ کُل رکاوٹ ہے جسے عموماً ایک تار پر دکھایا جاتا ہے۔

بوجھ کے دباؤ کو حوالہ دوری سمتیہ لیتے ہوئے اس کا زاویہ صفر چنا گیا ہے۔مخلوط طاقت
\begin{align*}
...
%================
\ابتدا{مثال}
گزشتہ مثال کے شکل \حوالہ{شکل_طاقت_جزو_طاقت_الف} میں بقایا تمام معلومات وہی ہیں البتہ بوجھ پر جزو طاقت پیچھے کے بجائے آگے ہے۔منبع طاقت کا دباؤ حاصل کریں۔

حل:گزشتہ مثال میں عین ہمارے توقع کے مطابق منبع طاقت کا دباؤ، بوجھ کے دباؤ سے زیادہ تھا۔یک سمت ادوار میں ہم یہی توقع کرتے ہیں کہ زیادہ دباؤ کے نقطے سے طاقت  کم دباؤ کے نقطے  کو فراہم ہوتا ہے۔اس مثال میں ہم دیکھیں گے کہ کبھی کبھار ہمارے توقعات غلط ثابت ہوتی ہیں۔ 
...
\end{align*}
آگے  ہے لہٰذا منبع پر آگے جزو طاقت \عددی{\cos(-10.31^{\circ})=0.98} ہو گا۔آپ دیکھ سکتے ہیں کہ بوجھ پر مؤثر دباؤ \عددی{\SI{230}{\volt}} ہے جبکہ منبع طاقت کا مؤثر دباؤ \عددی{\SI{223}{\volt}} ہے جو کہ بوجھ کے دباؤ سے کم ہے۔
\انتہا{مثال}
%===================
\ابتدا{مشق}
شکل \حوالہ{شکل_طاقت_جزو_طاقت_الف} میں بقایا تمام معلومات وہی ہیں البتہ آگے جزو طاقت \عددی{0.8} ہے۔منبع طاقت کا مؤثر دباؤ اور جزو طاقت حاصل کریں۔منبع کتنا طاقت پیدا کر رہا ہے۔

جوابات:\عددی{\SI{210}{\volt}\, \textup{rms}}، \عددی{\pf=0.94 \,\text{آگے}}، \عددی{\SI{53.69}{\kilo\watt}}
\انتہا{مشق}
%=================
\ابتدا{مشق}
ایک صنعتی بوجھ کو \عددی{\SI{30}{\kilo\watt}} طاقت \عددی{0.82} پیچھے جزو طاقت پر درکار ہے۔بوجھ پر مؤثر دباؤ \عددی{\SI{230}{\volt}} اور تعدد \عددی{\SI{50}{\hertz}} ہے۔منبع سے صنعت تک طاقت کو ترسیلی تاروں کے ذریعہ پہنچایا جاتا ہے۔ان ترسیلی تاروں کی رکاوٹ \عددی{\bZ_{\text{تار}}=0.08+j0.3\,\si{\ohm}} ہے۔ترسیلی تاروں میں حقیقی اور متعاملی طاقت کا ضیاع دریافت کریں۔ترسیلی تار کے داخلی سر پر درکار حقیقی اور متعاملی طاقت دریافت کریں۔
...
%=================
\ابتدا{مشق}
صنعتی بوجھ کو \عددی{0.86} امالی جزو طاقت پر \عددی{\SI{25}{\kilo\watt}} طاقت \عددی{\SI{230}{\volt}\,\rms}  اور \عددی{\SI{50}{\hertz}} تعدد پر فراہم کی جا رہی ہے۔ترسیلی تار کی رکاوٹ  \عددی{\bZ_{\text{تار}}=0.1+j0.2\,\si{\ohm}} ہے۔تاروں کے داخلی سروں پر مؤثر دباؤ اور جزو طاقت دریافت کریں۔

جوابات:\عددی{254\phase{3.4^{\circ}} \,\si{\volt}\,\rms}، \عددی{0.83} امالی
\انتہا{مشق}
%=================
\ابتدا{مشق}\شناخت{مشق_طاقت_دو_متوازی_بوجھ}
شکل \حوالہ{شکل_طاقت_دو_متوازی_بوجھ} میں منبع طاقت کا دباؤ اور جزو طاقت دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
...
کوئی بھی صنعت حقیقی طاقت \عددی{P} استعمال کرتے ہوئے کام سرانجام دیتی ہے۔کوئی بھی صنعت قائم کرنے سے پہلے اس کی پیدا وار طے کی جاتی ہے۔اس پیدا وار کو حاصل کرنے کے لیے درکار مشین نصب کیے جاتے ہیں۔غیر ضروری طور پر \عددی{P} بڑھانے سے مراد، ضرورت سے زیادہ بڑی مشینیں نصب کرنا ہے، جس سے صنعت قائم کرنے کا خرچہ بڑھتا ہے۔جزو طاقت بہتر کرنے کا یہ انتہائی مہنگا طریقہ ہو گا جسے کبھی بھی نہیں اپنایا جاتا۔ساتھ ہی ساتھ زیادہ پیداوار کے لیے زیادہ سرمایہ درکار ہو گا۔

آئیں اب \عددی{Q} کم کرتے ہیں۔جیسا درج بالا مثال میں دکھایا گیا، امالی بوجھ کے متوازی برق گیر جوڑنے سے \عددی{Q} کو کم کیا جا سکتا ہے۔برق گیر کی  لاگت  صنعتی مشینوں کے لحاظ سے بہت کم ہوتی ہے لہٰذا جزو طاقت کو برق گیر سے ہی بہتر بنایا جاتا ہے۔شکل \حوالہ{شکل_طاقت_درستگی_جزو_طاقت_صنعتی_بہتر} -الف میں صنعتی بوجھ کے متوازی برق گیر نصب کیا گیا ہے۔شکل-ب میں بوجھ کا طاقتی تکون دکھایا گیا ہے جس میں برق گیر متعاملی طاقت بھی دکھائی گئی ہے۔شکل-پ میں منبع طاقت کو درپیش صنعتی بوجھ اور برق گیر متعاملی طاقت کا کُل طاقتی تکون دکھایا گیا ہے۔آپ دیکھ سکتے ہیں کہ \عددی{Q} کم ہونے سے طاقتی تکون کا زاویہ کم اور جزو طاقت بہتر ہو گا۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
\draw[-latex](3,0)--++(0,2);
\draw[-latex](0,0)--++(3,0)node[below,pos=0.6]{$P_b$};
\draw[-latex](0,0)--++(3,1)node[above left,pos=0.9]{$S_{\text{بہتر}}$};
\draw[-latex](3,0)--++(0,1);
\draw[-latex] (3.3,2)--++(0,-1)node[right,pos=0.5]{$Q_C$};
\draw[-stealth] ([shift={(0:1.3)}]0,0) arc (0:18.43:1.3);
\draw(3/4*18:1.3)node[right]{$\theta_{\text{بہتر}}$};
\end{tikzpicture}
\caption*{(ت)}
...
\bS_C=-jQ_C=-j \omega C \VrmsS\quad \quad \text{\RL{جزو طاقت درست کرنے کے لیے درکار برق گیر}}
\end{align}
کسی بھی جزو طاقت کے حصول کے لیے  \عددی{\bS_C} کو شکل \حوالہ{شکل_طاقت_درستگی_جزو_طاقت_صنعتی_بہتر}-ت سے حاصل کا جا سکتا ہے جسے استعمال کرتے ہوئے درج بالا مساوات سے درکار \عددی{C} حاصل کیا جا سکتا ہے۔ جزو طاقت قابو کرنے کے لیے برق گیر کی سکت عموماً متعاملی وولٹ ایمپیئر \عددی{\si{\var}} میں ہی بیان کی جاتی ہے۔یوں \عددی{\SI{50}{\hertz}}، \عددی{\SI{440}{\volt}\,\rms} پر استعمال ہونے  والے \عددی{\SI{822}{\micro\farad}} برق گیر کو \عددی{\SI{50}{\kilo\var}} کا برق گیر کہا جائے گا۔
...
\end{align*}
ہم حقیقی طاقت تبدیل کیے بغیر \عددی{0.9} جزو طاقت درکار ہے جس پر مخلوط طاقت درج ذیل ہو گا۔
\begin{align*}
...
\end{align*}
اس طرح \عددی{\SI{50}{\kilo\var}} سکت کے برق گیر استعمال کرتے ہوئے \عددی{\tfrac{\SI{539}{\kilo\var}}{\SI{50}{\kilo\var}}=10.78} عدد برق گیر درکار ہوں گے۔جزو طاقت بہتر بنانے والے برق گیر مختلف اکایوں میں دستیاب ہیں۔یوں \عددی{\SI{50}{\kilo\var}} کے اکائی میں دستیاب گیارہ عدد برق گیر نصب کیے جائیں گے۔

اگرچہ صنعت کار زیادہ برق گیر نصب کرتے ہوئے اکائی جزو طاقت بھی حاصل کر سکتا ہے لیکن اس کو ایسا کرنے سے کوئی اضافی فائدہ نہیں ہو گا۔جرمانہ صرف \عددی{0.9} جزو طاقت سے کم پر عائد ہوتا ہے۔جزو طاقت کو \عددی{0.9} سے بہت بہتر کرنے پر توانائی کی قیمت میں چھوٹ نہیں ملتی لہٰذا صنعت کار اضافی خرچہ نہیں کرے گا۔    
\انتہا{مثال}
%================
\ابتدا{مثال}
پاکستان کی سب سے بڑی صنعت کپاس سے روئی کا دھاگا بناتی ہے۔ایسی ایک صنعت کا جزو طاقت \عددی{0.84} امالی اور حقیقی طاقت \عددی{\SI{200}{\kilo\watt}} تھا جب نیا قانون نافذ ہوا جس کے تحت کم سے کم جزو طاقت \عددی{0.9} مقرر کیا گیا۔اس صنعت کو کتنا برق گیر نصب کرنا پڑا۔
...
%==================
\ابتدا{مشق}
مثال \حوالہ{مثال_طاقت_فرنس_الف} کے صنعت کار زیادہ محتاط ہیں۔وہ جزو طاقت کو \عددی{0.7} سے بہتر کرتے ہوئے  \عددی{0.95} امالی کرنا چاہتے ہیں۔انہیں درکار متعاملی طاقت دریافت کریں۔انہیں \عددی{\SI{50}{\kilo\var}} اکائی کے کتنے برق گیر نصب کرنے ہوں گے؟

جواب:\عددی{\SI{690}{\kilo\var}}، \عددی{14} عدد
\انتہا{مشق}
%=================
\حصہ{برقی جھٹکا}
برقی دباؤ اور طاقت کے بارے میں علم حاصل کرتے وقت ضروری ہے کہ ان سے لاحق خطرات اور ان خطرات سے بچنے کے حفاظتی اقدامات اور تدابیر پر بھی غور کیا جائے۔

 میں چھوٹا بچہ تھا جب مجھے پہلی مرتبہ بجلی کا جھٹکا لگا۔آپ میں سے  بیشتر طلباء بھی اس کٹھن تجربے سے گزر چکے ہوں گے۔کسی بھی دو مختلف اجسام کے رگڑ سے ساکن  دباؤ پیدا ہوتا ہے۔اونی جرسی اتارنے سے جرسی اور آپ کے جسم کے مابین \عددی{\SI{20}{\kilo\volt}} تا \عددی{\SI{40}{\kilo\volt}} کا ساکن دباؤ پیدا ہو سکتا ہے۔ آپ نے اندھرے میں اونی جرسی اتارتے ہوئے شعلے ضرور دیکھے ہوں گے جو اسی ساکن دباؤ کی وجہ سے پیدا ہوتے ہیں۔آپ کو ساکن دباؤ کے جھٹکے بھی لگے ہوں گے جن سے جسم میں \عددی{\SI{40}{\ampere}} تک کی رو گزر سکتی ہے۔جسم میں رو گزرنے سے بجلی کا جھٹکا محسوس ہوتا ہے۔ رو گزرنے سے پٹھے کھینچ جاتے ہیں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0)--++(0,{ln(10000)});
...
\draw(1,{ln(150)}) node[right,align=left]{\RL{قلب دھڑکنے کے بجائے تھرتھرانے لگتا ہے۔ بجلی سے جلد علیحدہ نہ ہونے کی صورت میں جان لیوا ثابت ہوتا ہے۔}};
...
%=======================
\حصہ{ایک دور کا نظام}
گھریلو صارفین کو عموماً ایک دور طاقت مہیا کی جاتی ہے۔ایک دور نظام کو شکل \حوالہ{شکل_طاقت_ایک_دور_نظام} میں دکھایا گیا ہے جہاں منبع دباؤ کو \اصطلاح{واپڈا}\فرہنگ{واپڈا}\حاشیہب{WAPDA}\فرہنگ{WAPDA} کا ٹرانسفارمر تصور کیا جائے۔
...
صارف کے عمارت میں نصب برقی میٹر، خرچ کی گئی توانائی  کو ناپ کر اس کا حساب رکھتا ہے۔ایک مثال دیکھ کر آگے بڑھتے ہیں۔
%=====================================
...
%===========
\ابتدا{سوال}
ایک دور کا دباؤ اور اس کی رو درج ذیل ہیں۔دور کی اوسط طاقت دریافت کریں۔
\begin{align*}
v(t)&=3\sin \omega t \, \si{\volt}\\
i(t)&=10\cos \omega t \,\si{\ampere}
\end{align*}
جواب:\عددی{p=\SI{0}{\watt}}
\انتہا{سوال}
%===============
\ابتدا{سوال}
ایک دور کا دباؤ اور اس کی رو درج ذیل ہیں۔دور کی اوسط طاقت دریافت کریں۔
...
\end{align*}
جواب:\عددی{p=\SI{14.49}{\watt}}
\انتہا{سوال}
%===============
\ابتدا{سوال}\شناخت{سوال_طاقت_الف}
شکل \حوالہ{شکل_سوال_طاقت_الف}-الف میں رو حاصل کرتے ہوئے اوسط طاقت کا ضیاع دریافت کریں۔
\begin{figure}
\centering
\begin{subfigure}{0.4\textwidth}
\centering
\begin{tikzpicture}
\draw(0,0) to [american voltage source,l={$22\phase{40^{\circ}}\,\si{\volt}$}]++(0,\y) to [resistor,l={$\SI{2}{\ohm}$}]++(\x,0) to [inductor,l={$j4\,\si{\ohm}$}]++(0,-\y) to [short] (0,0);
\end{tikzpicture}
\caption*{(الف)}
\end{subfigure}%
\begin{subfigure}{0.6\textwidth}
\centering
\begin{tikzpicture}
\draw(0,0) to [american voltage source,l={$v_s(t)$}]++(0,\y) to [resistor,l={$\SI{8}{\ohm}$}]++(\x,0) to [inductor,l={$\SI{50}{\milli\henry}$}]++(\x,0) to [resistor,l={$\SI{10}{\ohm}$}]++(0,-\y) to [short] (0,0);
\draw(\x,0) to [capacitor,*-*,l={$\SI{1}{\milli\farad}$}]++(0,\y);
\end{tikzpicture}
\caption*{(ب)}
\end{subfigure}%
\caption{سوال \حوالہ{سوال_طاقت_الف} کا دور۔}
\label{شکل_سوال_طاقت_الف}
\end{figure}

جواب:\عددی{p=\SI{24.2}{\watt}}
\انتہا{سوال}
%================
\ابتدا{سوال}\شناخت{سوال_طاقت_ب}
شکل \حوالہ{شکل_سوال_طاقت_الف}-ب میں \عددی{v_s(t)=120\cos 100t\,\si{\volt}} ہے۔دور میں اوسط طاقت کا ضیاع دریافت کریں۔

جواب:\عددی{\SI{394.52}{\watt}}
\انتہا{سوال}
%========================
\ابتدا{سوال}\شناخت{سوال_طاقت_پ}
شکل \حوالہ{شکل_سوال_طاقت_پ} میں منبع کا اوسط طاقت دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [american current source,l={$10\phase{45^{\circ}}\,\si{\ampere}$}]++(0,\y);
\draw(\x,0) to [resistor,*-*,l={$\SI{6}{\ohm}$}]++(0,\y);
\draw(2*\x,0) to [capacitor,*-*,l={$-j2\,\si{\ohm}$}]++(0,\y);
\draw(3*\x,0) to [resistor,l={$\SI{2}{\ohm}$}]++(0,\y);
\draw(0,0) to [short]++(3*\x,0);
\draw(0,\y) to [short]++(\x,0) to [inductor,l={$j1\,\si{\ohm}$}]++(\x,0) to [short]++(\x,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_طاقت_پ} کا دور۔}
\label{شکل_سوال_طاقت_پ}
\end{figure}

جواب:\عددی{\SI{42.86}{\watt}}
\انتہا{سوال}
%=========================
\ابتدا{سوال}\شناخت{سوال_طاقت_ت}
شکل \حوالہ{شکل_سوال_طاقت_ت} کے \عددی{\SI{2}{\ohm}} مزاحمت میں اوسط طاقت کا ضیاع دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [american current source,l={$15\phase{0^{\circ}}\,\si{\ampere}$}]++(0,2*\y);
\draw(\x,2*\y) to [resistor,*-,l_={$\SI{2}{\ohm}$}]++(0,-\y) to [short]++(\x,0) to [inductor,-*,l_={$j4\,\si{\ohm}$}]++(0,\y);
\draw(\x+\x/2,0) to [capacitor,*-*,l={$-j2\,\si{\ohm}$}]++(0,\y);
\draw(3*\x,0) to [resistor,l_={$\SI{6}{\ohm}$}]++(0,2*\y);
\draw(0,0) to [short]++(3*\x,0);
\draw(0,2*\y) to [short]++(3*\x,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_طاقت_ت} کا دور۔}
\label{شکل_سوال_طاقت_ت}
\end{figure}

جواب:\عددی{\SI{109.5}{\watt}}
\انتہا{سوال}
%=========================
\ابتدا{سوال}\شناخت{سوال_طاقت_ٹ}
شکل \حوالہ{شکل_سوال_طاقت_ٹ} میں \عددی{\SI{1}{\kilo\ohm}} کے بوجھ میں طاقت کی اوسط ضیاع دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) node[op amp](u1){};
\draw(u1.+) to [short]++(-\x/8,0)++(0,-\y)node[ground]{} to [american voltage source,l={$0.75\cos 10t \,\si{\volt}$}]++(0,\y);
\draw(u1.-) to [short,-*]++(-\x/8,0) to [resistor,l_={$\SI{2}{\kilo\ohm}$}]++(-\x,0)node[ground]{};
\draw(u1.-)++(-\x/8,0) to [short]++(0,\y/2) to [resistor,l={$\SI{5}{\kilo\ohm}$}]++(\x+\x/4,0)-|(u1.out);
\draw(u1.out) to [resistor,*-,l={$\SI{1}{\kilo\ohm}$}]++(0,-\y)node[ground]{};
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_طاقت_ٹ} کا دور۔}
\label{شکل_سوال_طاقت_ٹ}
\end{figure}

جواب:\عددی{\SI{3.45}{\milli\watt}}
\انتہا{سوال}
%=========================
\ابتدا{سوال}\شناخت{سوال_طاقت_ث}
شکل \حوالہ{شکل_سوال_طاقت_ث} میں طاقت کا اوسط ضیاع \عددی{\SI{200}{\watt}} ہے۔نا معلوم رکاوٹ \عددی{\bZ_L} دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [american voltage source,l={$20\phase{30^{\circ}}\,\si{\volt}$}]++(0,\y);
\draw(\x,0) to [resistor,*-*,l_={$\SI{2}{\ohm}$}]++(0,\y);
\draw(2*\x,0) to [european resistor,l={$\bZ_L$}]++(0,\y);
\draw(0,0) to [short]++(2*\x,0);
\draw(0,\y) to [short]++(\x,0) to [inductor,l={$j1\,\si{\ohm}$}]++(\x,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_طاقت_ث} کا دور۔}
\label{شکل_سوال_طاقت_ث}
\end{figure}

جواب:\عددی{\bZ_L=\SI{1}{\ohm}}
\انتہا{سوال}
%=========================
\ابتدا{سوال}\شناخت{سوال_طاقت_ج}
شکل \حوالہ{شکل_سوال_طاقت_ج} \عددی{\bZ_L} کو زیادہ سے زیادہ اوسط طاقت منتقل کرنا ہے۔رکاوٹ \عددی{\bZ_L} کی قیمت دریافت کریں اور اس کو اوسط منتقل طاقت \عددی{p_Z} حاصل کریں۔منبع کا اوسط طاقت \عددی{p_m} حاصل کرتے ہوئے  \عددی{\bZ_L} کو طاقت منتقل کرنے کی کارگزاری دریافت کریں۔ 
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [american current source,l={$20\phase{30^{\circ}}\,\si{\ampere}$}]++(0,\y);
\draw(\x,0) to [resistor,*-*,l={$\SI{2}{\ohm}$}]++(0,\y);
\draw(2*\x,0) to [european resistor,l={$\bZ_L$}]++(0,\y);
\draw(0,0) to [short]++(2*\x,0);
\draw(0,\y) to [short]++(\x,0) to [inductor,l={$j2\,\si{\ohm}$}]++(\x,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_طاقت_ج} کا دور۔}
\label{شکل_سوال_طاقت_ج}
\end{figure}

جوابات:\عددی{\bZ_L=2-j2\,\si{\ohm}}، \عددی{p_Z=\SI{25}{\watt}}، \عددی{p_m=\SI{50}{\watt}}، \عددی{\SI{50}{\percent}}
\انتہا{سوال}
%=========================
\ابتدا{سوال}\شناخت{سوال_طاقت_چ}
شکل \حوالہ{شکل_سوال_طاقت_چ} \عددی{\bZ_L} کو زیادہ سے زیادہ اوسط طاقت منتقل کرنا ہے۔رکاوٹ \عددی{\bZ_L} کی قیمت  اور اس کو اوسط منتقل طاقت  حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [american voltage source,l={$22\phase{45^{\circ}}\,\si{\volt}$}]++(0,\y);
\draw(2*\x,0) to [american current source,*-*,l={$2\phase{30^{\circ}}\,\si{\ampere}$}]++(0,\y);
\draw(4*\x,0) to [european resistor,l_={$\bZ_L$}]++(0,\y);
\draw(0,0) to [short]++(4*\x,0);
\draw(0,\y) to [resistor,l={$\SI{1}{\ohm}$}]++(\x,0) to [capacitor,l={$-j2\,\si{\ohm}$}]++(\x,0) to [resistor,l={$\SI{2}{\ohm}$}]++(\x,0) to [inductor,l={$j1\,\si{\ohm}$}]++(\x,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_طاقت_چ} کا دور۔}
\label{شکل_سوال_طاقت_چ}
\end{figure}

جوابات:\عددی{\bZ=3-j1\,\si{\ohm}}، \عددی{\SI{22.64}{\watt}}
\انتہا{سوال}
%=========================
\ابتدا{سوال}\شناخت{سوال_طاقت_ح}
شکل \حوالہ{شکل_سوال_طاقت_ح} \عددی{\bZ_L} کو زیادہ سے زیادہ اوسط طاقت منتقل کرنا ہے۔رکاوٹ \عددی{\bZ_L} کی قیمت  اور اس کو اوسط منتقل طاقت  حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [capacitor,l={$-j2\,\si{\ohm}$}]++(0,\y);
\draw(\x,0) to [european resistor,*-*,l={$\bZ_L$}]++(0,\y);
\draw(2*\x,0) to [resistor,l_={$\SI{1}{\ohm}$}]++(0,\y);
\draw(0,0) to [short]++(2*\x,0);
\draw(0,\y) to [resistor,l={$\SI{1}{\ohm}$}]++(\x,0) to [inductor,l={$j2\,\si{\ohm}$}]++(\x,0);
\draw(0,\y) to [short,*-]++(0,3/4*\y) to [american voltage source,l={$10\phase{0^{\circ}}\,\si{\volt}$}]++(2*\x,0) to [short,-*]++(0,-3/4*\y);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_طاقت_ح} کا دور۔}
\label{شکل_سوال_طاقت_ح}
\end{figure}

جوابات:\عددی{\bZ_L=\tfrac{8}{5}\,\si{\ohm}}، \عددی{\SI{2.8125}{\watt}}
\انتہا{سوال}
%=========================
\ابتدا{سوال}\شناخت{سوال_طاقت_خ}
شکل \حوالہ{شکل_سوال_طاقت_خ} \عددی{\bZ_L} کو زیادہ سے زیادہ اوسط طاقت منتقل کرنا ہے۔رکاوٹ \عددی{\bZ_L} کی قیمت  اور اس کو اوسط منتقل طاقت  حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [american current source,l={$6\phase{0^{\circ}}\,\si{\ampere}$}]++(0,3*\y);
\draw(\x,0) to [resistor,*-*,l={$\SI{6}{\ohm}$}]++(0,3*\y);
\draw(2*\x+\x/2,3*\y) to [american voltage source,*-,l_={$10\phase{0^{\circ}}\,\si{\volt}$}]++(0,-\y) to [resistor,l={$\SI{1}{\ohm}$}]++(0,-\y) to [short,*-]++(-\x/2,0) to [capacitor,l_={$-j2 \,\si{\ohm}$}]++(0,-\y)to [resistor,l_={$\SI{1}{\ohm}$}]++(\x,0) to [inductor,l_={$j2\,\si{\ohm}$}]++(0,\y) to [short]++(-\x/2,0);
\draw(0,0) to [short,-*]++(2*\x,0)++(\x,0) to [short,*-]++(\x,0) to [european resistor,l_={$\bZ_L$}]++(0,3*\y) to [resistor,l={$\SI{4}{\ohm}$}]++(-\x-\x/2,0);
\draw(0,3*\y) to [short]++(2*\x+\x/2,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_طاقت_خ} کا دور۔}
\label{شکل_سوال_طاقت_خ}
\end{figure}

جوابات:\عددی{\bZ_L=6.8-j1.6\,\si{\ohm}}، \عددی{\SI{2.18}{\watt}}
\انتہا{سوال}
%=========================
\ابتدا{سوال}\شناخت{سوال_طاقت_موثر_الف}
شکل \حوالہ{شکل_سوال_طاقت_موثر_الف}-الف میں دیے دباؤ کی مؤثر قیمت دریافت کریں۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}
\begin{axis}[small,ytick={-4,0,4},yticklabels={$-4$,$0$,$4$},xlabel={$t\,(\si{\second})$},ylabel={$v(t)\,(\si{\volt})$},ylabel style={rotate=-90},ylabel style={at={(axis description cs:0,1.05)}}]
\addplot[] plot coordinates {(-0.5,-4) (0,-4) (0,4) (1,4) (1,-4) (2,-4) (2,4) (3,4) (3,-4) (4,-4) (4,4)(5,4)(5,-4)(5.5,-4) };
\end{axis}
\end{tikzpicture}
\caption*{(الف)}
\end{subfigure}%
...
\centering
\begin{tikzpicture}
\begin{axis}[small,ytick={-2,0,6},yticklabels={$-2$,$0$,$6$},xlabel={$t\,(\si{\second})$},ylabel={$i(t)\,(\si{\ampere})$},ylabel style={rotate=-90},ylabel style={at={(axis description cs:0,1.05)}}]
\addplot[] plot coordinates {(-0.5,-2) (0,-2) (0,6) (1,6) (1,-2) (2,-2) (2,6) (3,6) (3,-2) (4,-2) (4,6)(5,6)(5,-2)(5.5,-2) };
\end{axis}
\end{tikzpicture}
\caption*{(ب)}
\end{subfigure}%
\caption{سوال \حوالہ{سوال_طاقت_موثر_الف} اور سوال \حوالہ{سوال_طاقت_موثر_ب} کے ترسیم۔}
\label{شکل_سوال_طاقت_موثر_الف}
\end{figure}

جواب:\عددی{\Vrms=\SI{4}{\volt}}
\انتہا{سوال}
%==========================

\ابتدا{سوال}\شناخت{سوال_طاقت_موثر_ب}
شکل \حوالہ{شکل_سوال_طاقت_موثر_الف}-ب میں دیے رو کی مؤثر قیمت دریافت کریں۔

جواب:\عددی{\Irms=\sqrt{20}\,\si{\ampere}}
\انتہا{سوال}
%======================
\ابتدا{سوال}\شناخت{سوال_طاقت_موثر_پ}
شکل \حوالہ{شکل_سوال_طاقت_موثر_پ}-الف میں دیے دباؤ کی مؤثر قیمت دریافت کریں۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}
\begin{axis}[small,ytick={-2,0,1,3},yticklabels={$-2$,$0$,$1$,$3$},xlabel={$t\,(\si{\second})$},ylabel={$v(t)\,(\si{\volt})$},ylabel style={rotate=-90},ylabel style={at={(axis description cs:0,1.05)}}]
\addplot[] plot coordinates {(-0.5,-2)(0,-2)(0,3) (2,3)( 2,1)(3,1)(3,-2)(4,-2)(4,3) (4.5,3) };
\end{axis}
\end{tikzpicture}
\caption*{(الف)}
\end{subfigure}%
...
\centering
\begin{tikzpicture}
\begin{axis}[small,ytick={0,1,2,3},yticklabels={$0$,$1$,$2$,$3$},xlabel={$t\,(\si{\second})$},ylabel={$i(t)\,(\si{\ampere})$},ylabel style={rotate=-90},ylabel style={at={(axis description cs:0,1.05)}},xtick={0,2,3,5,6,8,9,11},xticklabels={$0$,$2$,$3$,$5$,$6$,$8$,$9$,$11$}]
\addplot[] plot coordinates {(-0.5,0) (0,0) (0,1) (2,1) (2,2) (3,2) (3,3) (5,3) (5,0) (6,0) (6,1)(8,1)(8,2)(9,2) (9,3) (11,3) (11,0) (11.5,0)};
\end{axis}
\end{tikzpicture}
\caption*{(ب)}
\end{subfigure}%
\caption{سوال \حوالہ{سوال_طاقت_موثر_پ} اور سوال \حوالہ{سوال_طاقت_موثر_ت} کے ترسیم۔}
\label{شکل_سوال_طاقت_موثر_پ}
\end{figure}

جواب:\عددی{\Vrms=\tfrac{\sqrt{23}}{2}\,\si{\volt}}
\انتہا{سوال}
%==========================

\ابتدا{سوال}\شناخت{سوال_طاقت_موثر_ت}
شکل \حوالہ{شکل_سوال_طاقت_موثر_الف}-ب میں دیے رو کی مؤثر قیمت دریافت کریں۔

جواب:\عددی{\Irms=\SI{2}{\ampere}}
\انتہا{سوال}
%=========================
\ابتدا{سوال}
دباؤ \عددی{v(t)=15+10\cos(\omega t+30^{\circ})\,\si{\volt}} کی مؤثر قیمت دریافت کریں۔

جواب:\عددی{\Vrms=\SI{13.398}{\volt}}
\انتہا{سوال}
%==============================
\ابتدا{سوال}\شناخت{طاقت_صنعتی_الف}
شکل \حوالہ{شکل_طاقت_صنعتی_بوجھ} میں صنعتی بوجھ کو طاقت مہیا کیا گیا ہے۔ ایمپیئر پیما مؤثر \عددی{\SI{130}{\ampere}} اور وولٹ پیما مؤثر \عددی{\SI{440}{\volt}} ناپتے ہیں جبکہ بوجھ کو \عددی{\SI{50}{\kilo\watt}} فراہم کیا جا رہے ہے۔صنعتی بوجھ کا امالی جزو طاقت دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [american voltage source,l={$\bV_m$}]++(0,\y) to [european resistor,l={$\bZ_\text{\RL{تار}}$}]++(\x,0) to node [component]{A}++(\x+\x/2,0) to [european resistor,l={$\bZ_{\text{بوجھ}}$}] ++(0,-\y) to [short](0,0);
\draw(\x,0) to node [component]{V}++(0,\y);
\draw(\x,0) node[circ]{};
\draw(\x,\y) node[circ]{};
\draw(\x+3/4*\x,\y+\y/5)node[above]{\RL{ایمپیئر پیما}};
\draw(\x+\x/2,\y/2)node[]{\RL{وولٹ پیما}};
\end{tikzpicture}
\caption{صنعتی بوجھ کو طاقت مہیا کیا گیا ہے۔}
\label{شکل_طاقت_صنعتی_بوجھ}
\end{figure}

جواب:\عددی{\pf=0.874}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{طاقت_صنعتی_ب}
شکل \حوالہ{شکل_طاقت_صنعتی_بوجھ} میں صنعتی بوجھ کو \عددی{\SI{80}{\kilo\watt}} طاقت مہیا کیا گیا ہے۔ ایمپیئر پیما \عددی{\SI{220}{\ampere}\,\rms} ناپتا ہے  جبکہ بوجھ کا امالی جزو طاقت \عددی{0.92} ہے۔مؤثر دباؤ حاصل کریں۔

جواب: \عددی{\SI{395}{\volt}\,\rms}
\انتہا{سوال}
%=====================
\ابتدا{سوال}\شناخت{طاقت_صنعتی_پ}
شکل \حوالہ{شکل_طاقت_صنعتی_بوجھ} میں صنعتی بوجھ کو \عددی{\pf=0.84} امالی پر  \عددی{\SI{60}{\kilo\watt}} طاقت مہیا کیا گیا ہے جبکہ منبع کا طاقت \عددی{\SI{64}{\kilo\watt}} ہے۔تار کی رکاوٹ \عددی{\bZ_{\text{تار}}=\SI{0.12}{\ohm}} ہے۔ ایمپیئر پیما اور وولٹ پیما کیا پڑھتے ہیں۔

جواب:\عددی{\SI{199.2}{\ampere}\,\rms}، \عددی{\SI{358.57}{\volt}\,\rms}
\انتہا{سوال}
%=====================
\ابتدا{سوال}\شناخت{طاقت_صنعتی_ت}
شکل \حوالہ{شکل_طاقت_صنعتی_بوجھ} میں صنعتی بوجھ کو \عددی{\pf=0.86} آگے جزو طاقت پر  \عددی{\SI{20}{\kilo\watt}} طاقت مہیا کیا گیا ہے۔بوجھ
 پر دباؤ \عددی{240\phase{0^{\circ}}\,\si{\volt}\,\rms} ہے۔تار کی رکاوٹ \عددی{\bZ_{\text{تار}}=0.1+j0.15\,\si{\ohm}} ہے۔ منبع کا جزو طاقت اور مخلوط طاقت دریافت کریں۔

جواب:جزو طاقت آگے \عددی{\pf=0.89} ہے اور منبع کا مخلوط طاقت \عددی{\bS=23.4\phase{-26.5^{\circ}}\,\si{\kilo\volt\ampere}} ہے۔
\انتہا{سوال}
%=====================
\ابتدا{سوال}\شناخت{طاقت_صنعتی_ٹ}
شکل \حوالہ{شکل_طاقت_صنعتی_ٹ} میں منبع کا جزو طاقت اور مخلوط طاقت دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$\bV_m$}]++(0,\y) to [european resistor,l={${0.02+j0.2\,\si{\ohm}}$}]++(2*\x,0) 
to [european resistor,l={$\substack{\displaystyle \SI{20}{\kilo\volt\ampere}\hfill  \\ \displaystyle \pf=0.7 \\ \displaystyle \text{پیچھے}} \hfill$}, v={$280\phase{0^{\circ}}\,\si{\volt}\,\rms$}]++(0,-\y) to [short] (0,0);
\draw(2*\x,\y) to [short,*-]++(\x+\x/2,0) to [european resistor,l={$\substack{\displaystyle \SI{15}{\kilo\volt\ampere}\hfill  \\ \displaystyle \pf=0.96 \\ \displaystyle \text{آگے}} \hfill$}]++(0,-\y) to [short,-*] ++(-\x-\x/2,0);
\end{tikzpicture}
\caption{شکل \حوالہ{طاقت_صنعتی_ٹ} کا دور۔}
\label{شکل_طاقت_صنعتی_ٹ}
\end{figure}

جوابات:جزو طاقت \عددی{0.891} پیچھے ہے۔مخلوط طاقت \عددی{\bS=37964\phase{26.97^{\circ}}\,\si{\volt\ampere}} ہے۔
\انتہا{سوال}
%========================
\ابتدا{سوال}\شناخت{طاقت_صنعتی_ث}
شکل \حوالہ{شکل_طاقت_صنعتی_ث} میں کرخوف کے قوانین سے دباؤ منبع \عددی{\bV_m} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$\bV_m$}]++(0,\y) to [european resistor,l={${0.08+j0.22\,\si{\ohm}}$}]++(2*\x,0) 
to [european resistor,l={$\substack{\displaystyle \SI{42}{\kilo\volt\ampere}\hfill  \\ \displaystyle \pf=0.82 \\ \displaystyle \text{پیچھے}} \hfill$}, v={$240\phase{0^{\circ}}\,\si{\volt}\,\rms$}]++(0,-\y) to [short] (0,0);
\draw(2*\x,\y) to [short,*-]++(\x+\x/2,0) to [european resistor,l={$\substack{\displaystyle \SI{36}{\kilo\watt}\hfill  \\ \displaystyle \pf=0.75 \\ \displaystyle \text{آگے}} \hfill$}]++(0,-\y) to [short,-*] ++(-\x-\x/2,0);
\end{tikzpicture}
\caption{شکل \حوالہ{طاقت_صنعتی_ث} کا دور۔}
\label{شکل_طاقت_صنعتی_ث}
\end{figure}

جوابات: \عددی{\bV_m=273.5\phase{15.33^{\circ}}\,\si{\volt}\,\rms}
\انتہا{سوال}
%========================
\ابتدا{سوال}\شناخت{طاقت_صنعتی_ج}
شکل \حوالہ{شکل_طاقت_صنعتی_ج} میں منبع کا جزو طاقت اور مخلوط طاقت دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$\bV_m$}]++(0,\y) to [european resistor,l={${0.08+j0.22\,\si{\ohm}}$}]++(2*\x,0) 
to [european resistor,l_={$\substack{\displaystyle \SI{22}{\kilo\volt\ampere}\hfill  \\ \displaystyle \pf=0.88 \\ \displaystyle \text{پیچھے}} \hfill$}]++(0,-\y) to [short] (0,0);
\draw(2*\x,\y) to [european resistor,*-,l={$0.04+j0.1\,\si{\ohm}$}]++(2*\x,0) to [european resistor,l={$\substack{\displaystyle \SI{30}{\kilo\watt}\hfill  \\ \displaystyle \pf=0.91 \\ \displaystyle \text{آگے}} \hfill$}, v={$260\phase{0^{\circ}}\,\si{\volt}\,\rms$}]++(0,-\y) to [short,-*] ++(-2*\x,0);
\end{tikzpicture}
\caption{شکل \حوالہ{طاقت_صنعتی_ج} کا دور۔}
\label{شکل_طاقت_صنعتی_ج}
\end{figure}

جوابات: \عددی{\pf=0.988} امالی، \عددی{\bS=52.26\phase{8.95^{\circ}}\,\si{\kilo\volt\ampere}}
\انتہا{سوال}
%========================
\ابتدا{سوال}\شناخت{طاقت_صنعتی_چ}
شکل \حوالہ{شکل_طاقت_صنعتی_چ} میں منبع کا دباؤ دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$\bV_m$}]++(0,\y) to [european resistor,l={${0.06+j0.18\,\si{\ohm}}$}]++(2*\x,0) 
to [european resistor,l_={$\substack{\displaystyle \SI{25}{\kilo\watt}\hfill  \\ \displaystyle \pf=0.9 \\ \displaystyle \text{پیچھے}} \hfill$}]++(0,-\y) to [short] (0,0);
\draw(2*\x,\y) to [european resistor,*-,l={$0.01+j0.04\,\si{\ohm}$}]++(2*\x,0) to [european resistor,l={$\substack{\displaystyle \SI{15}{\kilo\watt}\hfill  \\ \displaystyle \pf=0.85 \\ \displaystyle \text{پیچھے}} \hfill$}, v={$220\phase{0^{\circ}}\,\si{\volt}\,\rms$}]++(0,-\y) to [short,-*] ++(-2*\x,0);
\end{tikzpicture}
\caption{شکل \حوالہ{طاقت_صنعتی_چ} کا دور۔}
\label{شکل_طاقت_صنعتی_چ}
\end{figure}

جوابات: \عددی{\bV_m=252.4\phase{6.56^{\circ}}\,\si{\volt}\,\rms}
\انتہا{سوال}
%========================
\ابتدا{سوال}
ایک صنعتی بوجھ کو \عددی{\SI{50}{\hertz}} اور \عددی{\SI{260}{\volt}\,\rms} کے منبع سے طاقت مہیا کیا جاتا ہے۔بوجھ کا جزو طاقت \عددی{0.8} امالی اور طاقت \عددی{\SI{40}{\kilo\watt}} ہے۔ بوجھ کے متوازی کتنا برق گیر نصب کرنے سے جزو طاقت \عددی{0.9} امالی کیا جا سکتا ہے۔

جواب:\عددی{C=\SI{500}{\micro\farad}}
\انتہا{سوال}
%========================
\ابتدا{سوال}
ایک صنعتی بوجھ کو \عددی{\SI{50}{\hertz}} اور \عددی{\SI{200}{\volt}\,\rms} کے منبع سے طاقت مہیا کیا جاتا ہے۔بوجھ کا جزو طاقت \عددی{0.8} امالی اور طاقت \عددی{\SI{40}{\kilo\watt}} ہے۔ بوجھ کے متوازی کتنا برق گیر نصب کرنے سے جزو طاقت \عددی{0.9} امالی کیا جا سکتا ہے۔

جواب:\عددی{C=\SI{846}{\micro\farad}}
\انتہا{سوال}
%========================
\ابتدا{سوال}
ایک صنعتی بوجھ کو \عددی{\SI{50}{\hertz}} اور \عددی{\SI{480}{\volt}\,\rms} کے منبع سے طاقت مہیا کیا جاتا ہے۔بوجھ کا جزو طاقت \عددی{0.7} امالی اور طاقت \عددی{\SI{66}{\kilo\watt}} ہے۔ بوجھ کے متوازی کتنا برق گیر نصب کرنے سے جزو طاقت \عددی{0.92} امالی کیا جا سکتا ہے۔

جواب:\عددی{C=\SI{542}{\micro\farad}}
\انتہا{سوال}
%========================
\ابتدا{سوال}\شناخت{سوال_طاقت_مساوی_الف}
شکل \حوالہ{شکل_سوال_طاقت_مساوی_الف}-الف امالی بوجھ کا مساوی دور \عددی{2+j2\,\si{\ohm}} دکھایا گیا ہے جس کو \عددی{\SI{50}{\hertz}} کے منبع سے طاقت فراہم کی گئی ہے۔بوجھ کے متوازی کتنا برق گیر نصب کرنے سے منبع کو \عددی{0.94} امالی جزو طاقت نظر آئے گا؟
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$220\phase{0^{\circ}}\,\si{\volt}\,\rms$}]++(0,2*\y) to [short]++(\x,0) to [resistor,l={$\SI{2}{\ohm}$}]++(0,-\y) to [inductor,l={$j2\,\si{\ohm}$}]++(0,-\y) to [short](0,0);
\end{tikzpicture}
\caption*{(الف)}
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$240\phase{0^{\circ}}\,\si{\volt}\,\rms$}]++(0,2*\y) to [european resistor,l={$0.1+j0.2\,\si{\ohm}$}]++(\x,0) to [resistor,l={$\SI{2}{\ohm}$}]++(0,-\y) to [inductor,l={$j2\,\si{\ohm}$}]++(0,-\y) to [short](0,0);
\end{tikzpicture}
\caption*{(ب)}
\end{subfigure}%
\caption{سوال \حوالہ{سوال_طاقت_مساوی_الف} اور سوال \حوالہ{سوال_طاقت_مساوی_ب} کے ادوار۔}
\label{شکل_سوال_طاقت_مساوی_الف}
\end{figure}

جواب:\عددی{\SI{507}{\micro\farad}}
\انتہا{سوال}
%==========================
\ابتدا{سوال}\شناخت{سوال_طاقت_مساوی_ب}
شکل \حوالہ{شکل_سوال_طاقت_مساوی_الف}-ب امالی بوجھ کا مساوی دور \عددی{2+j2\,\si{\ohm}} دکھایا گیا ہے جس کو \عددی{\SI{50}{\hertz}} کے منبع سے طاقت فراہم کی گئی ہے۔بوجھ کے متوازی کتنا برق گیر نصب کرنے سے  بوجھ اور برق گیر کا کُل جزو طاقت \عددی{0.94} امالی ہو گا؟

جواب:\عددی{\SI{438}{\micro\farad}}
\انتہا{سوال}
%========================
