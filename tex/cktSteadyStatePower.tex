...
کوئی بھی صنعت حقیقی طاقت \عددی{P} استعمال کرتے ہوئے کام سرانجام دیتی ہے۔کوئی بھی صنعت قائم کرنے سے پہلے اس کی پیدا وار طے کی جاتی ہے۔اس پیدا وار کو حاصل کرنے کے لیے درکار مشین نسب کیے جاتے ہیں۔غیر ضروری طور پر \عددی{P} بڑھانے سے مراد، ضرورت سے زیادہ بڑی مشینیں نسب کرنا ہے، جس سے صنعت قائم کرنے کا خرچہ بڑھتا ہے۔جزو طاقت بہتر کرنے کا یہ انتہائی مہنگا طریقہ ہو گا جسے کبھی بھی نہیں اپنایا جاتا۔ساتھ ہی ساتھ زیادہ پیداوار کے لیے زیادہ سرمایہ درکار ہو گا۔
...
\end{align*}
اس طرح \عددی{\SI{50}{\kilo\var}} سکت کے برق گیر استعمال کرتے ہوئے \عددی{\tfrac{\SI{539}{\kilo\var}}{\SI{50}{\kilo\var}}=10.78} عدد برق گیر درکار ہوں گے۔جزو طاقت بہتر بنانے والے برق گیر مختلف اکایوں میں دستیاب ہیں۔یوں \عددی{\SI{50}{\kilo\var}} کے اکائی میں دستیاب گیارہ عدد برق گیر نسب کیے جائیں گے۔
...
%========================
\ابتدا{سوال}
ایک صنعتی بوجھ کو \عددی{\SI{50}{\hertz}} اور \عددی{\SI{260}{\volt}\,\rms} کے منبع سے طاقت مہیا کیا جاتا ہے۔بوجھ کا جزو طاقت \عددی{0.8} امالی اور طاقت \عددی{\SI{40}{\kilo\watt}} ہے۔ بوجھ کے متوازی کتنا برق گیر نسب کرنے سے جزو طاقت \عددی{0.9} امالی کیا جا سکتا ہے۔

جواب:\عددی{C=\SI{500}{\micro\farad}}
\انتہا{سوال}
%========================
\ابتدا{سوال}
ایک صنعتی بوجھ کو \عددی{\SI{50}{\hertz}} اور \عددی{\SI{200}{\volt}\,\rms} کے منبع سے طاقت مہیا کیا جاتا ہے۔بوجھ کا جزو طاقت \عددی{0.8} امالی اور طاقت \عددی{\SI{40}{\kilo\watt}} ہے۔ بوجھ کے متوازی کتنا برق گیر نسب کرنے سے جزو طاقت \عددی{0.9} امالی کیا جا سکتا ہے۔

جواب:\عددی{C=\SI{846}{\micro\farad}}
\انتہا{سوال}
%========================
\ابتدا{سوال}
ایک صنعتی بوجھ کو \عددی{\SI{50}{\hertz}} اور \عددی{\SI{480}{\volt}\,\rms} کے منبع سے طاقت مہیا کیا جاتا ہے۔بوجھ کا جزو طاقت \عددی{0.7} امالی اور طاقت \عددی{\SI{66}{\kilo\watt}} ہے۔ بوجھ کے متوازی کتنا برق گیر نسب کرنے سے جزو طاقت \عددی{0.92} امالی کیا جا سکتا ہے۔

جواب:\عددی{C=\SI{542}{\micro\farad}}
\انتہا{سوال}
%========================
\ابتدا{سوال}\شناخت{سوال_طاقت_مساوی_الف}
شکل \حوالہ{شکل_سوال_طاقت_مساوی_الف}-الف امالی بوجھ کا مساوی دور \عددی{2+j2\,\si{\ohm}} دکھایا گیا ہے جس کو \عددی{\SI{50}{\hertz}} کے منبع سے طاقت فراہم کی گئی ہے۔بوجھ کے متوازی کتنا برق گیر نسب کرنے سے منبع کو \عددی{0.94} امالی جزو طاقت نظر آئے گا؟
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
شکل \حوالہ{شکل_سوال_طاقت_مساوی_الف}-ب امالی بوجھ کا مساوی دور \عددی{2+j2\,\si{\ohm}} دکھایا گیا ہے جس کو \عددی{\SI{50}{\hertz}} کے منبع سے طاقت فراہم کی گئی ہے۔بوجھ کے متوازی کتنا برق گیر نسب کرنے سے  بوجھ اور برق گیر کا کل جزو طاقت \عددی{0.94} امالی ہو گا؟
