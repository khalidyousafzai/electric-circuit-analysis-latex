...
\end{align}
ملتا ہے جہاں \عددی{\alpha=\omega t +\theta_v} اور \عددی{\beta=\omega t+\theta_i} لئے گئے ہیں۔آپ دیکھ سکتے ہیں کہ لمحاتی طاقت دو اجزاء کا مجموعہ ہے۔پہلا جزو مستقل طاقت ہے جو وقت کے ساتھ تبدیل نہیں ہوتا جبکہ دوسرا جزو دگنی تعدد کا بدلتا رو طاقت ہے۔  
%
\begin{figure}
\centering
\begin{tikzpicture}
...
%===========================
\حصہ{مخلوط طاقت}
برقرار حال بدلتا رو طاقت پر غور کرنے کے لئے \اصطلاح{مخلوط طاقت}\فرہنگ{مخلوط طاقت}\فرہنگ{طاقت!مخلوط}\حاشیہب{complex power}\فرہنگ{complex power}\فرہنگ{power!complex} کا جاننا ضروری ہے لہٰذا اس حصے میں مخلوط طاقت پر بحث کی جائے گی۔   
\begin{figure}
\centering
\begin{tikzpicture}
...
\end{align}
جہاں مساوات \حوالہ{مساوات_طاقت_مقدار_مساوی_مخلوط_اور_جوڑی_دور_ضرب} اور مساوات \حوالہ{مساوات_طاقت_مخلوط_طاقت_مساوی_حقیقی_متعاملی} کا سہارا لیا گیا ہے۔اسی طرح مساوات \حوالہ{مساوات_طاقت_مخلوط_طاقت_الف} میں دباو کے بجائے رو کے لئے پر کرتے ہوئے درج ذیل لکھا جا سکتا ہے۔
\begin{align}
...
کوئی بھی صنعت حقیقی طاقت \عددی{P} استعمال کرتے ہوئے کام سرانجام دیتی ہے۔کوئی بھی صنعت قائم کرنے سے پہلے اس کی پیدا وار طے کی جاتی ہے۔اس پیدا وار کو حاصل کرنے کے لئے درکار مشین نسب کیے جاتے ہیں۔غیر ضروری طور پر \عددی{P} بڑھانے سے مراد، ضرورت سے زیادہ بڑی مشینیں نسب کرنا ہے، جس سے صنعت قائم کرنے کا خرچہ بڑھتا ہے۔جزو طاقت بہتر کرنے کا یہ انتہائی مہنگا طریقہ ہو گا جسے کبھی بھی نہیں اپنایا جاتا۔ساتھ ہی ساتھ زیادہ پیداوار کے لئے زیادہ سرمایہ درکار ہو گا۔
...
\end{align}
کسی بھی جزو طاقت کے حصول کے لئے  \عددی{\bS_C} کو شکل \حوالہ{شکل_طاقت_درستگی_جزو_طاقت_صنعتی_بہتر}-ت سے حاصل کا جا سکتا ہے جسے استعمال کرتے ہوئے درج بالا مساوات سے درکار \عددی{C} حاصل کیا جا سکتا ہے۔ جزو طاقت قابو کرنے کے لئے برق گیر کی سکت عموماً متعاملی وولٹ ایمپیئر \عددی{\si{\var}} میں ہی بیان کی جاتی ہے۔یوں \عددی{\SI{50}{\hertz}}، \عددی{\SI{440}{\volt}\,\rms} پر استعمال ہونے  والے \عددی{\SI{822}{\micro\farad}} برق گیر کو \عددی{\SI{50}{\kilo\var}} کا برق گیر کہا جائے گا۔
