...
ایک صنعت کو \عددی{560 \, \si{\volt} \, \rms} پر \عددی{\SI{100}{\kilo\watt}} طاقت مہیا کیا جاتا ہے۔صنعتی بوجھ کا جزو طاقت \عددی{0.68} امالی ہے۔برقی طاقت کو منبع سے بوجھ تک \اصطلاح{ترسیلی تاروں}\فرہنگ{ترسیلی تار}\حاشیہب{transmission lines}\فرہنگ{transmission lines}\حاشیہب{پاکستان میں بجلی کے کھمبوں پر ترسیلی تار آپ نے ضرور دیکھے ہوں گے۔ڈیم میں موجود بجلی گھر سے صارف تک طاقت انہیں ترسیلی تاروں کے ذریعہ پہنچتا ہے۔} کے ذریعہ پہنچایا جاتا ہے۔ترسیلی تاروں مزاحمت \عددی{\SI{0.06}{\ohm}} ہے۔ترسیلی تاروں میں طاقت کا ضیاع دریافت کریں۔منبع طاقت کتنا طاقت پیدا کرے گا۔اگر صنعتی بوجھ کا جزو طاقت \عددی{0.95} امالی کر دیا جائے تب جوابات کیا ہوں گے۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
...
حصہ \حوالہ{حصہ_طاقت_جزو_طاقت_پر_قابو} میں جزو طاقت پر قابو پانے کی ترکیب بتلائی جائے گی۔
%============================
\ابتدا{مشق}
...
آپ نے مثال \حوالہ{مثال_طاقت_جزو_طاقت_کی_اہمیت} میں دیکھا کہ جزو طاقت نہایت اہم معلومات فراہم کرتا ہے۔
