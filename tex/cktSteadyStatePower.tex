...
\end{align}
طاقت منتقل ہو گا۔ہم یہ بھی جانتے ہیں کہ \عددی{I_\text{موثر}} یک سمت رو اسی مزاحمت کو درج ذیل طاقت منتقل کرتی ہے۔
\begin{align}
P=I^2_\text{موثر} R
\end{align}
...
موثر دباو کو بھی اسی طرح حاصل کیا جا سکتا ہے۔مزاحمت \عددی{R} کے متوازی دباو \عددی{v(t)} نصب کرنے سے مزاحمت کو لمحاتی طور پر \عددی{\tfrac{v^2(t)}{R}} طاقت منتقل ہو گا۔اگر دباو کا دوری عرصہ \عددی{T} ہو تب مزاحمت کو اوسطاً 
\begin{align}
P=\frac{1}{T}\int_{t_0}^{t_0+T} \frac{v^2(t)}{R} \dif t
\end{align}
طاقت منتقل ہو گا۔اسی مزاحمت کو یک سمت دباو \عددی{V_{\text{موثر}}} اوسطاً درج ذیل طاقت فراہم کرتا ہے۔
\begin{align}
...
%====================
\ابتدا{مثال}
بدلتا رو \عددی{i(t)=I_0\cos (\omega t+\theta)} کی موثر قیمت \عددی{\Irms} دریافت کریں۔
...
\Vrms&=\SI{230}{\volt}
\end{align*}
بدلتا رو مشینوں کے دباو اور رو کی عموماً موثر قیمتیں بیان کی جاتی ہیں۔یوں \عددی{\SI{230}{\volt}} پر چلنے والا گھریلو پنکھا درحقیقت \عددی{\SI{230}{\volt}} کے موثر دباو پر چلے گا۔اس کتاب میں موثر قیمتیں استعمال کرتے ہوئے دباو اور رو کے ساتھ موثر یا \عددی{\textup{rms}} لکھا جائے گا۔
...
&=V_{\textup{p}}
\end{align*}
یوں دی گئی تینوں فعال عرصوں  کے لیے  موثر دباو \عددی{\SI{10}{\volt}} حاصل ہوتا ہے۔
...
شکل \حوالہ{شکل_سوال_طاقت_موثر_الف}-الف میں دیے دباو کی موثر قیمت دریافت کریں۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
شکل \حوالہ{شکل_سوال_طاقت_موثر_الف}-ب میں دیے رو کی موثر قیمت دریافت کریں۔

جواب:\عددی{\Irms=\sqrt{20}\,\si{\ampere}}
\انتہا{سوال}
%======================
\ابتدا{سوال}\شناخت{سوال_طاقت_موثر_پ}
شکل \حوالہ{شکل_سوال_طاقت_موثر_پ}-الف میں دیے دباو کی موثر قیمت دریافت کریں۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
%=========================
\ابتدا{سوال}
دباو \عددی{v(t)=15+10\cos(\omega t+30^{\circ})\,\si{\volt}} کی موثر قیمت دریافت کریں۔

جواب:\عددی{\Vrms=\SI{13.398}{\volt}}
\انتہا{سوال}
%==============================
\ابتدا{سوال}\شناخت{طاقت_صنعتی_الف}
شکل \حوالہ{شکل_طاقت_صنعتی_بوجھ} میں صنعتی بوجھ کو طاقت مہیا کیا گیا ہے۔ ایمپیئر پیما موثر \عددی{\SI{130}{\ampere}} اور وولٹ پیما موثر \عددی{\SI{440}{\volt}} ناپتے ہیں جبکہ بوجھ کو \عددی{\SI{50}{\kilo\watt}} فراہم کیا جا رہے ہے۔صنعتی بوجھ کا امالی جزو طاقت دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
...
شکل \حوالہ{شکل_طاقت_صنعتی_بوجھ} میں صنعتی بوجھ کو \عددی{\SI{80}{\kilo\watt}} طاقت مہیا کیا گیا ہے۔ ایمپیئر پیما \عددی{\SI{220}{\ampere}\,\rms} ناپتا ہے  جبکہ بوجھ کا امالی جزو طاقت \عددی{0.92} ہے۔موثر دباو حاصل کریں۔
...
شکل \حوالہ{شکل_سوال_طاقت_مساوی_الف}-ب امالی بوجھ کا مساوی دور \عددی{2+j2\,\si{\ohm}} دکھایا گیا ہے جس کو \عددی{\SI{50}{\hertz}} کے منبع سے طاقت فراہم کی گئی ہے۔بوجھ کے متوازی کتنا برق گیر نصب کرنے سے  بوجھ اور برق گیر کا کل جزو طاقت \عددی{0.94} امالی ہو گا؟
