...
&=12\phase{76.87^{\circ}}
\end{align*}
\عددی{\hat{V}_m} اور \عددی{\hat{I}} کو شکل \حوالہ{شکل_بدلتا_رو_بالمقابل_دباو} میں دکھایا گیا ہے جہاں حیطوں کو درست تناسب سے نہیں دکھایا گیا ہے۔
...
\begin{align*}
\bZ_L&=1581\times 0.004 \phase{90^{\circ}}=6.32\phase{90^{\circ}} \, \si{\ohm}\\
\bZ_C&=\frac{1}{1581\times 100\times 10^{-6}}\phase{-90^{\circ}}=6.32\phase{-90^{\circ}}\,\si{\ohm}
\end{align*}
حاصل ہوتے ہیں۔
\begin{figure}
\centering
