...
شکل \حوالہ{شکل_بدلتا_مزاحمت_امالہ_جبری_حل_الف} میں حقیقی جبری تفاعل \عددی{V_0\cos \omega t} کی جگہ مخلوط جبری تفاعل نسب کرتے ہوئے حقیقی \عددی{i(t)} کے لیے حل کریں۔
...
حل:تھونن دباو دریافت کرنے کی خاطر بوجھ کو کھلا دور کرنے سے شکل-ب حاصل ہوتا ہے جہاں متوازی جڑے منبع رو اور رکاوٹ \عددی{2-j2 \,\si{\ohm}} کا متبادل تھونن دور نسب کیا گیا ہے۔دور میں رو \عددی{\hat{I}} تصور کرتے ہوئے درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
...
حل:نارٹن رو دریافت کرنے کی خاطر  بوجھ کو قصر دور کرنے سے شکل \حوالہ{شکل_بدلتا_تراکیب_ج}-الف حاصل ہوتا ہے جہاں نارٹن رو کی نشاندہی کی گئی ہے۔آپ دیکھ سکتے ہیں کہ قصر دور کے دائیں جانب پرزوں میں صفر رو گزرے گی لہٰذا انہیں دور سے ہٹایا جا سکتا ہے۔ایسا ہی کرتے ہوئے اور ساتھ ہی ساتھ متوازی جڑے منبع رو \عددی{2-j2\,\si{\ohm}} رکاوٹ کی جگہ متبادل منبع نسب کرتے ہوئے شکل-ب حاصل ہوتا ہے۔ شکل-ب سے درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
\hat{I}_{\text{نارٹن}}&=\frac{(2-j2)(5\phase{0^{\circ}})}{2-j2}\\
&=3.535\phase{-45^{\circ}} \, \si{\ampere}
\end{align*}
گزشتہ مثال میں ہم تھونن رکاوٹ \عددی{\bZ_{\text{تھونن}}=2.471-j0.118\,\si{\ohm}} حاصل کر چکے ہیں۔شکل-پ میں بوجھ کے ساتھ نارٹن مساوی دور نسب کیا گیا ہے جہاں سے تقسیم رو کے کلیے سے  \عددی{\hat{I}_0} درج ذیل لکھی جا سکتی ہے۔ 
\begin{align*}
...
حل:یہاں منبع دباو کی تعدد مختلف ہے لہٰذا دوری سمتیات استعمال کرتے ہوئے کون سی تعدد استعمال کی جائے گی؟ اس دور کو مسئلہ خطی میل سے حل کیا جا سکتا ہے۔یوں باری باری ایک ایک منبع نسب کرتے ہوئے وقتی دائرہ کار میں جوابات حاصل کیے جائیں گے۔تمام جوابات کا مجموعہ درکار جواب ہو گا۔
