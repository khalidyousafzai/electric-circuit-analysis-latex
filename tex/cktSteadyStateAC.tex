...
حل:مسئلہ خطی میل میں تمام منبع کے انفرادی اثرات کا مجموعہ لیا جاتا ہے۔شکل \حوالہ{شکل_بدلتا_تراکیب_ب} میں منبع دباو کو قصر دور کرتے ہوئے  شکل \حوالہ{شکل_بدلتا_تراکیب_پ} حاصل ہوتا ہے۔منبع رو کے متوازی کل رکاوٹ \عددی{ \bZ_1} حاصل کرتے ہیں۔شکل کو دیکھتے ہوئے درج ذیل لکھا جا سکتا ہے
\begin{align*}
