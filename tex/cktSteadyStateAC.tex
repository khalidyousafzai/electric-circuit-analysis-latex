...
بدلتا رو ادوار میں برقی رکاوٹ \عددی{\bZ} کے علاوہ \اصطلاح{برقی فراوانی}\فرہنگ{فراوانی}\حاشیہب{admittance}\فرہنگ{admittance} \عددی{\bY} بھی نہایت اہم ثابت ہوتی ہے۔رکاوٹ کے بالعکس متناسب کو فراوانی کہتے ہیں۔
\begin{align}
\bY=\frac{1}{\bZ}
\end{align}
