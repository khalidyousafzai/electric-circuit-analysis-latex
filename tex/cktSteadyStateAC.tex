...
مخلوط عدد کو \عددی{x+jy} یا \عددی{r\phase{\theta}} لکھا جا سکتا ہے جہاں مستطیلی طرز سے زاویائی طرز درج ذیل طریقے سے حاصل کی جاتی ہے
\begin{align}\label{مساوات_بدلتا_مستطیل_سے_زاویائی}
r&=\sqrt{x^2+y^2}\\
\theta&=\tan^{-1}\frac{y}{x}
\end{align}
...
\begin{align}
r\phase{\theta}=r e^{j\theta}=r\cos \theta+j r \sin \theta
\end{align}
%======================
\حصہ{سائن نما تفاعل}
...
v_M=V_0 e^{j \omega t}
\end{align}
مسلط کرنے سے دور میں تمام رو کی صورت \عددی{i_M(t)=I_0e^{j(\omega t+\phi)}} اور دباو کی صورت \عددی{v_M(t)=V_0e^{j(\omega t+\phi)}} ہو گی جہاں تمام رو اور دباو  کی تعدد \عددی{\omega} جبکہ ان کے انفرادی  حیطے \عددی{I_0} یا \عددی{V_0} اور زاویہ ہٹاو \عددی{\phi} مختلف ہوں گے۔یہاں حیطے حقیقی مقدار ہیں۔

یوں تعدد جانتے ہوئے کسی بھی مخلوط تفاعل مثلاً مخلوط رو کو اس کے حیطے \عددی{I_0} اور زاویائی ہٹاو \عددی{\phi} سے مکمل طور پر ظاہر کیا جا سکتا ہے۔یوں مخلوط رو 
\begin{align}
...
\end{align}
لکھی جائے گی جہاں \عددی{I_0} حقیقی مقدار ہے۔مساوات \حوالہ{مساوات_بدلتا_حقیقی_رو_الف} حقیقی رو دیتی ہے۔اس طرز کے تمام مساوات میں \عددی{e^{j\omega t}} پایا جاتا ہے اور مساوات کا حقیقی جزو ہی حقیقی مقدار ہوتی ہے۔اس مساوات میں تعدد \عددی{\omega} کو ذہن نشین کرتے ہوئے زیر نوشت میں لفظ "حقیقی" اور جزو \عددی{e^{j\omega t}} نہ لکھنے سے  \اصطلاح{دوری سمتی طرز}\فرہنگ{دوری سمتی طرز}\حاشیہب{phasor notation}\فرہنگ{phasor notation} حاصل ہوتی ہے۔ یوں مساوات \حوالہ{مساوات_بدلتا_حقیقی_رو_الف} میں دی گئی حقیقی رو کی دوری سمتی صورت درج ذیل ہو گی
\begin{align}\label{مساوات_بدلتا_حقیقی_رو_پ}
\hat{I}=I_0 e^{j\phi}
\end{align}
دوری سمتیہ کو بڑے حروف سے ظاہر کرتے ہوئے  اس پر ٹوپی کا نشان بنایا گیا ہے۔ یوں دوری سمتی رو کو \عددی{\hat{I}} اور دوری سمتی دباو کو \عددی{\hat{V}} سے ظاہر کیا جائے گا۔درج بالا کو درج ذیل دوری سمتیہ کی صورت میں بھی لکھا جاتا ہے۔
\begin{align}\label{مساوات_بدلتا_حقیقی_رو_ت}
\hat{I}=I_0 \phase{\phi}
\end{align}
دوری سمتی تفاعل کا حیطہ حقیقی اور مثبت مقدار ہوتا ہے۔یوں درج بالا مساوات میں \عددی{I_0} حقیقی مثبت مقدار ہے۔روایتی طور پر دوری سمتیہ کو \عددی{\cos} جزو سے حاصل کیا جاتا ہے۔

مساوات \حوالہ{مساوات_بدلتا_حقیقی_رو_ب} طرز کے تفاعل کو تفاعل کی \اصطلاح{وقتی صورت}\فرہنگ{وقتی صورت}\حاشیہب{time domain form}\فرہنگ{time domain form} کہتے ہیں جبکہ مساوات \حوالہ{مساوات_بدلتا_حقیقی_رو_پ} اور مساوات \حوالہ{مساوات_بدلتا_حقیقی_رو_ت} کو تفاعل کی \اصطلاح{تعددی صورت}\فرہنگ{تعددی صورت}\حاشیہب{frequency domain form}\فرہنگ{frequency domain form} کہتے ہیں۔
...
دوری سمتیہ حقیقت میں مخلوط عدد ہے۔یوں کسی بھی مخلوط عدد کی طرح اس کو بھی مخلوط سطح پر ظاہر کیا جا سکتا ہے۔شکل \حوالہ{شکل_بدلتا_دوری_سمتیات} میں 
\عددی{\hat{I}=25\phase{20^{\circ}}} اور \عددی{\hat{V}=30 e^{j55^{\circ}}} کھینچے گئے ہیں جہاں مرکز \عددی{(0,0)} سے مخلوط نقطے تک لکیر کے سر پر تیر کا نشان ڈالتے ہوئے انہیں سمتیہ کی شکل دی گئی ہے۔اسی لئے  \عددی{\hat{V}} یا \عددی{\hat{I}} کو دوری سمتیات کہتے ہیں۔شکل سے دوری سمتیات کا زاویائی تعلق بھی ظاہر ہوتا ہے۔شکل \حوالہ{شکل_بدلتا_دوری_سمتیات} میں دباو سے رو \عددی{33^{\circ}} درجے پیچھے ہے۔
\begin{figure}
\centering
\begin{tikzpicture}
...
مزاحمت \عددی{R} پر مخلوط دباو \عددی{v(t)=V_0e^{j(\omega t+\phi_v)}} مسلط کرنے سے  مزاحمت میں مخلوط رو \عددی{i(t)=I_0e^{j(\omega t+\phi_i)}} گزرے گی۔اوہم کے قانون کے تحت
\begin{align*}
...
\phi_v&=\phi_i
\end{align} 
اس طرح مزاحمت کی رو اور دباو ہم زاویہ ہیں۔شکل-الف میں مزاحمت کے \عددی{\hat{I}} اور \عددی{\hat{V}} دوری سمتیات دکھائے گئے ہیں جو تعددی تفاعل ہیں جبکہ شکل-ب میں مزاحمت کے \عددی{i(t)} اور \عددی{v(t)} دکھائے گئے ہیں جو وقتی تفاعل ہیں۔
