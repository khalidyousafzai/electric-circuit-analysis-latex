...
\حصہ{مخلوط اعداد}
\اصطلاح{حقیقی}\فرہنگ{حقیقی!عدد}\حاشیہب{real number}\فرہنگ{real!number} عدد اور \اصطلاح{خیالی}\فرہنگ{خیالی!عدد}\حاشیہب{imaginary number}\فرہنگ{imaginary!number} عدد کے مجموعے کو \اصطلاح{مخلوط}\فرہنگ{مخلوط!عدد}\حاشیہب{complex number}\فرہنگ{complex!number} عدد کہتے ہیں۔مخلوط اعداد کو \اصطلاح{مخلوط سطح}\فرہنگ{مخلوط سطح}\حاشیہب{complex plane}\فرہنگ{complex!plane} پر دکھایا جایا ہے۔مخلوط سطح پر افقی محور  حقیقی اعداد کو ظاہر کرتا ہے جبکہ انتصابی محور  خیالی اعداد کو ظاہر کرتا ہے۔
...
شکل \حوالہ{شکل_بدلتا_مخلوط_اعداد_لکھنا}-الف میں مخلوط نقطہ \عددی{(3+j2)} سے محددی نظام  کے مبدا \عددی{(0,0)} تک لکیر کھینچی گئی ہے۔اس لکیر کی لمبائی \عددی{r} کو مسئلہ فیثاغورث کی مدد سے
\begin{align*}
r=\sqrt{3^2+2^2}=\sqrt{13}
\end{align*}
لکھا جا سکتا ہے۔اسی طرح افقی محور سے لکیر تک کا زاویہ درج ذیل ہو گا۔
\begin{align*}
...
جہاں \عددی{A_0} موج کی چوٹی ہے جسے موج کا \اصطلاح{حیطہ}\فرہنگ{حیطہ}\حاشیہب{amplitude}\فرہنگ{amplitude} کہتے ہیں اور \عددی{\theta} کو تفاعل کا \اصطلاح{دلیل}\فرہنگ{دلیل}\حاشیہد{ایک ماہر ریاضی اپنی خیالی دنیا میں کوسائن \عددی{\cos \theta} تفاعل کے ساتھ بحث میں مصورف ہوتا ہے۔ماہر ریاضی تفاعل کو دلیل کے طور پر صفر پیش کرتا ہے۔تفاعل اس کا فوراً جواب اکائی \عددی{(\cos 0=1)} دیتا ہے۔}\حاشیہب{argument}\فرہنگ{argument} کہتے ہیں۔اس مساوات میں \عددی{\theta} از خود وقت\عددی{t} پر منحصر ہے۔
 ...
 گردش کرتا نقطہ ایک چکر میں \عددی{360^{\circ}} درجے کا زاویہ یعنی \عددی{2\pi} ریڈیئن طے کرتا ہے۔ایک چکر کاٹنے کے لیے درکار دورانیے کو \اصطلاح{دوری عرصہ}\فرہنگ{دوری عرصہ}\حاشیہب{time period}\فرہنگ{time period} کہتے ہیں جسے \عددی{T} سے ظاہر کیا جاتا ہے۔
%=========================
\ابتدا{مشق}
...
اگر ایک چکر کاٹنے کے لیے \عددی{T} سیکنڈ کا وقت درکار ہو تب ایک سیکنڈ میں چکروں کی تعداد  \عددی{\tfrac{1}{T}} ہو گی جسے \اصطلاح{تعدد}\فرہنگ{تعدد}\حاشیہب{frequency}\فرہنگ{frequency} کہتے اور \عددی{f} سے ظاہر کرتے ہیں۔
\begin{align}
f=\frac{1}{T}
\end{align}
...
\omega=2\pi f
\end{align}
زاویائی رفتار \عددی{\omega} سے گردش کرتا ہوا نقطہ \عددی{t} سیکنڈ میں \عددی{2\pi f t} ریڈیئن کا زاویہ طے کرے گا۔یوں اگر \عددی{t=0} پر نقطہ عین محور  \عددی{x} کے مثبت حصے پر ہو تب لمحہ \عددی{t} پر
\begin{align}
...
برقی میدان میں \عددی{y(t)} وقت کے ساتھ بدلتے دباؤ یا وقت کے ساتھ بدلتا رو کو ظاہر کر سکتی ہے۔مساوات \حوالہ{مساوات_بدلتا_سائن_نما_تفاعل_ب} میں دیے تفاعل، جسے شکل \حوالہ{شکل_بدلتی_رو_سائن_تفاعل}-ب میں دکھایا گیا ہے،  کا آزاد متغیرہ وقت \عددی{t} ہے۔آپ دیکھ سکتے ہیں کہ یہ تفاعل ہر \عددی{T} سیکنڈ کے بعد اپنے آپ کو دہراتا ہے۔ اس حقیقت کو ریاضی میں درج ذیل لکھا جاتا ہے۔
\begin{align}
y(t+T)=y( t)
\end{align}
...
حل: شکل \حوالہ{شکل_بدلتا_کوسائن_تفاعل_بالمقابل_ہٹاو}-الف میں \عددی{v(\omega t)=1\cos \omega t} کا خط دکھایا گیا ہے۔اس کو افقی محور پر \عددی{60^{\circ}} درجے  بائیں منتقل کرنے سے \عددی{v(\omega t)=1\cos(\omega t +60^{\circ})} کا خط حاصل ہوتا ہے جسے شکل-ب میں دکھایا گیا ہے۔ ہم درج ذیل لکھ سکتے ہیں
\begin{align*}
...
%==========================
\ابتدا{مثال}
درج ذیل امواج کی تعدد ہرٹز میں حاصل کریں۔ امواج کے مابین زاویائی فرق دریافت کریں۔یہ بھی بتلائیں کہ کون سی موج آگے ہے۔
\begin{align*}
...
\انتہا{مشق}
%=========================
\حصہ{سائن نما اور مخلوط جبری تفاعل}\شناخت{حصہ_برقرار_مخلوط_جبری_تفاعل}
گزشتہ باب میں دور پر مستقل جبری تفاعل مسلط  کرتے ہوئے، دور کا جبری ردعمل بھی مستقل قیمت کا حاصل ہوا۔تفرقی مساوات کا جبری ردعمل، مسلط جبری تفاعل اور اس کے تمام بلند رتبی تفرق کا مجموعہ ہوتا ہے۔یوں  دور پر جبری دباؤ \عددی{v(t)=\sin \omega t} مسلط کرنے سے رو کا جبری ردعمل \عددی{i(t)=c_1\sin\omega t+c_2\cos\omega t} متوقع ہو گا۔پس جبری ردعمل کے مستقل \عددی{c_1} اور \عددی{c_2} معلوم کرنا باقی ہے۔
%===============
...
\end{align*}
درج بالا مساوات میں دونوں اطراف \عددی{\cos \omega t} کے   ضریب  برابر ہوں گے۔اسی طرح دونوں اطراف \عددی{\sin \omega t} کے  ضریب  برابر ہوں گے۔
\begin{align*}
c_1 R+c_2 \omega L&=V_0\\
-c_1 \omega L+c_2 R&=0
\end{align*}
ان ہمزاد مساوات کو \عددی{c_1} اور \عددی{c_2} کے لیے حل کرتے ہوئے درج ذیل ملتا ہے
\begin{align*}
...
\end{align}
مساوات \حوالہ{مساوات_بدلتا_جبری_حل_ب} میں \عددی{\cos \omega t} اور \عددی{\sin \omega t} کے  ضریب  کو مساوات \حوالہ{مساوات_بدلتا_جبری_حل_پ} کے  ضریب  کے برابر پُر کرتے ہیں۔
\begin{align}
...
\end{align}
جہاں سے ظاہر ہے کہ دباؤ سے رو \عددی{26.6^{\circ}} درجے پیچھے ہے۔ مخلوط جبری حل درج ذیل لکھا جائے گا جس کا حقیقی جزو درج بالا مساوات ہے۔
...
مثال \حوالہ{مثال_بدلتا_مزاحمت_امالہ_جبری_حل_ب} کے طرز پر مثال \حوالہ{مثال_بدلتا_مزاحمت_امالہ_جبری_حل_الف} میں حاصل کیے گئے جبری حل کو \عددی{i_J(t)=I_0\cos(\omega t -\phi)} کی صورت میں لکھیں۔

حل:مساوات \حوالہ{مساوات_بدلتا_جبری_حل_الف} میں \عددی{\cos \omega t} اور \عددی{\sin \omega t} کے  ضریب  کو مساوات \حوالہ{مساوات_بدلتا_جبری_حل_پ} میں \عددی{\cos \omega t} اور \عددی{\sin \omega t} کے  ضریب  کے برابر پُر کرتے ہوئے درج ذیل ملتا ہے۔
\begin{align*}
...
مساوات \حوالہ{مساوات_بدلتا_جبری_حل_امالہ_مزاحمت} سے ظاہر ہے کہ \عددی{L=0} کی صورت میں \عددی{\phi=0} ہو گا لہٰذا دباؤ اور رو ہم زاویہ ہوں گے جبکہ \عددی{R=0} کی صورت میں \عددی{\phi=90^{\circ}} ہو گا لہٰذا دباؤ سے رو \عددی{90^{\circ}} درجے پیچھے ہو گی۔مزاحمت اور امالہ کے دیگر قیمتوں کی صورت میں دباؤ سے رو \عددی{0^{\circ}} تا \عددی{90^{\circ}} کے مابین کسی مخصوص  درجے پر پیچھے رہے گی۔اسی لیے مزاحمت اور امالہ کے ادوار کو پیچھے رہنے والے ادوار کہا جاتا ہے۔
...
شکل \حوالہ{شکل_بدلتا_مزاحمت_امالہ_جبری_حل_الف} میں حقیقی جبری تفاعل \عددی{V_0\cos \omega t} کی جگہ مخلوط جبری تفاعل نصب کرتے ہوئے حقیقی \عددی{i(t)} کے لیے حل کریں۔

حل:حقیقی جبری تفاعل \عددی{v(t)=V_0\cos \omega t} کی جگہ دور میں مخلوط جبری تفاعل \عددی{v(t)=V_0 e^{j\omega t}} نصب کرتے ہوئے کرخوف مساوات لکھتے ہیں۔
\begin{align*}
...
\end{align}
لکھا جا سکتا ہے جہاں \عددی{I_0} حقیقی مقدار ہے اور زیر نوشت میں لفظ \قول{حقیقی} لکھنے کا مطلب ہے کہ اس تفاعل کا حقیقی جزو لیا جائے یعنی
\begin{align}\label{مساوات_بدلتا_حقیقی_رو_ب}
i(t)&=I_0 \cos (\omega t+\phi)
\end{align}
مساوات \حوالہ{مساوات_بدلتا_حقیقی_رو_الف} حقیقی رو دیتی ہے۔اس طرز کے تمام مساوات میں \عددی{e^{j\omega t}} پایا جاتا ہے اور مساوات کا حقیقی جزو ہی حقیقی مقدار ہوتا ہے۔یوں ایسے مساوات میں لفظ \قول{حقیقی} اور \عددی{e^{j\omega t}} کو ذہن میں رکھتے ہوئے انہیں لکھنے سے گریز کیا جاتا ہے۔مساوات \حوالہ{مساوات_بدلتا_حقیقی_رو_الف} میں ایسا ہی کرتے ہوئے درج ذیل لکھا جائے گا
\begin{align}\label{مساوات_بدلتا_دوری_سمتیہ_الف}
\hat{I}=I_0e^{j\phi}
\end{align}
جہاں رو کو ٹوپی والے بڑے حرف سے ظاہر کیا گیا ہے۔دباؤ کی صورت میں تفاعل کو \عددی{\hat{V}} لکھا جاتا۔ٹوپی والے بڑے حرف سے ظاہر کردہ تفاعل کو \عددی{e^{j\omega t}} سے ضرب دے کر حقیقی جزو لینے سے حقیقی تفاعل حاصل کیا جاتا ہے۔

مساوات \حوالہ{مساوات_بدلتا_دوری_سمتیہ_الف} کا صفحہ \حوالہصفحہ{مساوات_بدلتا_مخلوط_عدد_طرز_لکھائی} پر مساوات \حوالہ{مساوات_بدلتا_مخلوط_عدد_طرز_لکھائی} سے موازنہ کریں۔ایسا معلوم ہوتا ہے جیسے  \عددی{\hat{I}} مخلوط عدد کو ظاہر کرتا ہے۔اگرچہ مساوات \حوالہ{مساوات_بدلتا_دوری_سمتیہ_الف} درحقیقت میں مساوات \حوالہ{مساوات_بدلتا_حقیقی_رو_الف} کو چھوٹا لکھنے کا طریقہ ہے لہٰذا \عددی{\hat{I}} مخلوط عدد کو ظاہر نہیں کرتا لیکن دیکھا یہ گیا ہے کہ \عددی{\hat{I}} کو مخلوط عدد تصور کر لینے سے ہمارے لیے آسانی پیدا ہوتی ہے۔آئیں \عددی{\hat{V}} کو مخلوط عدد فرض کرتے ہوئے اس کو مخلوط سطح پر ظاہر کریں۔
%=========================== 
\ابتدا{مثال}\شناخت{مثال_بدلتا_دوری_سمتیہ_مثال_الف}
مخلوط دباؤ \عددی{v_M(t)=50e^{j(100\pi t-35^{\circ})}}سے \عددی{\hat{V}} حاصل کرتے ہوئے \عددی{\hat{V}} کو مخلوط سطح پر دکھائیں۔

حل:مخلوط دباؤ سے حقیقی دباؤ لکھتے ہیں۔
\begin{align*}
v(t)=\left. 50e^{j(100\pi t-35^{\circ})} \right|_{\text{حقیقی}}
\end{align*}
اس مساوات کی تعدد \عددی{(\omega=100\pi)} کو ذہن نشین کرتے ہوئے لفظ \قول{حقیقی} اور \عددی{e^{j100\pi t}} لکھنے سے گریز کرتے ہوئے درج ذیل لکھا جائے گا
\begin{align*}
\hat{V}&=50e^{-j35^{\circ}}\\
&=50\phase{-35^{\circ}}
\end{align*}
جسے شکل \حوالہ{شکل_بدلتا_دوری_سمتیہ_مثال_الف} میں مخلوط سطح پر دکھایا گیا ہے۔حقیقی محور سے گھڑی کی گردش کی جانب مثبت زاویہ ناپا جاتا ہے لہٰذا منفی زاویے کو گھڑی کی گردش کے الٹ جانب دکھایا گیا ہے۔مخلوط اعداد اور \عددی{\hat{V}} میں فرق رکھنے کی خاطر \عددی{\hat{V}} کو مخلوط سطح پر تیر کی نشان سے ظاہر کیا جاتا ہے۔
\begin{figure}
\centering
\begin{tikzpicture}
...
مثال \حوالہ{مثال_بدلتا_دوری_سمتیہ_مثال_الف} میں \عددی{\hat{V}} کو مخلوط سطح پر تیر کے نشان سے ظاہر کیا گیا ہے جسے دیکھ کر یوں معلوم ہوتا ہے جیسے \عددی{\hat{V}} ایک سمتیہ ہے۔اسی حقیقت کی وجہ سے \عددی{\hat{V}} یا \عددی{\hat{I}} کو \اصطلاح{دوری سمتیہ}\فرہنگ{دوری سمتیہ}\حاشیہب{phasor}\فرہنگ{phasor} کہتے ہیں اور شکل \حوالہ{شکل_بدلتا_دوری_سمتیہ_مثال_الف} کو \اصطلاح{دوری سمتیہ شکل}\فرہنگ{دوری سمتیہ شکل}\حاشیہب{phasor diagram}\فرہنگ{phasor diagram} کہتے ہیں۔
...
حل:دباؤ \عددی{v_1(t)} کو مخلوط تفاعل کا حقیقی جزو لکھ کر
\begin{align*}
v_1(t)=\left. 20 e^{j(100 t+30^{\circ})}\right|_{\text{حقیقی}}
\end{align*}
تعدد کو ذہن نشین کرتے ہوئے،  \عددی{e^{j 100t}} نہ لکھتے  ہوئے اور زیر نوشت میں لفظ \قول{حقیقی} نہ لکھتے ہوئے  دوری سمتیہ حاصل ہوتا ہے۔
\begin{align*}
...
\end{align*} 
اس مساوات کے زیر نوشت میں لفظ \قول{حقیقی} نہ لکھتے ہوئے اور ساتھ ہی ساتھ \عددی{e^{j 310 t}} نہ لکھتے ہوئے دوری سمتیہ حاصل ہوتی ہے یعنی
\begin{align*}
...
شکل \حوالہ{شکل_بدلتا_دوری_سمتیات} میں \عددی{\hat{I}=25\phase{20^{\circ}}} اور \عددی{\hat{V}=30 e^{j55^{\circ}}} کھینچے گئے ہیں جہاں سے دوری سمتیات کا زاویائی تعلق بھی ظاہر ہوتا ہے۔شکل \حوالہ{شکل_بدلتا_دوری_سمتیات} میں دباؤ سے رو \عددی{33^{\circ}} درجے پیچھے ہے۔
\begin{figure}
\centering
\begin{tikzpicture}
...
کسی بھی حقیقی تفاعل مثلاً حقیقی دباؤ کو \عددی{v(t)=V_0\cos(\omega t+\phi)} صورت میں لکھتے ہوئے جہاں \عددی{V_0} مثبت حقیقی مقدار ہو، \عددی{V_0} اور \عددی{\phi} استعمال کرتے ہوئے دوری سمتیہ فوراً
\begin{align}
\hat{V}=V_0\phase{\phi}
\end{align}
لکھا جا سکتا ہے۔
...
\end{align*}
دباؤ کا حیطہ منفی ہے لہٰذا مثبت حیطہ حاصل کرنے کی خاطر دباؤ کو درج ذیل لکھتے ہیں
\begin{align*}
...
\حصہ{مزاحمت، امالہ گیر اور برق گیر کے انفرادی دوری سمتیہ تعلق}
شکل \حوالہ{شکل_بدلتا_مزاحمت_تعددی_اور_وقتی_تفاعل} پر نظر رکھتے ہوئے پڑھیں۔مزاحمت \عددی{R} پر مخلوط دباؤ \عددی{v(t)=V_0e^{j(\omega t+\phi_v)}} مسلط کرنے سے  مزاحمت میں مخلوط رو \عددی{i(t)=I_0e^{j(\omega t+\phi_i)}} گزرے گی۔اوہم کے قانون کے تحت
\begin{align*}
...
\end{aligned}
\end{gather} 
اس طرح مزاحمت کی رو اور دباؤ ہم زاویہ ہیں۔مساوات \حوالہ{مساوات_بدلتا_مزاحمت_دوری_تعلق_ب} کی مدد سے مساوات \حوالہ{مساوات_بدلتا_مزاحمت_دوری_تعلق_الف} درج ذیل صورت اختیار کرتے ہیں۔
\begin{gather}
...
\caption*{(ت)}
\end{subfigure}%
\caption{مزاحمت کے دباؤ اور رو کے تعددی اور وقتی تفاعل۔}
\label{شکل_بدلتا_مزاحمت_تعددی_اور_وقتی_تفاعل}
\end{figure}
%==============
\ابتدا{مثال}
شکل \حوالہ{شکل_بدلتا_مزاحمت_تعددی_اور_وقتی_تفاعل}-ب میں \عددی{\SI{10}{\ohm}} کے مزاحمت پر \عددی{v(t)=22\cos(30t-66^{\circ})} دباؤ مسلط کی گئی ہے۔ مزاحمت کے رو کو وقتی دائرہ کار میں لکھیں۔رو کی تعددی دائرہ کار صورت شکل \حوالہ{شکل_بدلتا_مزاحمت_تعددی_اور_وقتی_تفاعل}-الف سے دریافت کریں۔
...
\end{align*}
آئیں اب رو کی تعددی دائرہ کار صورت حاصل کرتے ہیں۔دوری دباؤ
\begin{align*}
...
%=============================
\ابتدا{مشق}
بارہ اوہم کے مزاحمت میں دوری رو \عددی{\hat{I}=37\phase{43^{\circ}} \, \si{\ampere}} ہے جبکہ تعدد \عددی{\omega=\SI{172}{\radian\per\second}} ہے۔دباؤ کی وقتی دائرہ کار صورت لکھیں۔

جواب:\عددی{v(t)=444\cos(172 t +43^{\circ}) \, \si{\volt}}
\انتہا{مشق}
%============================
شکل \حوالہ{شکل_بدلتا_امالہ_تعددی_اور_وقتی_تفاعل} پر نظر رکھتے ہوئے پڑھیں۔امالہ گیر کے دباؤ اور رو کا تعلق درج ذیل ہے۔
\begin{align}\label{مساوات_بدلتا_امالہ_وقتی_تعلق}
v=L\frac{\dif i(t)}{\dif t}
\end{align}
امالہ گیر پر مخلوط دباؤ \عددی{v(t)=V_0e^{j(\omega t+\phi_v)}} مسلط کرنے سے اس میں مخلوط رو \عددی{i(t)=I_0e^{j(\omega t+\phi_i)}} پیدا ہو گی۔ان قیمتوں کو درج بالا مساوات میں پُر کرنے سے
\begin{align*}
...
\end{aligned}
\end{gather}
ہوں گے۔یوں دباؤ کا زاویہ، رو کے زاویے سے \عددی{90^{\circ}} درجے زیادہ ہے لہٰذا رو سے دباؤ \عددی{90^{\circ}} درجے آگے ہے یا دباؤ سے رو \عددی{90^{\circ}} پیچھے ہے۔شکل \حوالہ{شکل_بدلتا_امالہ_تعددی_اور_وقتی_تفاعل}-پ میں دوری سمتیات دکھائے گئے ہیں جہاں دباؤ سے رو \عددی{90^{\circ}} درجے پیچھے دکھایا گیا ہے۔
...
\end{align}
درج بالا مساوات میں دیے دباؤ اور رو کو شکل \حوالہ{شکل_بدلتا_امالہ_تعددی_اور_وقتی_تفاعل}-ت میں دکھایا گیا ہے۔
%
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
...
\caption*{(ت)}
\end{subfigure}%
\caption{امالہ کے دباؤ اور رو کے تعددی اور وقتی تفاعل۔}
\label{شکل_بدلتا_امالہ_تعددی_اور_وقتی_تفاعل}
\end{figure}
%============
\ابتدا{مثال}
شکل \حوالہ{شکل_بدلتا_امالہ_تعددی_اور_وقتی_تفاعل} میں \عددی{\SI{4}{\milli\henry}} امالہ گیر پر \عددی{v(t)=12\cos(1000t+22^{\circ})} دباؤ مسلط کی جاتی ہے۔امالہ گیر کی رو دریافت کریں۔

حل:دوری سمتیہ دباؤ درج ذیل ہے۔
\begin{align*}
...
%================
\ابتدا{مشق}
امالہ کی قیمت \عددی{\SI{10}{\milli\henry}} جبکہ اس میں رو \عددی{\hat{I}=8\phase{44^{\circ}}} کی تعدد \عددی{\SI{500}{\radian \per\second}} ہے۔دباؤ کی وقتی دائرہ کار صورت دریافت کریں۔

جواب:\عددی{v(t)=40\cos(500t+134^{\circ})\, \si{\volt}}
\انتہا{مشق}
%===============
شکل \حوالہ{شکل_بدلتا_برق_گیر_تعددی_اور_وقتی_تفاعل} پر نظر رکھتے ہوئے پڑھیں جہاں برق گیر پر دباؤ \عددی{v(t)=V_0\cos(\omega t +\phi_v)} مسلط کی گئی ہے۔برق گیر کی تفرقی مساوات
\begin{align}\label{مساوات_بدلتا_برق_گیر_تفرقی_مساوات}
i(t)=C \frac{\dif v(t)}{\dif t}
\end{align}
میں مخلوط دباؤ اور مخلوط رو پُر کرتے ہوئے
\begin{align*}
...
\end{aligned}
\end{gather}
درج بالا مساوات کے تحت دباؤ سے رو \عددی{90^{\circ}} درجے آگے ہے۔
...
\end{align}
شکل \حوالہ{شکل_بدلتا_برق_گیر_تعددی_اور_وقتی_تفاعل}-پ میں دوری سمتیات دکھائے گئے ہیں جبکہ شکل-ت میں دباؤ اور رو کی وقتی دائرہ کار صورت دکھائی گئی ہے۔
...
\caption*{(ت)}
\end{subfigure}%
\caption{برق گیر کے دباؤ اور رو کے تعددی اور وقتی تفاعل۔}
\label{شکل_بدلتا_برق_گیر_تعددی_اور_وقتی_تفاعل}
\end{figure}
%=========================
\ابتدا{مثال}
شکل \حوالہ{شکل_بدلتا_برق_گیر_تعددی_اور_وقتی_تفاعل} میں \عددی{\SI{100}{\micro\farad}} برق گیر پر \عددی{v(t)=7\cos(5000t-60^{\circ}) \, \si{\volt}} کا دباؤ مسلط کیا گیا ہے۔رو حاصل کریں۔

حل:مسلط دباؤ کی دوری سمتیہ لکھتے ہیں۔
\begin{align*}
...
%===========================
\ابتدا{مشق}
شکل \حوالہ{شکل_بدلتا_برق_گیر_تعددی_اور_وقتی_تفاعل} میں \عددی{\SI{330}{\micro\farad}} برق گیر کی رو \عددی{\hat{I}=11\phase{-12^{\circ}} \, \si{\ampere}} ہے۔ رو کی تعدد \عددی{\SI{6000}{\hertz}} ہے۔دباؤ کی وقتی دائرہ کار صورت حاصل کریں۔
...
قانون اوہم کے تحت برقی مزاحمت کو \عددی{R=\tfrac{V}{I}} لکھا جا سکتا ہے۔بالکل اسی طرح، شکل \حوالہ{شکل_بدلتا_برقی_رکاوٹ_تعریف} میں دوری سمتیہ دباؤ اور دوری سمتیہ رو کی شرح کو \اصطلاح{برقی رکاوٹ}\فرہنگ{رکاوٹ}\فرہنگ{برقی!رکاوٹ}\حاشیہب{impedance}\فرہنگ{impedance} کہتے اور  \عددی{\bZ} سے ظاہر کرتے ہیں۔
...
\end{align}
چونکہ دباؤ اور رو کی شرح کو اوہم \عددی{\si{\ohm}} میں ناپتے ہیں لہٰذا رکاوٹ کی اکائی بھی اوہم ہے۔یوں بدلتا رو دور کی رکاوٹ یک سمت رو دور کی مزاحمت کی مانند ہے۔رکاوٹ کو مستطیل طرز میں بھی لکھا جا سکتا ہے
\begin{align}
...
\draw(1,1.25)node{\RL{بدلتا رو دور}};
...
%=============
\ابتدا{مشق}
صفحہ \حوالہصفحہ{شکل_مزاحمتی_متعدد_مزاحمت_تقسیم_دباو} پر شکل \حوالہ{شکل_مزاحمتی_متعدد_مزاحمت_تقسیم_دباو} میں سلسلہ وار مزاحمت جڑے دکھائے گئے ہیں۔مزاحمتوں کی جگہ رکاوٹ نصب کرتے ہوئے، مخلوط دباؤ اور مخلوط رو کے استعمال سے مساوی رکاوٹ کی مساوات حاصل کریں۔ اسی طرح متعدد رکاوٹوں کو متوازی جوڑتے ہوئے ان کا مساوی رکاوٹ حاصل کریں۔
...
%====================================
\ابتدا{مشق}
متعدد برق گیر متوازی جڑے ہیں۔ان کی رکاوٹیں استعمال کرتے ہوئے مساوات \حوالہ{مساوات_بدلتا_متوازی_مساوی_رکاوٹ_الف} کی مدد سے ان کا مساوی رکاوٹ حاصل کریں۔مساوی رکاوٹ سے مساوی برق گیر کی مساوات حاصل کریں۔متعدد متوازی برق گیر کا مساوی برق گیر  دیتی ہے۔
\انتہا{مشق}
%==================================
\ابتدا{مشق}
...
شکل \حوالہ{شکل_بدلتا_سلسلہ_وار_مزاحمت_امالہ_برق_گیر_الف} میں منبع دباؤ کو درپیش مساوی رکاوٹ \عددی{\SI{50}{\hertz}} اور \عددی{\SI{2000}{\radian\per\second}} تعدد پر دریافت کریں۔دباؤ \عددی{v(t)=30\cos(\omega t+45^{\circ}) \, \si{\volt}} کی صورت میں دونوں تعدد پر وقتی دائرہ کار میں رو دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
...
\end{align*}
دباؤ کو دوری سمتیہ صورت میں لکھتے ہوئے تعددی دائرہ کار میں رو حاصل کرتے ہیں۔
\begin{align*}
...
بدلتا رو ادوار میں برقی رکاوٹ \عددی{\bZ} کے علاوہ \اصطلاح{برقی فراوانی}\فرہنگ{فراوانی}\حاشیہب{admittance}\فرہنگ{admittance} \عددی{\bY} بھی نہایت اہم ثابت ہوتی ہے۔رکاوٹ کے  مقلوب  کو فراوانی کہتے ہیں۔
\begin{align}
\bY=\frac{1}{\bZ}
\end{align}
...
\end{aligned}
\end{gather}
آپ دیکھ سکتے ہیں کہ مخلوط رکاوٹ کی صورت میں \عددی{G} اور \عددی{R} مقلوب  نہیں ہیں۔اسی طرح \عددی{B} اور \عددی{X} بھی مقلوب  نہیں ہیں۔اگر رکاوٹ میں \عددی{X=0} ہو تب \عددی{G=\tfrac{1}{R}} ہو گا۔
...
رکاوٹ کی قیمت تعدد پر منحصر ہوتی ہے۔یوں دور میں رو اور دباؤ کا دارومدار بھی تعدد پر ہو گا۔دوری سمتیہ اشکال کی مدد سے رو اور دباؤ پر تعدد کے اثر پر غور کرنے میں مدد ملتی ہے۔آئیں اس پر چند مثال دیکھیں۔
%=======================
...
\end{align*}
جس سے منبع کا دباؤ درج ذیل ملتا ہے۔
\begin{align*}
...
حل:رو کو حوالہ لیتے ہیں۔یوں \عددی{\hat{I}=I_0\phase{0^{\circ}}} ہو گا۔تعدد \عددی{\omega} پر مزاحمتی رکاوٹ \عددی{\bZ_R=R} جبکہ  برق گیر کی رکاوٹ \عددی{\bZ_C=\tfrac{1}{\omega C} \phase{-90^{\circ}}} ہو گی لہٰذا ان پرزوں پر دباؤ درج ذیل ہو گا۔
\begin{align*}
\hat{V}_R&=\hat{I} \bZ_R=I_0 R \phase{0^{\circ}}\\
\hat{V}_C&=\hat{I} \bZ_C=\frac{I_0}{ \omega C} \phase{-90^{\circ}}
\end{align*}
یوں مزاحمت پر دباؤ عین رو کے ہم زاویہ ہے جبکہ برق گیر پر دباؤ، رو سے \عددی{90^{\circ}} پیچھے ہے۔شکل \حوالہ{شکل_بدلتا_دوری_سمتیات_ب}-ب میں ان دوری سمتیات کو دکھایا گیا ہے۔چونکہ مزاحمتی رکاوٹ کی قیمت پر تعدد کا کوئی اثر نہیں لہٰذا \عددی{\hat{V}_R} کی قیمت اور زاویہ تعدد تبدیل کرنے سے تبدیل نہیں ہوتے۔اس کے برعکس برق گیر رکاوٹ تعدد کے بالعکس متناسب ہے لہٰذا تعدد بڑھانے سے \عددی{\bZ_C} کی قیمت کم ہو گی اور یوں \عددی{\hat{V}_C} کا حیطہ بھی کم ہو گا جبکہ اس کا زاویہ جوں کا توں رہے گا۔آپ دیکھ سکتے ہیں کہ لامتناہی تعدد پر \عددی{\hat{V}_C} کی قیمت صفر ہو گی جبکہ تعدد کم کرنے سے \عددی{\hat{V}_C} کی نوک خیالی محور پر رہتے ہوئے  مبدا سے دور ہو گی۔

شکل \حوالہ{شکل_بدلتا_دوری_سمتیات_ب}-الف سے درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
\hat{V}_m=\hat{V}_R+\hat{V}_C
\end{align*}
شکل \حوالہ{شکل_بدلتا_دوری_سمتیات_ب}-پ میں اس سمتیہ جمع کو دکھایا گیا ہے جہاں دم سے سر جوڑنے کا طریقہ استعمال کیا گیا ہے۔تعدد کو کم یا زیادہ کرنے  سے \عددی{\hat{V}_C} کا حیطہ زیادہ اور کم ہو گا لہٰذا شکل میں \عددی{\hat{V}_m} کی نوک نقطہ دار لکیر پر حرکت کرے گی۔لامتناہی تعدد کی صورت میں \عددی{\hat{V}_m=\hat{V}_R} ہو گا جبکہ صفر  تعدد پر \عددی{\hat{V}_m} کا زاویہ تقریباً \عددی{-90^{\circ}} ہو گا۔ 
\انتہا{مثال}
%===============
...
حل:یہاں بھی رو کو حوالہ دوری سمتیہ \عددی{\hat{I}=I_0\phase{0^{\circ}}\,\si{\ampere}} تصور کرتے ہیں۔مزاحمت کا دباؤ اسی سمت میں ہو گا جبکہ امالہ کا دباؤ \عددی{90^{\circ}} آگے اور برق گیر کا دباؤ \عددی{90^{\circ}} پیچھے ہو گا۔شکل \حوالہ{شکل_بدلتا_دوری_سمتیات_پ}-ب میں انہیں دکھایا گیا ہے۔

جن تعدد پر \عددی{\omega L > \tfrac{1}{\omega C}} ہو، ان تعدد پر امالہ کا دباؤ، برق گیر کے دباؤ سے زیادہ ہو گا لہٰذا \عددی{\hat{V}_L+\hat{V}_C} کا زاویہ \عددی{90^{\circ}} ہو گا یعنی ان کا مجموعی تاثیر امالی ہو گا۔شکل \حوالہ{شکل_بدلتا_دوری_سمتیات_پ}-پ میں ایسی ہی تعدد پر درج ذیل سمتیہ مجموعہ دکھایا گیا ہے۔
\begin{align*}
\hat{V}_m=\hat{V}_R+\hat{V}_L+\hat{V}_C
\end{align*}
جس تعدد پر \عددی{\omega L=\tfrac{1}{\omega C}} ہو یعنی \عددی{(\omega_0=\tfrac{1}{\sqrt{LC}})} اس تعدد پر \عددی{\hat{V}_L+\hat{V}_C=0} ہو گا لہٰذا درج بالا مجموعے سے \عددی{\hat{V}_m=\hat{V}_R} حاصل ہو گا۔تعدد \عددی{\omega_0} سلسلہ وار جڑے \عددی{LC} کی \اصطلاح{قدرتی تعدد}\فرہنگ{قدرتی تعدد} یا اس کی \اصطلاح{گھمکی تعدد}\فرہنگ{گھمکی تعدد}\حاشیہب{resonant frequency}\فرہنگ{resonant frequency} کہلاتی ہے۔تعدد کم اور زیادہ کرنے سے \عددی{\hat{V}_m} کی نوک نقطہ دار لکیر پر حرکت کرتی ہے۔عین \عددی{\omega_0} پر \عددی{\hat{V}_m=\hat{V}_R} ہو گا۔گھمکی تعدد سے زیادہ تعدد پر \عددی{\hat{V}_m} کی نوک، نقطہ دار لکیر پر رہتے ہوئے، افقی محور سے اوپر ہو گی جبکہ \عددی{\omega_0} سے کم تعدد پر \عددی{\hat{V}_m} کی نوک، نقطہ دار لکیر پر رہتے ہوئے، افقی محور سے نیچے ہو گی۔ شکل \حوالہ{شکل_بدلتا_دوری_سمتیات_پ}-پ  گھمکی تعدد سے زیادہ تعدد کی صورت حال دکھا رہا ہے۔ 
\انتہا{مثال} 
%================
...
\end{align*}
جبکہ دور کو \عددی{\SI{1000}{\radian\per\second}} پر حل کیا گیا ہے۔یہی وجہ ہے کہ دور برق گیر تاثیر رکھتا ہے اور رو منبع کے دباؤ سے \عددی{37.87^{\circ}} درجے  آگے ہے۔عین قدرتی تعدد پر
\begin{align*}
...
عموماً حوالہ دوری سمتیہ کا زاویہ \عددی{0^{\circ}} رکھا جاتا ہے۔یوں اگر ہم منبع دباؤ کا زاویہ \عددی{40^{\circ}} کی جگہ \عددی{0^{\circ}} چنتے تب \عددی{\hat{V}_m=120\phase{0^{\circ}}} لکھا جاتا اور رو درج ذیل حاصل ہوتی۔
\begin{align*}
\hat{I}=\frac{\hat{V}_m}{\bZ}=\frac{120\phase{0^{\circ}}}{10\phase{-36.87^{\circ}}}=12\phase{36.87^{\circ}}\,\si{\ampere}
\end{align*}
انہیں شکل  \حوالہ{شکل_بدلتا_رو_بالمقابل_دباو}-ب میں دکھایا گیا ہے۔آپ دیکھ سکتے ہیں کہ شکل-الف کو  گھڑی  وار سمت میں \عددی{40^{\circ}} گھمانے سے شکل-ب ملتا ہے۔یوں حوالہ سمتیہ کا زاویہ تبدیل کرنے سے تمام دوری سمتیہ کی شکل گھوم جاتی ہے، البتہ انفرادی دوری سمتیات کے تعلق پر کوئی فرق نہیں پڑتا۔یوں شکل-الف اور شکل-ب دونوں میں رو \عددی{36.87^{\circ}} درجے دباؤ سے آگے ہے۔ 
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
حل:دباؤ \عددی{\hat{V}_m} کو حوالہ دوری سمتیہ لیتے ہوئے اس کا زاویہ صفر درجے چنتے ہیں۔ تینوں پرزوں پر \عددی{\hat{V}_m}  دباؤ پایا جاتا ہے لہٰذا ان کی انفرادی رو درج ذیل ہوں گے۔
\begin{align*}
...
\end{align*}
جسے \عددی{\omega>\omega_0}  کی صورت میں  شکل-ت میں دکھایا گیا ہے۔تعدد مزید بڑھانے سے \عددی{\hat{I}_m} کی نوک نقطہ دار لکیر پر رہتے ہوئے افقی محور سے مزید دور ہو گی۔دوری سمتیہ \عددی{\hat{I}'_m} ایسی صورت کو ظاہر کرتی ہے۔

قدرتی تعدد سے کم تعدد \عددی{(\omega<\omega_0)} پر \عددی{\bZ_C>\bZ_L} اور \عددی{I_L>I_C} ہو گا لہٰذا دوری سمتیہ کی نوک نقطہ دار لکیر پر افقی محور سے نیچے کی طرف ہو گی۔دوری سمتیہ \عددی{\hat{I}''_m} ایسی صورت کو ظاہر کرتی ہے۔
\انتہا{مثال}
%===================
\ابتدا{مشق}\شناخت{مشق_بدلتا_دو_پرزے_متوازی_الف}
شکل \حوالہ{شکل_بدلتا_دو_پرزے_متوازی_الف}-الف میں تمام رو اور دباؤ کے دوری سمتیات کے خط کھینچیں۔تقسیم رو کا کلیہ استعمال کیا جا سکتا ہے۔ جواب کو شکل-ب میں دکھایا گیا ہے۔
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
...
\حصہ{کرخوف مساوات}
یک سمت رو ادوار کو کرخوف کے قوانین سے حل کرنا ہم گزشتہ بابوں میں دیکھ چکے ہیں۔قوانین کرخوف دوری سمتیات پر بھی لاگو ہوتے ہیں۔یوں بدلتا رو ادوار کو کرخوف مساوات سے بالکل یک سمت رو ادوار کی طرح حل کیا جا سکتا ہے۔یک سمت رو ادوار حل کرنے کے تمام ترکیب یعنی مسئلہ تھونن، مسئلہ نارٹن، مسئلہ تبادلہ منبع، مسئلہ خطی میل، تقسیم رو اور تقسیم دباؤ کو بدلتا رو ادوار حل کرنے کے لیے بھی استعمال کیا جاتا ہے۔بدلتا رو ادوار کی صورت میں مخلوط الجبرا کا استعمال کیا جاتا ہے۔متعدد منبع کی صورت میں اگر تمام منبع کی تعدد یکساں ہو تب درج بالا تمام ترکیب قابل استعمال ہوں گے البتہ مختلف تعدد کی صورت میں مسئلہ خطی میل کی مدد سے انفرادی منبع کے وقتی دائرہ کار میں جوابات کا مجموعہ لیتے ہوئے ادوار حل کیے جا سکتے ہیں۔ایسے ایک دور کو مثال \حوالہ{مثال_بدلتا_مختلف_تعدد} میں حل کیا گیا ہے۔ گزشتہ حصے میں ہم نے چند سادہ مثال اسی طرح حل کیے۔آئیں نسبتاً مشکل ادوار حل کریں۔


%==================
\ابتدا{مثال}\شناخت{مثال_بدلتا-متعدد_پرزے_کرخوف_الف}
شکل \حوالہ{شکل_بدلتا-متعدد_پرزے_کرخوف_الف} میں تمام نا معلوم دباؤ اور رو دریافت کریں۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
حل:ہم پہلے منبع سے جڑی کُل رکاوٹ حاصل کرتے ہوئے \عددی{\hat{I}_1} دریافت کرتے ہیں جسے جانتے ہوئے \عددی{j2\,\si{\ohm}} امالہ کا دباؤ حاصل کیا جا سکتا ہے۔اس دباؤ کو \عددی{\hat{V}_m} سے منفی کرتے ہوئے \عددی{\hat{V}_1} حاصل کیا جائے گا۔اب \عددی{\hat{V}_1} جانتے ہوئے  \عددی{\hat{I}_2} حاصل کیا جا سکتا ہے جسے استعمال کرتے ہوئے \عددی{\hat{I}_3=\hat{I}_1-\hat{I}_2} لکھا جا سکتا ہے۔آخر میں \عددی{\hat{V}_2=\hat{I}_3 (-j8)} لکھتے ہوئے برق گیر کا دباؤ حاصل کیا جائے  گا۔
...
&=10.8987\phase{-67.224^{\circ}}\,\si{\volt}
\end{align*}
اس کے علاوہ \عددی{\hat{V}_1} کو تقسیم دباؤ کے کلیے سے بھی حاصل کیا جا سکتا ہے یعنی
\begin{align*}
\hat{V}_1&=\left(\frac{\frac{6(1-j8)}{6+1-j8}}{j10+\frac{6(1-j8)}{6+1-j8}}\right) 20\phase{30^{\circ}}\\
&=10.8987\phase{-67.224^{\circ}}\,\si{\volt}
\end{align*}
دباؤ \عددی{\hat{V}_1} جانتے ہوئے \عددی{\hat{I}_2} حاصل کرتے ہیں۔
\begin{align*}
...
&=1.352\phase{15.65^{\circ}}\,\si{\ampere}
\end{align*}
برق گیر کا دباؤ حاصل کرتے ہیں۔
\begin{align*}
\hat{V}_2&=\hat{I}_3 (-j8)\\
&=(1.352\phase{15.65^{\circ}})(8\phase{-90^{\circ}})\\
&=10.816\phase{-74.35^{\circ}}\,\si{\volt}
\end{align*}
اس دباؤ کو تقسیم دباؤ کے کلیے سے بھی حاصل کیا جا سکتا ہے یعنی
\begin{align*}
\hat{V}_2&=\left(\frac{-j8}{1-j8}\right) \hat{V}_1\\
&=10.816\phase{-74.35^{\circ}}\,\si{\volt}
\end{align*}
اس کے علاوہ \عددی{\SI{1}{\ohm}}  مزاحمت میں \عددی{\hat{I}_3} گزرتی ہے۔یوں \عددی{\hat{V}_1} سے اس مزاحمت کا دباؤ منفی کرنے سے بھی برق گیر کا دباؤ حاصل کیا جا سکتا ہے یعنی
\begin{align*}
...
\حصہ{تجزیاتی تراکیب}
اس حصے میں ہم وہ تمام ترکیب استعمال کریں گے جن سے یک سمت ادوار حل کیے گئے۔ایسا مثالوں کی مدد سے کیا جائے گا۔
...
حل:تین خانوں میں رو فرض کرتے ہوئے دائرہ \عددی{abcda} اور \عددی{dcefd} پر  کرخوف مساوات دباؤ لکھتے ہیں۔
\begin{align}
...
شکل \حوالہ{شکل_بدلتا_تراکیب_ب} کو مسئلہ خطی میل سے حل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
...
\end{tikzpicture}
\caption{مثال \حوالہ{مثال_بدلتا_تراکیب_پ} کا دور۔ منبع دباؤ کو قصر دور کیا گیا ہے۔}
\label{شکل_بدلتا_تراکیب_پ}
\end{figure}


حل:مسئلہ خطی میل میں تمام منبع کے انفرادی اثرات کا مجموعہ لیا جاتا ہے۔شکل \حوالہ{شکل_بدلتا_تراکیب_ب} میں منبع دباؤ کو قصر دور کرتے ہوئے  شکل \حوالہ{شکل_بدلتا_تراکیب_پ} حاصل ہوتا ہے۔منبع رو کے متوازی کُل رکاوٹ \عددی{ \bZ_1} حاصل کرتے ہیں۔شکل کو دیکھتے ہوئے درج ذیل لکھا جا سکتا ہے
\begin{align*}
...
\end{align*}
حاصل ہوتا ہے۔یوں دباؤ \عددی{\hat{V}} درج ذیل ہو گا۔
\begin{align*}
\hat{V}&=(5\phase{60^{\circ}})(2.6261\phase{-66.8^{\circ}})=13.13\phase{-6.8^{\circ}}\,\si{\volt} 
\end{align*}
دباؤ جانتے ہوئے درکار رو درج ذیل لکھی جا سکتی ہے۔
\begin{gather}
...
آئیں اب منبع دباؤ سے پیدا رو حاصل کریں۔ایسا کرنے کی خاطر منبع رو کو کھلا دور کرتے ہوئے شکل \حوالہ{شکل_بدلتا_تراکیب_ت} حاصل کرتے ہیں۔اس شکل میں \عددی{\hat{I}} جانتے ہوئے تقسیم رو کے کلیے سے \عددی{\hat{I}''_0} حاصل کیا جا سکتا ہے۔آئیں پہلے \عددی{\hat{I}} حاصل کریں۔منبع رو کے ساتھ کُل درج ذیل رکاوٹ جڑی ہے۔
\begin{align*}
...
\end{align*}
رو \عددی{\hat{I}} جانتے ہوئے تقسیم رو کے کلیے سے \عددی{\hat{I}''_0} حاصل کرتے ہیں جہاں منفی کی علامت اس لیے استعمال کی گئی ہے کہ  \عددی{\hat{I}} اور \عددی{\hat{I}''_0} کی سمتیں آپس میں الٹ ہیں۔
\begin{align*}
\hat{I}''_0&=-\left(\frac{10}{10+2+j6}\right) \hat{I}\\
&=-\left(\frac{10}{10+2+j6}\right) 8.356\phase{-61.8^{\circ}}\\
&=6.23\phase{91.63^{\circ}}\,\si{\ampere}
\end{align*}
شکل \حوالہ{شکل_بدلتا_تراکیب_پ} اور شکل \حوالہ{شکل_بدلتا_تراکیب_ت} میں حاصل کیے گئے رو کا مجموعہ درکار رو ہے یعنی
\begin{align*}
...
حل:منبع رو کے متوازی رکاوٹ \عددی{2-j4} جڑی ہے۔ان کو نارٹن مساوی دور تصور کرتے ہوئے ان کی جگہ  تھونن مساوی  دور نصب کرتے ہوئے شکل-ب ملتا ہے جہاں درج ذیل متبادل منبع دباؤ نصب کیا گیا ہے۔
\begin{align*}
...
\انتہا{مثال}
%================
\ابتدا{مثال}\شناخت{مثال_بدلتا_تراکیب_ث}
شکل \حوالہ{شکل_بدلتا_تراکیب_ث}-الف میں مسئلہ تھونن کی مدد سے بوجھ کی رو \عددی{\hat{I}_0} دریافت کریں۔
...
\centering
\begin{tikzpicture}
\draw(0,0) to [american current source,l_={$5\phase{0^{\circ}}\,\si{\ampere}$}]++(0,\yy) to [capacitor,l_={$-j2\,\si{\ohm}$}]++(-\xx,0) to [resistor,l_={$\SI{2}{\ohm}$}]++(0,-\yy) to [short] (0,0);
\draw(0,0) to [short,*-]++(\xx,0) to [capacitor,*-,i<={$\hat{I}_0$},l_={$-j1 \, \si{\ohm}$}]++(0,\yy) to [american voltage source,-*,l_={$10\phase{0^{\circ}}$}]++(-\xx,0);
\draw(\xx,0) to [short]++(\xx,0) to [resistor,l_={$\SI{2}{\ohm}$}]++(0,\yy) to [inductor,-*,l_={$j3\,\si{\ohm}$}]++(-\xx,0);
\end{tikzpicture}
\caption*{(الف)}
\end{subfigure}
\begin{subfigure}{1\textwidth}
\centering
\begin{tikzpicture}
\draw(0,0)++(0,\yy) to [capacitor,l_={$-j2\,\si{\ohm}$}]++(-\xx,0) to [resistor,l_={$\SI{2}{\ohm}$}]++(-\xx,0) ++(0,-\yy) to [american voltage source,l_={$(2-j2)(5\phase{0^{\circ}})\,\si{\volt}$}] ++(0,\yy) ++(0,-\yy) to [short] (0,0);
\draw(0,0) to [short,-*]++(\xx,0) to [short,-o]++(0,\yy/8)coordinate(b)node[left]{$b$};
\draw(\xx,\yy) to [short,-o]++(0,-\yy/8)coordinate(a)node[left]{$a$};
\draw (\xx,\yy) to [american voltage source,l_={$10\phase{0^{\circ}}$}]++(-\xx,0);
\draw(\xx,0) to [short]++(\xx,0) to [resistor,l_={$\SI{2}{\ohm}$}]++(0,\yy) to [inductor,-*,l_={$j3\,\si{\ohm}$}]++(-\xx,0);
\draw($(a)!0.5!(b)$) node{$\begin{aligned} &+ \\ &\hat{V}_\text{تھونن} \\ &- \end{aligned}$};
\draw[stealth-] ([shift={(-150:\xx/4)}]0,\yy/2) arc (-150:150:\xx/4);
\draw(0,\yy/2) node{$\hat{I}$};
\end{tikzpicture}
\caption*{(ب)}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}
\draw(0,\yy) to [capacitor,l_={$-j2\,\si{\ohm}$}]++(-\xx,0) to [resistor,l={$\SI{2}{\ohm}$}]++(0,-\yy) to [short] (0,0);
\draw(0,0) to [short,*-o]++(0,\yy/8);
\draw(0,\yy) to [short,-o]++(0,-\yy/8);
\draw(0,0) to [short] ++(\xx,0)  to [resistor,l_={$\SI{2}{\ohm}$}]++(0,\yy) to [inductor,-*,l_={$j3\,\si{\ohm}$}]++(-\xx,0);
\draw(0,\yy/2)node{$Z_{\text{تھونن}}$};
\end{tikzpicture}%
\caption*{(پ)}
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\centering
\begin{tikzpicture}
\draw(0,0) to [american voltage source,l={$8.745\phase{-47.73^{\circ}} \, \si{\volt}$}]++(0,\y) to [european resistor,l={$2.471-j0.118\,\si{\ohm}$}]++(\x,0) to [capacitor,i={$\hat{I}_0$},l_={$-j1\,\si{\ohm}$}]++(0,-\y) to [short](0,0);
\end{tikzpicture}%
\caption*{(ت)}
\end{subfigure}%
\caption{مثال \حوالہ{مثال_بدلتا_تراکیب_ث} کا دور۔}
\label{شکل_بدلتا_تراکیب_ث}
\end{figure}

حل:تھونن دباؤ دریافت کرنے کی خاطر بوجھ کو کھلا دور کرنے سے شکل-ب حاصل ہوتا ہے جہاں متوازی جڑے منبع رو اور رکاوٹ \عددی{2-j2 \,\si{\ohm}} کا متبادل تھونن دور نصب کیا گیا ہے۔دور میں رو \عددی{\hat{I}} تصور کرتے ہوئے درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
\hat{I}&=\frac{(2-j2)(5\phase{0^{\circ}})-10\phase{0^{\circ}}}{2-j2+j3+2}\\
&=\frac{(10-j10)-(10)}{4+j1}\\
&=2.425\phase{-104^{\circ}}\,\si{\ampere}
\end{align*}
یوں تھونن دباؤ درج ذیل ہو گا۔
\begin{align*}
\hat{V}_{\text{تھونن}}&=(2+j3)\hat{I}\\
&=(2+j3)(2.425\phase{-104^{\circ}}) \\
&=8.745\phase{-47.73^{\circ}}\,\si{\volt}
\end{align*}
 تھونن رکاوٹ حاصل کرنے کی خاطر شکل \حوالہ{شکل_بدلتا_تراکیب_ث} میں منبع رو کو کھلے دور اور منبع دباؤ کو قصر دور کرتے ہوئے شکل-پ حاصل ہوتا ہے جہاں سے درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
Z_{\text{تھونن}}&=\frac{(2-j2)(2+j3)}{(2-j2)+(2+j3)}=2.471-j0.118 \, \si{\ohm}
\end{align*}
تھونن دباؤ اور تھونن رکاوٹ استعمال کرتے ہوئے شکل-ت حاصل ہوتی ہے جس سے بوجھ کی رو درج ذیل حاصل ہوتی ہے۔
\begin{align*}
...
\end{align*}
تھونن رکاوٹ کو شکل میں سلسلہ وار جڑے \عددی{\SI{2.471}{\ohm}}مزاحمت اور \عددی{-j0.118\,\si{\ohm}} برق گیر سے بھی ظاہر کیا جا سکتا تھا البتہ دکھایا گیا طریقہ مجھے زیادہ پسند ہے۔ 
\انتہا{مثال}
%=================
\ابتدا{مثال}\شناخت{مثال_بدلتا_تراکیب_ج}
شکل \حوالہ{شکل_بدلتا_تراکیب_ث}-الف میں مسئلہ نارٹن کی مدد سے بوجھ کی رو \عددی{\hat{I}_0} دریافت کریں۔
...
\begin{tikzpicture}
\draw(0,0) to [american current source,l_={$5\phase{0^{\circ}}\,\si{\ampere}$}]++(0,\yy) to [capacitor,l_={$-j2\,\si{\ohm}$}]++(-\xx,0) to [resistor,l_={$\SI{2}{\ohm}$}]++(0,-\yy) to [short] (0,0);
\draw(0,0) to [short,*-]++(\xx,0) to [short,*-,i<_={$\hat{I}_{\text{نارٹن}}$}]++(0,\yy) to [american voltage source,-*,l_={$10\phase{0^{\circ}}$}]++(-\xx,0);
\draw(\xx,0) to [short]++(\xx,0) to [resistor,l_={$\SI{2}{\ohm}$}]++(0,\yy) to [inductor,-*,l_={$j3\,\si{\ohm}$}]++(-\xx,0);
\end{tikzpicture}
\caption*{(الف)}
\end{subfigure}
...
\begin{tikzpicture}
\draw(0,0)++(0,\yy) to [capacitor,l_={$-j2\,\si{\ohm}$}]++(-\xx,0) to [resistor,l_={$\SI{2}{\ohm}$}]++(-\xx,0) ++(0,-\yy) to [american voltage source,l_={$(2-j2)(5\phase{0^{\circ}})\,\si{\volt}$}] ++(0,\yy) ++(0,-\yy) to [short] (0,0);
\draw(0,0) to [short]++(\xx,0) to [short,i<_={$\hat{I}_{\text{تھونن}}$}]++(0,\yy);
\draw (\xx,\yy) to [american voltage source,l_={$10\phase{0^{\circ}}$}]++(-\xx,0);
\end{tikzpicture}
\caption*{(ب)}
\end{subfigure}
...
\centering
\begin{tikzpicture}
\draw(0,0) to [american current source,l={$3.535\phase{-45^{\circ}}\,\si{\ampere}$}]++(0,\y) to [short]++(\x,0) to [european resistor,l={$2.471-j0.118\,\si{\ohm}$}]++(0,-\y) to [short] (0,0);
\draw(\x,0) to [short,*-]++(2*\x,0) to [capacitor,i<={$\hat{I}_0$},l_={$-j1\,\si{\ohm}$}]++(0,\y) to [short,-*]++(-2*\x,0);
\end{tikzpicture}%
\caption*{(پ)}
\end{subfigure}%
\caption{مثال \حوالہ{مثال_بدلتا_تراکیب_ج} کا دور۔}
\label{شکل_بدلتا_تراکیب_ج}
\end{figure}

حل:نارٹن رو دریافت کرنے کی خاطر  بوجھ کو قصر دور کرنے سے شکل \حوالہ{شکل_بدلتا_تراکیب_ج}-الف حاصل ہوتا ہے جہاں نارٹن رو کی نشاندہی کی گئی ہے۔آپ دیکھ سکتے ہیں کہ قصر دور کے دائیں جانب پرزوں میں صفر رو گزرے گی لہٰذا انہیں دور سے ہٹایا جا سکتا ہے۔ایسا ہی کرتے ہوئے اور ساتھ ہی ساتھ متوازی جڑے منبع رو \عددی{2-j2\,\si{\ohm}} رکاوٹ کی جگہ متبادل منبع نصب کرتے ہوئے شکل-ب حاصل ہوتا ہے۔ شکل-ب سے درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
\hat{I}_{\text{نارٹن}}&=\frac{(2-j2)(5\phase{0^{\circ}})}{2-j2}\\
&=3.535\phase{-45^{\circ}} \, \si{\ampere}
\end{align*}
گزشتہ مثال میں ہم تھونن رکاوٹ \عددی{\bZ_{\text{تھونن}}=2.471-j0.118\,\si{\ohm}} حاصل کر چکے ہیں۔شکل-پ میں بوجھ کے ساتھ نارٹن مساوی دور نصب کیا گیا ہے جہاں سے تقسیم رو کے کلیے سے  \عددی{\hat{I}_0} درج ذیل لکھی جا سکتی ہے۔ 
\begin{align*}
\hat{I}_0&=\frac{2.471-j0.118}{2.471-j0.118-j1} (3.535\phase{-45^{\circ}})\\
&=3.22\phase{-23.39^{\circ}}\,\si{\ampere}
\end{align*}
\انتہا{مثال}
%==============================
\ابتدا{مثال}\شناخت{مثال_بدلتا_مختلف_تعدد}
شکل \حوالہ{مثال_بدلتا_مختلف_تعدد} میں رو \عددی{i(t)} حاصل کریں۔
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
\begin{tikzpicture}
\draw(0,0) to [american voltage source,l={$10\cos(100t-30^{\circ})\,\si{\volt}$}]++(0,\y) to [resistor,i={$i(t)$},l={$\SI{2}{\ohm}$}]++(\x,0) to [inductor,l={$\SI{0.02}{\henry}$}]++(\x,0) to [capacitor,l={$\SI{0.01}{\farad}$}]++(\x,0);
\draw(0,0) to [short]++(3*\x,0) to [american voltage source,l_={$20\cos(50t+60^{\circ})$}]++(0,\y);
\end{tikzpicture}
\caption*{(الف)}
\end{subfigure}
\begin{subfigure}{1\textwidth}
\centering
\begin{tikzpicture}
\draw(0,0) to [american voltage source,l={$10\phase{-30^{\circ}}\,\si{\volt}$}]++(0,\y) to [resistor,i={$\hat{I}'$},l={$\SI{2}{\ohm}$}]++(\x,0) to [inductor,l={$j2\,\si{\ohm}$}]++(\x,0) to [capacitor,l={$-j1\,\si{\ohm}$}]++(\x,0);
\draw(0,0) to [short]++(3*\x,0) to [short]++(0,\y);
\end{tikzpicture}
\caption*{(ب)}
\end{subfigure}
\begin{subfigure}{1\textwidth}
\centering
\begin{tikzpicture}
\draw(0,0) to [short]++(0,\y) to [resistor,i<={$\hat{I}''$},l={$\SI{2}{\ohm}$}]++(\x,0) to [inductor,l={$j1\,\si{\ohm}$}]++(\x,0) to [capacitor,l={$-j2\,\si{\ohm}$}]++(\x,0);
\draw(0,0) to [short]++(3*\x,0) to [american voltage source,l_={$20\phase{60^{\circ}}$}]++(0,\y);
\end{tikzpicture}
\caption*{(پ)}
\end{subfigure}
\caption{مثال \حوالہ{مثال_بدلتا_مختلف_تعدد} کا دور۔}
\label{شکل_بدلتا_مختلف_تعدد}
\end{figure}

حل:یہاں منبع دباؤ کی تعدد مختلف ہے لہٰذا دوری سمتیات استعمال کرتے ہوئے کون سی تعدد استعمال کی جائے گی؟ اس دور کو مسئلہ خطی میل سے حل کیا جا سکتا ہے۔یوں باری باری ایک ایک منبع نصب کرتے ہوئے وقتی دائرہ کار میں جوابات حاصل کیے جائیں گے۔تمام جوابات کا مجموعہ درکار جواب ہو گا۔

شکل-ب میں صرف بائیں منبع استعمال کیا گیا ہے لہٰذا تعدد \عددی{\omega=\SI{100}{\radian\per\second}} ہو گی۔یوں امالی رکاوٹ اور برق گیر رکاوٹ درج ذیل ہوں گے۔
\begin{align*}
...
\end{align*}
اب دوسری منبع کو استعمال کرتے ہوئے حل کرتے ہیں لہٰذا تعدد \عددی{\omega=\SI{50}{\radian\per\second}} ہو گی۔یوں امالی رکاوٹ اور برق گیر رکاوٹ بالترتیب درج ذیل ہوں گے جنہیں استعمال کرتے ہوئے شکل-پ حاصل کی گئی ہے۔
\begin{align*}
...
\end{align*}
چونکہ شکل-پ میں رو کی سمت درکار سمت کے الٹ چنی گئی ہے لہٰذا کُل رو درج ذیل ہو گی۔
\begin{align*}
i(t)&=i(t)'-i(t)''
...
\انتہا{مثال}
%=============
\ابتدا{مثال}\شناخت{مثال_بدلتا_عمومی_دور}
شکل \حوالہ{شکل_بدلتا_عمومی_دور} کو ترکیب جوڑ سے حل کرتے ہوئے \عددی{\hat{V}_x} دریافت کریں۔
...
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american controlled voltage source,l={$2\hat{I}_x$}]++(0,\yy) to [inductor,l={$j4\,\si{\ohm}$}]++(0,\yy) to [short]++(2*\xx,0) to [capacitor,l={$-j6$\,\si{\ohm}}]++(0,-\yy) to [american current source,l={$2\phase{0^{\circ}}\,\si{\ampere}$}] ++(0,-\yy) to [short] (0,0);
\draw(0,\yy) to [capacitor,*-*,l={$-j2\,\si{\ohm}$}]++(\xx,0) to [resistor,-*,l={$\SI{4}{\ohm}$}]++(\xx,0);
\draw(\xx,2*\yy) to [american voltage source,*-,l={$10\phase{0^{\circ}}$}]++(0,-\yy) to [inductor,-*,l={$j1\,\si{\ohm}$},v={$\hat{V}_x$},i={$\hat{I}_x$}]++(0,-\yy);
\end{tikzpicture}%
\caption*{(الف)}
\end{subfigure}
\begin{subfigure}{1\textwidth}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american controlled voltage source,l={$2\hat{I}_x$}]++(0,\yy)node[left]{$\hat{V}_1$} to [inductor,l={$j4\,\si{\ohm}$}]++(0,\yy) to [short]++(2*\xx,0) to [capacitor,l={$-j6$\,\si{\ohm}}]++(0,-\yy)node[right]{$\hat{V}_3$} to [american current source,l={$2\phase{0^{\circ}}\,\si{\ampere}$}] ++(0,-\yy) to [short] (0,0);
\draw(0,\yy) to [capacitor,*-*,l={$-j2\,\si{\ohm}$}]++(\xx,0) to [resistor,-*,l={$\SI{4}{\ohm}$}]++(\xx,0);
\draw(\xx,2*\yy)node[above]{$\hat{V}_2$} to [american voltage source,*-,l={$10\phase{0^{\circ}}$}]++(0,-\yy)node[above left]{$\hat{V}_4$} to [inductor,-*,l={$j1\,\si{\ohm}$},v={$\hat{V}_x$},i={$\hat{I}_x$}]++(0,-\yy)node[ground]{};
\draw[gray,dashed] (\xx,\yy+\yy/2) circle (\xx/4 and 3/4*\yy);
\end{tikzpicture}%
\caption*{(ب)}
\end{subfigure}%
\caption{مثال \حوالہ{مثال_بدلتا_عمومی_دور} کا دور۔}
\label{شکل_بدلتا_عمومی_دور}
\end{figure}

حل:شکل-ب میں نچلے جوڑ کو زمین تصور کرتے ہوئے بقایا جوڑ کی نشاندہی کی گئی ہے جہاں \عددی{\hat{V}_2} اور \عددی{\hat{V}_4} مخلوط جوڑ کو نقطہ دار لکیر سے دکھایا گیا ہے۔دور کو دیکھتے ہوئے قابو کرنے والی رو کو درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
\hat{I}_x=\frac{\hat{V}_2+10\phase{0^{\circ}}}{j1}
\end{align*}
اس قیمت کو استعمال کرتے ہوئے اور جوڑ پر خارجی رو فرض کرتے ہوئے، جوڑ \عددی{\hat{V}_1}،  \عددی{\hat{V}_3} اور مخلوط جوڑ پر بالترتیب کرخوف مساوات رو لکھتے ہیں۔
\begin{gather}
...
\end{aligned}
\end{gather}
درج بالا مساوات میں \عددی{\hat{V}_4=\hat{V}_2+10\phase{0^{\circ}}\,\si{\volt}} پر کیا گیا ہے۔درج بالا تین ہمزاد مساوات کو کسی بھی طریقے سے حل کرتے ہوئے \عددی{\hat{V}_1}، \عددی{\hat{V}_2} اور \عددی{\hat{V}_3} حاصل کیے جا سکتے ہیں۔

مساوات \حوالہ{مساوات_بدلتا_جڑوا_جوڑ_الف} میں پہلی مساوات سے  درج ذیل لکھا جا سکتا ہے۔
\begin{align}\label{مساوات_بدلتا_جڑوا_جوڑ_ب}
\hat{V}_1=-7\hat{V}_2-60
\end{align}
مساوات \حوالہ{مساوات_بدلتا_جڑوا_جوڑ_الف} کی دوسری مساوات کو ترتیب دیتے ہوئے لکھتے ہیں۔
...
\end{align}
مساوات \حوالہ{مساوات_بدلتا_جڑوا_جوڑ_الف} کی تیسری مساوات میں مساوات \حوالہ{مساوات_بدلتا_جڑوا_جوڑ_ب} پر کرتے ہوئے ترتیب دیتے ہیں۔
...
\انتہا{مثال}
%==============
\ابتدا{مشق}\شناخت{مشق_بدلتا_آخری_الف}
شکل \حوالہ{شکل_بدلتا_آخری_الف} میں دائری ترکیب سے  تینوں خانوں کی رو دریافت کریں۔

\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [american voltage source,l={$20\phase{45^{\circ}}$}]++(0,\y) to [inductor,l={$j2\,\si{\ohm}$}]++(\x,0) to [resistor,l={$\SI{2}{\ohm}$}]++(\x,0) to [capacitor,l={$-j8\,\si{\ohm}$}]++(\x,0) to [resistor,l={$\SI{4}{\ohm}$}]++(0,-\y) to [short] (0,0);
\draw(\x,0) to [resistor,*-*,l_={$\SI{8}{\ohm}$}]++(0,\y);
\draw(2*\x,0) to [inductor,*-*,l_={$j10\,\si{\ohm}$}]++(0,\y);
%currents
\draw[stealth-]([shift={(-120:\x/5.5)}]\x/2,\y/2) arc (-120:120:\x/5.5);
\draw(\x/2,0)node[above]{$\hat{I}_1$};
\draw[stealth-]([shift={(-120:\x/5.5)}]\x+\x/2,\y/2) arc (-120:120:\x/5.5);
\draw(\x+\x/2,0)node[above]{$\hat{I}_2$};
\draw[stealth-]([shift={(-120:\x/5.5)}]2*\x+\x/2,\y/2) arc (-120:120:\x/5.5);
\draw(2*\x+\x/2,0)node[above]{$\hat{I}_3$};
\end{tikzpicture}
\caption{مشق \حوالہ{مشق_بدلتا_آخری_الف} کا دور۔}
\label{شکل_بدلتا_آخری_الف}
\end{figure}

جوابات:\عددی{\hat{I}_1=3.23\phase{26.2^{\circ}}\,\si{\ampere}}، \عددی{\hat{I}_2=0.86\phase{26.2^{\circ}}\,\si{\ampere}}، 
\عددی{\hat{I}_3=1.92\phase{89.6^{\circ}}\,\si{\ampere}}
\انتہا{مشق}
%=================

\ابتدا{مشق}\شناخت{مشق_بدلتا_آخری_ب}
شکل \حوالہ{شکل_بدلتا_آخری_ب} کو ترکیب جوڑ سے  حل کرتے ہوئے دونوں جوڑ کے دباؤ حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}
\draw(0,0) to [american current source,l={$5\phase{0^{\circ}}$}]++(0,2*\y) to [short]++(\x,0)node[above]{$\hat{V}_1$} to [inductor,l={$j2\,\si{\ohm}$}]++(\x,0)node[above]{$\hat{V}_2$} to [european resistor,l={$2+j1\,\si{\ohm}$}]++(\x,0);
\draw(0,0) to [short]++(3*\x,0) to [american voltage source,l_={$30\phase{45^{\circ}}$}]++(0,2*\y);
\draw(\x,0)node[ground]{} to [capacitor,*-,l_={$-j4\,\si{\ohm}$}]++(0,\y) to [resistor,-*,l_={$\SI{4}{\ohm}$}]++(0,\y);
\draw(2*\x,0) to [american voltage source,l_={$10\phase{20^{\circ}}\,\si{\volt}$}]++(0,\y) to [capacitor,-*,l_={$-j1\,\si{\ohm}$}]++(0,\y);
\end{tikzpicture}
\caption{مشق \حوالہ{مشق_بدلتا_آخری_ب} کا دور۔}
\label{شکل_بدلتا_آخری_ب}
\end{figure}

جوابات:\عددی{\hat{V}_1=21.91\phase{-4.4^{\circ}}\,\si{\volt}}، \عددی{\hat{V}_2=17.78\phase{-19.1^{\circ}}\,\si{\volt}}
\انتہا{مشق}
%===================
\ابتدا{مشق}\شناخت{مشق_بدلتا_آخری_پ}
شکل \حوالہ{شکل_بدلتا_آخری_پ} کو دائری ترکیب سے حل کرتے ہوئے \عددی{\hat{V}_x} دریافت کریں۔اسی کو دوبارہ ترکیب جوڑ سے حل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$40\phase{0^{\circ}}\,\si{\volt}$}]++(0,\y) to [european resistor,l={$2-j2\,\si{\ohm}$}]++(\x,0) to [inductor,l={$j6\,\si{\ohm}$},v={$\hat{V}_x$}]++(0,-\y) to [european resistor,l={$4+j2\,\si{\ohm}$}]++(-\x,0);
\draw(0,0) to [resistor,*-,l_={$\SI{10}{\ohm}$}]++(0,-\y) to [short]++(\x,0) to [american voltage source,-*,l_={$20\phase{0^{\circ}}\,\si{\volt}$}]++(0,\y);
\draw(\x,-\y) to [short,*-]++(\x,0) to [resistor,l_={$\SI{2}{\ohm}$}]++(0,\y) to [capacitor,l_={$-j6\,\si{\ohm}$}]++(0,\y) to [short,-*]++(-\x,0);
\end{tikzpicture}
\caption{مشق \حوالہ{مشق_بدلتا_آخری_پ} کا دور۔}
\label{شکل_بدلتا_آخری_پ}
\end{figure}

جواب:\عددی{\hat{V}_x=24.61\phase{-25.44^{\circ}}\,\si{\volt}}
\انتہا{مشق}
%=================
...
%======================
\ابتدا{سوال}
برقی دباؤ \عددی{v(t)=45\cos(100t-42^{\circ})\,\si{\volt}} کی تعدد، دوری عرصہ، زاویہ ہٹاو اور مؤثر دباؤ دریافت کریں۔
...
شکل \حوالہ{شکل_سوال_برقرار_برق_گیر_الف}-الف میں درج ذیل دباؤ کی صورت میں رو کو وقتی دائرہ کار اور تعددی دائرہ کار میں لکھیں۔
\begin{align*}
...
شکل \حوالہ{شکل_سوال_برقرار_رکاوٹ_پ} میں امالہ \عددی{L} کی وہ قیمت دریافت کریں جس پر دباؤ اور رو ہم قدم ہوں۔ایسی صورت میں منبع کو کیا رکاوٹ نظر آئے گی۔
\begin{figure}
\centering
\begin{tikzpicture}
...
شکل \حوالہ{شکل_سوال_برقرار_رکاوٹ_ت} میں برق گیر \عددی{C} کی وہ قیمت دریافت کریں جس پر دباؤ منبع اور رو \عددی{i(t)} ہم قدم ہوں۔ایسی صورت میں منبع کو کیا رکاوٹ نظر آئے گی۔
\begin{figure}
\centering
\begin{tikzpicture}
...
\end{align*}
اس دور کو تعددی دائرہ کار میں بنائیں اور \عددی{v_R(t)} کے لیے حل کریں۔حاصل جواب اور دوری سمتیات کے استعمال سے \عددی{v_C(t)} حاصل کریں۔ 
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
...
شکل \حوالہ{شکل_سوال_برقرار_کرخوف_الف} میں \عددی{v_R(t)} اور \عددی{v_C(t)} حاصل کریں۔منبع کا دباؤ \عددی{v_s(t)=40\cos 15t \, \si{\volt}} ہے۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
...
شکل \حوالہ{شکل_سوال_برقرار_کرخوف_ت} میں رو درج ذیل ہیں۔دباؤ \عددی{v(t)} دریافت کریں۔
\begin{align*}
...
شکل \حوالہ{شکل_سوال_برقرار_دوری_سمتیہ_الف}-الف میں \عددی{\bV_0}  دریافت کریں۔
%
\begin{figure}
\centering
\begin{subfigure}{0.4\textwidth}
...
\draw(0,0) to [american voltage source,l={$160\phase{0^{\circ}}\,\si{\volt}$}]++(0,\y) to [resistor,l={$\SI{2}{\ohm}$}]++(\x,0)
 to [inductor,l_={$j4\,\si{\ohm}$},v^<={$\bV_0$}]++(0,-\y) to [short](0,0);
\end{tikzpicture}
\caption*{(الف)}
\end{subfigure}%
\begin{subfigure}{0.6\textwidth}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$10\phase{60^{\circ}}\,\si{\volt}$}]++(0,\y) to [resistor,l={$\SI{4}{\ohm}$}]++(\x,0) to [inductor,l={$j8\,\si{\ohm}$}]++(\x,0) to [capacitor,l_={$-j6\,\si{\ohm}$},v^<={$\bV_0$}]++(0,-\y) to [short](0,0);
\end{tikzpicture}
\caption*{(ب)}
\end{subfigure}%
...
جواب:\عددی{\bV_0=113.1\phase{45^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================================
\ابتدا{سوال}\شناخت{سوال_برقرار_دوری_سمتیہ_ب}
شکل \حوالہ{شکل_سوال_برقرار_دوری_سمتیہ_الف}-ب میں \عددی{\bV_0}  دریافت کریں۔

جواب:\عددی{\bV_0=13.4\phase{-56.6^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================================
\ابتدا{سوال}\شناخت{سوال_برقرار_دوری_سمتیہ_پ}
شکل \حوالہ{شکل_سوال_برقرار_دوری_سمتیہ_پ}-الف میں \عددی{\bV_0}  دریافت کریں۔
%
\begin{figure}
\centering
\begin{subfigure}{1\textwidth}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [resistor,l={$\SI{10}{\ohm}$}]++(0,\yy);
\draw(\xx,\yy) to [american current source,*-*,l_={$7\phase{60^{\circ}}\,\si{\ampere}$}]++(0,-\yy);
\draw(2*\xx,0) to [capacitor,l={$-j8\,\si{\ohm}$},v_>={$\bV_0$}]++(0,\yy);
\draw(0,0) to [short]++(2*\xx,0);
\draw(0,\yy) to [short]++(\xx,0) to [resistor,l={$\SI{2}{\ohm}$}]++(\xx,0);
\end{tikzpicture}
\caption*{(الف)}
\end{subfigure}
\begin{subfigure}{1\textwidth}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$40\phase{30^{\circ}}\,\si{\volt}$}]++(0,\yy);
\draw(\xx,0) to [capacitor,*-*,l={$-j0.5\,\si{\ohm}$},v_>={$\bV_2$}]++(0,\yy);
\draw(2*\xx,0) to [resistor,l={$\SI{4}{\ohm}$},v_>={$\bV_1$}]++(0,\yy);
\draw(0,0) to [short]++(2*\xx,0);
\draw(0,\yy) to [resistor,l={$\SI{2}{\ohm}$}]++(\xx,0) to [inductor,l={$j6\,\si{\ohm}$}]++(\xx,0);
\end{tikzpicture}
\caption*{(ب)}
\end{subfigure}%
\caption{سوال \حوالہ{سوال_برقرار_دوری_سمتیہ_پ} اور سوال \حوالہ{سوال_برقرار_دوری_سمتیہ_ت} کے ادوار۔}
\label{شکل_سوال_برقرار_دوری_سمتیہ_پ}
\end{figure}

جواب:\عددی{\bV_0=38.8\phase{183.7^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================================
\ابتدا{سوال}\شناخت{سوال_برقرار_دوری_سمتیہ_ت}
شکل \حوالہ{شکل_سوال_برقرار_دوری_سمتیہ_پ}-ب میں \عددی{\bV_1} اور \عددی{\bV_2} دریافت کریں۔

جوابات:\عددی{\bV_1=10.1\phase{-43^{\circ}}\,\si{\volt}}، \عددی{\bV_2=5.6\phase{261^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%================================
\ابتدا{سوال}\شناخت{سوال_برقرار_دوری_سمتیہ_ٹ}
شکل \حوالہ{شکل_سوال_برقرار_دوری_سمتیہ_ٹ} میں \عددی{\bV_1=6\phase{0^{\circ}}\,\si{\volt}} ہونے کی صورت میں \عددی{\bI_s} دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [inductor,l={$j2\,\si{\ohm}$}]++(0,\y);
\draw(\x,0) to [american current source,*-*,l={$\bI_s$}]++(0,\y);
\draw(2*\x,0) to [resistor,l={$\SI{2}{\ohm}$}]++(0,\y);
\draw(0,0) to [short]++(2*\x,0);
\draw(0,\y) to [resistor,l={$\SI{4}{\ohm}$},v_>={$\bV_1$}]++(\x,0) to [short]++(\x,0);
\draw(0,\y) to [short,*-]++(0,3/4*\y) to [capacitor,l_={$-j2\,\si{\ohm}$}]++(2*\x,0) to [short,-*]++(0,-3/4*\y);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دوری_سمتیہ_ٹ} کا دور۔}
\label{شکل_سوال_برقرار_دوری_سمتیہ_ٹ}
\end{figure}%

جواب:\عددی{\bI_s=4.74\phase{71.6^{\circ}}\,\si{\ampere}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_دوری_سمتیہ_ث}
شکل \حوالہ{شکل_سوال_برقرار_دوری_سمتیہ_ث} میں \عددی{\bI_1} اور \عددی{\bI_2} دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [inductor,l={$j1\,\si{\ohm}$}]++(0,\yy) to [resistor,l={$\SI{1}{\ohm}$}]++(0,\yy);
\draw(\xx,0) to [capacitor,*-,l={$-j2\,\si{\ohm}$}]++(0,\yy) to [american voltage source,-*,l={$8\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy);
\draw(2*\xx,0) to [resistor,*-,l={$\SI{1}{\ohm}$}]++(0,\yy) to [american current source,-*,l={$2\phase{0^{\circ}}\,\si{\ampere}$}]++(0,\yy);
\draw(3*\xx,0) to [american voltage source,l={$2\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy) to [resistor,l={$\SI{2}{\ohm}$}]++(0,\yy);
\draw(0,0) to [short]++(3*\xx,0);
\draw(0,2*\yy) to [short]++(3*\xx,0);
\draw(0,\yy) to [resistor,*-*,l={$\SI{1}{\ohm}$},i={$\bI_1$}]++(\xx,0) to [resistor,-*,l={$\SI{1}{\ohm}$},i={$\bI_2$}]++(\xx,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دوری_سمتیہ_ث} کا دور۔}
\label{شکل_سوال_برقرار_دوری_سمتیہ_ث}
\end{figure}%

جواب:\عددی{\bI_1=3.1\phase{1.8^{\circ}}\,\si{\ampere}}، \عددی{\bI_2=0.95\phase{119.2^{\circ}}\,\si{\ampere}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_دوری_سمتیہ_ج}
شکل \حوالہ{شکل_سوال_برقرار_دوری_سمتیہ_ج} میں \عددی{\bV_0=2\phase{30^{\circ}}\,\si{\volt}} ہے۔رکاوٹ \عددی{\bZ} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$8\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy);
\draw(\xx,0) to [european resistor,*-*,l={$\bZ$}]++(0,\yy);
\draw(2*\xx,0) to [european resistor,l={$\SI{2}{\ohm}$},v_>={$\bV_0$}]++(0,\yy);
\draw(0,0) to [short]++(2*\xx,0);
\draw(0,\yy) to [resistor,l={$\SI{3}{\ohm}$}]++(\xx,0) to [capacitor,l={$-j2\,\si{\ohm}$}]++(\xx,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دوری_سمتیہ_ج} کا دور۔}
\label{شکل_سوال_برقرار_دوری_سمتیہ_ج}
\end{figure}%

جواب:\عددی{\bZ=3.054+j0.056\,\si{\ohm}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_دوری_سمتیہ_چ}
شکل \حوالہ{شکل_سوال_برقرار_دوری_سمتیہ_چ} میں \عددی{\bI_0=3\phase{0^{\circ}}\,\si{\ampere}} ہے۔رو \عددی{\bI_x} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [resistor,l={$\SI{1}{\ohm}$},i={$\bI_x$}]++(0,\yy) to [european resistor,l={$\bZ$}]++(0,\yy);
\draw(\xx,0) to [american voltage source,*-*,l={$10\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy) to [inductor,-*,l={$j1\,\si{\ohm}$}]++(0,\yy);
\draw(2*\xx,0) to [resistor,l_={$\SI{1}{\ohm}$},i<={$\bI_0$}]++(0,\yy) to [capacitor,l_={$-j1\,\si{\ohm}$}]++(0,\yy);
\draw(0,0) to [short]++(2*\xx,0);
\draw(0,2*\yy) to [short]++(2*\xx,0);
\draw(0,\yy) to [american current source,*-,l={$3\phase{0^{\circ}}\,\si{\ampere}$}]++(\xx,0) to [resistor,-*,l={$\SI{1}{\ohm}$}]++(\xx,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دوری_سمتیہ_چ} کا دور۔}
\label{شکل_سوال_برقرار_دوری_سمتیہ_چ}
\end{figure}%

جواب:\عددی{\bI_x=3+j7\,\si{\ampere}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_دوری_سمتیہ_ح}
شکل \حوالہ{شکل_سوال_برقرار_دوری_سمتیہ_ح} میں \عددی{\bI_0=5\phase{0^{\circ}}\,\si{\ampere}} ہے۔رو \عددی{\bI_x} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [european resistor,l={$\bZ$}]++(0,\yy) to [inductor,l={$j1\,\si{\ohm}$},i<={$\bI_x$}]++(0,\yy);
\draw(\xx,0) to [american voltage source,*-*,l={$15\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy) to [resistor,-*,l={$\SI{2}{\ohm}$}]++(0,\yy);
\draw(2*\xx,0) to [resistor,*-*,l={$\SI{1}{\ohm}$}]++(0,\yy) to [capacitor,-*,l={$-j2\,\si{\ohm}$}]++(0,\yy);
\draw(3*\xx,0) to [resistor,l_={$\SI{2}{\ohm}$},i_<={$\bI_0$}]++(0,\yy) to [american current source,l_={$3\phase{0^{\circ}}\,\si{\ampere}$}]++(0,\yy);
\draw(0,0) to [short]++(3*\xx,0);
\draw(0,2*\yy) to [short]++(3*\xx,0);
\draw(0,\yy) to [resistor,*-,l={$\SI{2}{\ohm}$}]++(\xx,0) to [resistor,l={$\SI{1}{\ohm}$}]++(\xx,0)  to [resistor,-*,l={$\SI{1}{\ohm}$}]++(\xx,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دوری_سمتیہ_ح} کا دور۔}
\label{شکل_سوال_برقرار_دوری_سمتیہ_ح}
\end{figure}%

جواب:\عددی{\bI_x=-32.5+j35\,\si{\ampere}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_جوڑ_الف}
شکل \حوالہ{شکل_سوال_برقرار_جوڑ_الف} میں ترکیب جوڑ سے \عددی{\bI_0} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$20\phase{0^{\circ}}$}]++(0,\yy) to [inductor,l={$j4\,\si{\ohm}$}]++(0,\yy);
\draw(\xx,2*\yy) to [american current source,*-*,l={$5\phase{0^{\circ}}\,\si{\ampere}$}]++(0,-2*\yy);
\draw(2*\xx,0)node[ground]{} to [american voltage source,*-,l={$8\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy) to [capacitor,-*,l={$-j2\,\si{\ohm}$}]++(0,\yy)node[above]{$\bV_1$};
\draw(3*\xx,0) to [capacitor,*-*,l_={$-j1\,\si{\ohm}$}]++(0,2*\yy);
\draw(4*\xx,0) to [resistor,l_={$\SI{6}{\ohm}$},i_<={$\bI_0$}]++(0,2*\yy);
\draw(0,0) to [short]++(4*\xx,0);
\draw(0,2*\yy) to [short]++(4*\xx,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_جوڑ_الف} کا دور۔}
\label{شکل_سوال_برقرار_جوڑ_الف}
\end{figure}%

جواب:\عددی{\bI_0=0.67\phase{108.9^{\circ}}\,\si{\ampere}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_جوڑ_ب}
شکل \حوالہ{شکل_سوال_برقرار_جوڑ_ب} میں ترکیب جوڑ سے \عددی{\bV_0} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$18\phase{0^{\circ}}$}]++(0,2*\yy);
\draw(2*\xx,0) to [american current source,*-*,l={$4\phase{0^{\circ}}\,\si{\ampere}$}]++(0,2*\yy);
\draw(3*\xx,0)node[ground]{} to [resistor,*-,l={$\SI{4}{\ohm}$},v_>={$\bV_0$}]++(0,\yy) to [capacitor,-*,l={$-j2\,\si{\ohm}$}]++(0,\yy)node[above]{$\bV_1$};
\draw(4*\xx,0) to [american voltage source,l_={$6\phase{0^{\circ}}\,\si{\volt}$}]++(0,2*\yy);
\draw(0,0) to [short]++(4*\xx,0);
\draw(0,2*\yy) to [resistor,l={$\SI{2}{\ohm}$}]++(\xx,0) to [inductor,l={$j4\,\si{\ohm}$}]++(\xx,0) to [short]++(\xx,0) to [resistor,l={$\SI{1}{\ohm}$}]++(\xx,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_جوڑ_ب} کا دور۔}
\label{شکل_سوال_برقرار_جوڑ_ب}
\end{figure}%

جواب:\عددی{\bV_0=8.46\phase{14^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_جوڑ_پ}
شکل \حوالہ{شکل_سوال_برقرار_جوڑ_پ} میں ترکیب جوڑ سے \عددی{\bV_0} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [resistor,l_={$\SI{1}{\ohm}$},v^>={$\bV_x$}]++(0,\yy) to [american controlled current source,l={$3\bI_x$}]++(0,\yy);
\draw(\xx,0) to [american voltage source,*-*,l_={$4\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy) to [capacitor,-*,l_={$-j1\,\si{\ohm}$}]++(0,\yy);
\draw(2*\xx,0)node[ground]{} to [american controlled voltage source,l_={$2\bV_x$}]++(0,\yy) to [resistor,l_={$\SI{2}{\ohm}$},i_<={$\bI_x$}]++(0,\yy);
\draw(0,0) to [short]++(2*\xx,0);
\draw(0,2*\yy) to [short]++(2*\xx,0);
\draw(0,\yy) to [resistor,*-,l={$\SI{2}{\ohm}$},v={$\bV_0$}]++(\xx,0) to [resistor,-*,l={$\SI{2}{\ohm}$}]++(\xx,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_جوڑ_پ} کا دور۔}
\label{شکل_سوال_برقرار_جوڑ_پ}
\end{figure}%

جواب:\عددی{\bV_0=2.11\phase{161.6^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_جوڑ_ت}
شکل \حوالہ{شکل_سوال_برقرار_جوڑ_ت} میں ترکیب جوڑ سے \عددی{\bV_0} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american current source,l={$2\phase{-45^{\circ}}\,\si{\ampere}$}]++(0,\yy);
\draw(\xx,0) to [inductor,*-*,l_={$j1\,\si{\ohm}$},i<={$\bI_x$}]++(0,\yy);
\draw(2*\xx,0)node[ground]{} to [resistor,l={$\SI{1}{\ohm}$},v_>={$\bV_0$}]++(0,\yy);
\draw(0,0) to [short]++(2*\xx,0);
\draw(0,\yy) to [capacitor,*-,l={$-j2\,\si{\ohm}$}]++(\xx,0) to [american voltage source,-*,l={$8\phase{30^{\circ}}\,\si{\volt}$}]++(\xx,0);
\draw(0,\yy) to [short,*-]++(0,3/4*\yy) to [american controlled current source,l={$2\bI_x$}]++(2*\xx,0) to [short,-*]++(0,-3/4*\yy);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_جوڑ_ت} کا دور۔}
\label{شکل_سوال_برقرار_جوڑ_ت}
\end{figure}%

جواب:\عددی{\bV_0=7.03\phase{-12^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_دائری_الف}
شکل \حوالہ{شکل_سوال_برقرار_دائری_الف} میں دائری ترکیب سے \عددی{\bV_0} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,\yy) to [american voltage source,l_={$8\phase{0^{\circ}}\,\si{\volt}$}]++(0,-\yy);
\draw(\xx,0) to [inductor,*-*,l_={$j4\,\si{\ohm}$}]++(0,\yy);
\draw(2*\xx,0) to [resistor,l={$\SI{4}{\ohm}$},v_>={$\bV_0$}]++(0,\yy);
\draw(0,0) to [short]++(2*\xx,0);
\draw(0,\yy) to [capacitor,l={$-j1\,\si{\ohm}$}]++(\xx,0) to [american voltage source,l={$10\phase{-60^{\circ}}\,\si{\volt}$}]++(\xx,0);
%currents
\draw[stealth-]([shift={(-150:\xx/6)}]\xx/2,\yy/4) arc (-150:150:\xx/6);
\draw(\xx/2,\yy/4)node{$\bI_1$};
\draw[stealth-]([shift={(-150:\xx/6)}]\xx+\xx/2,\yy/4) arc (-150:150:\xx/6);
\draw(\xx+\xx/2,\yy/4)node{$\bI_2$};
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دائری_الف} کا دور۔}
\label{شکل_سوال_برقرار_دائری_الف}
\end{figure}%

جواب:\عددی{\bV_0=9.82\phase{255.2^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_دائری_ب}
شکل \حوالہ{شکل_سوال_برقرار_دائری_ب} میں دائری ترکیب سے \عددی{\bV_0} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$22\phase{0^{\circ}}\,\si{\volt}$}]++(0,2*\yy);
\draw(\xx,0) to [capacitor,*-,l={-$j2\,\si{\ohm}$},v_>={$\bV_0$}]++(0,\yy) to [resistor,-*,l={$\SI{4}{\ohm}$}]++(0,\yy);
\draw(2*\xx,0) to [american current source,l_={$6\phase{90^{\circ}}\,\si{\ampere}$}]++(0,2*\yy);
\draw(0,0) to [short]++(2*\xx,0);
\draw(0,2*\yy) to [resistor,l={$\SI{2}{\ohm}$}]++(\xx,0) to [inductor,l={$j4\,\si{\ohm}$}]++(\xx,0);
%currents
\draw[stealth-]([shift={(-150:\xx/6)}]\xx/2,\yy) arc (-150:150:\xx/6);
\draw(\xx/2,\yy)node{$\bI_1$};
\draw[stealth-]([shift={(-150:\xx/6)}]\xx+\xx/2,\yy) arc (-150:150:\xx/6);
\draw(\xx+\xx/2,\yy)node{$\bI_2$};
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دائری_ب} کا دور۔}
\label{شکل_سوال_برقرار_دائری_ب}
\end{figure}%

جواب:\عددی{\bV_0=7.92\phase{42.95^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_دائری_پ}
شکل \حوالہ{شکل_سوال_برقرار_دائری_پ} میں دائری ترکیب سے \عددی{\bV_0} حاصل کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american current source,l={$4\phase{0^{\circ}}\,\si{\ampere}$}]++(0,\yy);
\draw(\xx,0) to [american voltage source,*-*,l={$15\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy);
\draw(2*\xx,0) to [inductor,*-*,l_={$j3\,\si{\ohm}$}]++(0,\yy);
\draw(3*\xx,0) to [resistor,l={$\SI{2}{\ohm}$},v_>={$\bV_0$}]++(0,\yy);
\draw(0,0) to [short]++(3*\xx,0);
\draw(0,\yy) to [resistor,l={$\SI{2}{\ohm}$}]++(\xx,0) to [capacitor,l={$-j1\,\si{\ohm}$}]++(\xx,0) to [resistor,l={$\SI{1}{\ohm}$}]++(\xx,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دائری_پ} کا دور۔}
\label{شکل_سوال_برقرار_دائری_پ}
\end{figure}%

جواب:\عددی{\bV_0=13.4\phase{26.6^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_دائری_ت}
شکل \حوالہ{شکل_سوال_برقرار_دائری_ت} کو مسئلہ خطی میل سے حل کرتے ہوئے \عددی{\bV_0} دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$30\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy);
\draw(\xx,0) to [american current source,*-*,l={$4\phase{0^{\circ}}\,\si{\ampere}$}]++(0,\yy);
\draw(2*\xx,0) to [resistor,l={$\SI{2}{\ohm}$},v_>={$\bV_0$}]++(0,\yy);
\draw(0,0) to [short]++(2*\xx,0);
\draw(0,\yy) to [capacitor,l={$-j1\,\si{\ohm}$}]++(\xx,0) to [inductor,l={$j4\,\si{\ohm}$}]++(\xx,0);
\draw(0,\yy) to [short,*-]++(0,3/4*\yy) to [resistor,l_={$\SI{2}{\ohm}$}]++(2*\xx,0) to [short,-*]++(0,-3/4*\yy);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دائری_ت} کا دور۔}
\label{شکل_سوال_برقرار_دائری_ت}
\end{figure}%

جواب:\عددی{\bV_0=16.1\phase{-17.8^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_دائری_ٹ}
شکل \حوالہ{شکل_سوال_برقرار_دائری_ٹ} کو مسئلہ خطی میل سے حل کرتے ہوئے \عددی{\bV_0} دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [capacitor,l={$-j1\,\si{\ohm}$}]++(0,\yy) to [american current source,l={$30\phase{0^{\circ}}\,\si{\ampere}$}]++(0,\yy);
\draw(\xx,0) to [american voltage source,*-*,l={$8\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy) to [inductor,-*,l={$j2\,\si{\ohm}$}]++(0,\yy) ;
\draw(2*\xx,0) to [resistor,l={$\SI{2}{\ohm}$},v_>={$\bV_0$}]++(0,\yy);
\draw(2*\xx,2*\yy) to [american current source,l={$4\phase{0^{\circ}}\,\si{\ampere}$}]++(0,-\yy) ;
\draw(0,0) to [short]++(2*\xx,0);
\draw(0,2*\yy) to [short]++(2*\xx,0);
\draw(0,\yy) to [resistor,*-,l={$\SI{1}{\ohm}$}]++(\xx,0) to [resistor,-*,l={$\SI{2}{\ohm}$}]++(\xx,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دائری_ٹ} کا دور۔}
\label{شکل_سوال_برقرار_دائری_ٹ}
\end{figure}%

جواب:\عددی{\bV_0=8\phase{0^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_دائری_ث}
شکل \حوالہ{شکل_سوال_برقرار_دائری_ث} کو تبادلہ منبع سے حل کرتے ہوئے \عددی{\bV_0} دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$4\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy) ;
\draw(\xx,0) to [resistor,*-*,l={$\SI{1}{\ohm}$}]++(0,\yy);
\draw(2*\xx,\yy) to [american current source,*-*,l_={$3\phase{0^{\circ}}\,\si{\ampere}$}]++(0,-\yy) ;
\draw(3*\xx,0) to [resistor,l={$\SI{4}{\ohm}$},v_>={$\bV_0$}]++(0,\yy);
\draw(0,0) to [short]++(3*\xx,0);
\draw(0,\yy) to [capacitor,l={$-j1\,\si{\ohm}$}]++(\xx,0) to [short]++(\xx,0) to [american voltage source,l={$6\phase{0^{\circ}}\,\si{\volt}$}]++(\xx,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دائری_ث} کا دور۔}
\label{شکل_سوال_برقرار_دائری_ث}
\end{figure}%

جواب:\عددی{6.52\phase{34.6^{\circ}}\,\si{\volt}}
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_برقرار_دائری_ج}
شکل \حوالہ{شکل_سوال_برقرار_دائری_ج} کو تبادلہ منبع سے حل کرتے ہوئے \عددی{\bI_0} دریافت کریں۔
\begin{figure}
\centering
\begin{tikzpicture}[american voltages]
\draw(0,0) to [american voltage source,l={$10\phase{30^{\circ}}\,\si{\volt}$}]++(0,\yy) to [resistor,l={$\SI{2}{\ohm}$}]++(0,\yy) ;
\draw(\xx,0) to [american current source,*-*,l_={$6\phase{60^{\circ}}\,\si{\ampere}$}]++(0,2*\yy) ;
\draw(2*\xx,0) to [american voltage source,*-,l={$12\phase{0^{\circ}}\,\si{\volt}$}]++(0,\yy) to [inductor,-*,l={$j1\,\si{\ohm}$}]++(0,\yy) ;
\draw(3*\xx,0) to [capacitor,*-*,l={$-j4\,\si{\ohm}$}]++(0,2*\yy);
\draw(4*\xx,0) to [resistor,l_={$\SI{2}{\ohm}$},i_<={$\bI_0$}]++(0,2*\yy);
\draw(0,0) to [short]++(4*\xx,0);
\draw(0,2*\yy) to [short]++(4*\xx,0);
\end{tikzpicture}
\caption{سوال \حوالہ{سوال_برقرار_دائری_ج} کا دور۔}
\label{شکل_سوال_برقرار_دائری_ج}
\end{figure}%

جواب:\عددی{\bI_0=3.4\phase{6.45^{\circ}}\,\si{\ampere}}
\انتہا{سوال}
%==================
