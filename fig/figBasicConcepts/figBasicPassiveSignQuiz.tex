...
%external circuit
\draw (h) to [short]++(2,0)coordinate(rTop) to [european resistor]++(0,-2) to [short,i={$\SI{2}{\ampere}$}] (l);
%voltages
\draw (rTop)++(0.6,-1) node{$\begin{aligned} &+\\&\SI{4}{\volt}\\&- \end{aligned}$};
\draw ($(h)!0.5!(l)$)++(0.5,0) node{$\begin{aligned} &+\\&\SI{4}{\volt}\\&- \end{aligned}$};
%text
...
%external circuit
\draw (ha) to [short]++(2,0)coordinate(rTop) to [european resistor]++(0,-2) to [short,i={$\SI{-9}{\ampere}$}] (la);
%voltages
\draw (rTop)++(0.6,-1) node{$\begin{aligned} &-\\&\SI{3}{\volt}\\&+ \end{aligned}$};
\draw ($(ha)!0.5!(la)$)++(0.5,0) node{$\begin{aligned} &-\\&\SI{3}{\volt}\\&+ \end{aligned}$};
%text
