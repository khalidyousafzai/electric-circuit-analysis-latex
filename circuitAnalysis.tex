...
%\includeonly{./tex/cktSymbols,./tex/cktPreface,./tex/prefaceFirstBook,./tex/cktMagneticallyCoupledNetworks,./tex/cktQuestions,./tex/cktToDoList}%
\includeonly{./tex/cktSymbols,./tex/cktPreface,./tex/prefaceFirstBook,./tex/cktQuestions,./tex/cktToDoList}%
