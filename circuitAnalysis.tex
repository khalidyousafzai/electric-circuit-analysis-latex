...
%\newcommand*{\kcomplex}[1]{{\ensuremath{{\boldsymbol{#1}}}}}
%\newcommand*{\مخلوط}[1]{{\ensuremath{{\boldsymbol{#1}}}}}
...
%\includeonly{./tex/cktSymbols,./tex/cktPreface,./tex/prefaceFirstBook,./tex/cktBasics,./tex/cktResistive,./tex/cktNodalLoop,./tex/cktOpamp,./tex/cktTheorems,./tex/cktCapacitorInductor,./tex/cktTransients,./tex/cktSteadyStateAC,./tex/cktSteadyStatePower,./tex/cktToDoList}
\includeonly{./tex/cktSymbols,./tex/cktPreface,./tex/prefaceFirstBook,./tex/cktSteadyStateAC,./tex/cktSteadyStatePower,./tex/cktToDoList}%
